...
const Sparkles = () => {
  ...
  const [positions, setPositions] = useState<Array<{top: number, left: number, opacity: number}>>([]);
  ...
  if (!isClient || positions.length === 0) {
    return (
      <div className="absolute inset-0">
        {/* Static fallback that matches client dimensions */}
...
export const ClaudeLogo = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      fillRule="evenodd"  // This is fine in React
      clipRule="evenodd"  // This is fine in React
      viewBox="0 0 512 512"
      className={className}
    >
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          {/* Fixed: kebab-case to camelCase for stop-color */}
