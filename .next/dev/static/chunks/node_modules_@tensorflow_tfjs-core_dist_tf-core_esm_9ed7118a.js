...
function getWebGLContext(e) {
    e in contexts || (contexts[e] = getWebGLRenderingContext(e));
    var t = contexts[e];
...
function assertShapesMatch(e, t, n) {
    void 0 === n && (n = ""), assert(arraysEqual(e, t), function() {
        return n + " Shapes " + e + " and " + t + " must match";
    });
}
function assertNonNull(e) {
    assert(null != e, function() {
        return "The input to the tensor constructor must be a non-null value.";
    });
}
function flatten(e, t) {
    if (void 0 === t && (t = []), null == t && (t = []), Array.isArray(e) || isTypedArray(e)) for(var n = 0; n < e.length; ++n)flatten(e[n], t);
    else t.push(e);
    return t;
}
...
function createNestedArray(e, t, n) {
    var r = new Array;
    if (1 === t.length) for(var o = t[0], a = 0; a < o; a++)r[a] = n[e + a];
    else {
        o = t[0];
        var i = t.slice(1), s = i.reduce(function(e, t) {
            return e * t;
        });
        for(a = 0; a < o; a++)r[a] = createNestedArray(e + a * s, i, n);
    }
    return r;
}
...
function now() {
    ...
    if ("undefined" != typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]) {
        var e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].hrtime();
...
function assertNonNegativeIntegerDimensions(e) {
    e.forEach(function(t) {
        assert(Number.isInteger(t) && t >= 0, function() {
...
var util = Object.freeze({
    ...
    return e.prototype.profileKernel = function(e, t) {
        ...
        return (Array.isArray(n) ? n : [
            ...
            var n = t.dataSync();
            checkComputationForErrors(n, t.dtype, e), o.then(function(o) {
                var a = "";
    ...
    return e.prototype.logKernelProfile = function(e, t, n, r, o) {
        var a = rightPad(r + "ms", 9), i = rightPad(e, 25), s = t.rank, u = t.size, c = rightPad(t.shape.toString(), 14);
        console.log("%c" + i + "\t%c" + a + "\t%c" + s + "D " + c + "\t%c" + u + "\t%c" + o, "font-weight:bold", "color:red", "color:blue", "color: orange", "color: green");
    }, e;
}(), FORMAT_LIMIT_NUM_VALS = 20, FORMAT_NUM_FIRST_LAST_VALS = 3, FORMAT_NUM_SIG_DIGITS = 7;
function tensorToString(e, t, n, r) {
    var o = computeStrides(t), a = computeMaxSizePerColumn(e, t, n, o), i = t.length, s = subTensorToString(e, t, n, o, a), u = [
        "Tensor"
    ];
...
function computeMaxSizePerColumn(e, t, n, r) {
    ...
    if (s > 1) for(var c = 0; c < o / a; c++)for(var l = c * a, p = 0; p < a; p++)i[p] = Math.max(i[p], valToString(u[l + p], 0, n).length);
    return i;
}
function valToString(e, t, n) {
    return rightPad(Array.isArray(e) ? parseFloat(e[0].toFixed(FORMAT_NUM_SIG_DIGITS)) + " + " + parseFloat(e[1].toFixed(FORMAT_NUM_SIG_DIGITS)) + "j" : isString(e) ? "'" + e + "'" : "bool" === n ? boolNumToString(e) : parseFloat(e.toFixed(FORMAT_NUM_SIG_DIGITS)).toString(), t);
}
...
function subTensorToString(e, t, n, r, o, a) {
    ...
    if (0 === u) return "complex64" === n ? [
        valToString(createComplexTuples(e)[0], 0, n)
    ] : "bool" === n ? [
        boolNumToString(e[0])
    ] : [
        e[0].toString()
    ...
    if (1 === u) {
        if (s > FORMAT_LIMIT_NUM_VALS) {
            var c = FORMAT_NUM_FIRST_LAST_VALS * i, l = Array.from(e.slice(0, c)), p = Array.from(e.slice(s - FORMAT_NUM_FIRST_LAST_VALS * i, s));
            return "complex64" === n && (l = createComplexTuples(l), p = createComplexTuples(p)), [
                "[" + l.map(function(e, t) {
                    return valToString(e, o[t], n);
                }).join(", ") + ", ..., " + p.map(function(e, t) {
                    return valToString(e, o[s - FORMAT_NUM_FIRST_LAST_VALS + t], n);
                }).join(", ") + "]"
            ];
        }
        return [
            "[" + ("complex64" === n ? createComplexTuples(e) : Array.from(e)).map(function(e, t) {
                return valToString(e, o[t], n);
            }).join(", ") + "]"
        ];
    }
    ...
    if (s > FORMAT_LIMIT_NUM_VALS) {
        for(var g = 0; g < FORMAT_NUM_FIRST_LAST_VALS; g++){
            var v = (y = g * f) + f;
            m.push.apply(m, subTensorToString(e.slice(y, v), d, n, h, o, !1));
        }
        m.push("...");
        for(g = s - FORMAT_NUM_FIRST_LAST_VALS; g < s; g++){
            v = (y = g * f) + f;
            m.push.apply(m, subTensorToString(e.slice(y, v), d, n, h, o, g === s - 1));
        }
    } else for(g = 0; g < s; g++){
        var y;
        v = (y = g * f) + f;
    ...
    var E = ",\n";
    for(g = 2; g < u; g++)E += "\n";
    return m[m.length - 1] = " " + m[m.length - 1] + "]" + (a ? "" : E), m;
}
...
var TensorBuffer = function() {
    ...
    return e.prototype.set = function(e) {
        ...
        0 === n.length && (n = [
            0
        ]), assert(n.length === this.rank, function() {
        ...
        for(var n = 0, r = 0, o = e; r < o.length; r++){
            ...
            if (a < 0 || a >= this.shape[n]) {
                var i = "Requested out of range element at " + e + ".   Buffer shape=" + this.shape;
                throw new Error(i);
            }
            n++;
        }
        for(var s = e[e.length - 1], u = 0; u < e.length - 1; ++u)s += this.strides[u] * e[u];
...
var Tensor = function() {
    function e(e, t, n, r, o) {
        this.kept = !1, this.isDisposedInternal = !1, this.shape = e.slice(), this.dtype = t || "float32", this.size = sizeFromShape(e), this.strides = computeStrides(e), this.dataId = null != r ? r : {}, this.id = trackerFn().nextTensorId(), this.rankType = this.rank < 5 ? this.rank.toString() : "higher", trackerFn().registerTensor(this, o), null != n && trackerFn().write(this.dataId, n);
    }
    return e.make = function(t, n, r, o) {
        return new e(t, r, n.values, n.dataId, o);
    ...
    }, e.prototype.as5D = function(e, t, n, r, o) {
        return this.throwIfDisposed(), this.reshape([
            e,
            t,
            n,
            ...
            return __generator(this, function(t) {
                switch(t.label){
                    ...
                    case 1:
                        return e = t.sent(), [
                            2,
                            opHandler.buffer(this.shape, this.dtype, e)
                        ];
                }
            });
        });
    ...
    }, e.prototype.oneHot = function(e, t, n) {
    ...
    }, e.prototype.concat = function(t, n) {
        return void 0 === n && (n = 0), this.throwIfDisposed(), t instanceof e && (t = [
            t
        ]), opHandler.concat([
            this
        ].concat(t), n);
        ...
        return void 0 === n && (n = .001), deprecationWarningFn("tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon"), this.batchNorm(e, t, o, r, n);
    }, e.prototype.batchNorm = function(e, t, n, r, o) {
        return void 0 === o && (o = .001), this.throwIfDisposed(), opHandler.batchNorm(this, e, t, n, r, o);
    ...
    }, e.prototype.stridedSlice = function(e, t, n, r, o, a, i, s) {
...
function getFilteredNodesXToY(e, t, n) {
    ...
    p[n.id] = !0;
    var d = {};
    for(a = e.length - 1; a >= 0; a--)for(i = (f = e[a]).inputs, l = 0; l < f.outputs.length; l++)if (p[f.outputs[l].id]) {
...
function backpropagateGradients(e, t, n) {
    for(var r = function(r) {
        ...
        var i = o.gradient(1 === o.outputs.length ? a[0] : a), s = function(t) {
            if (!(t in i)) throw new Error("Cannot backprop through input " + t + ". Available gradients found: " + Object.keys(i) + ".");
            var r = n(function() {
                return i[t]();
            });
            if ("float32" !== r.dtype) throw new Error("Error in gradient for op " + o.name + ". The gradient of input " + t + " must have 'float32' dtype, but has '" + r.dtype + "'");
            var a = o.inputs[t];
            if (!arraysEqual(r.shape, a.shape)) throw new Error("Error in gradient for op " + o.name + ". The gradient of input '" + t + "' has shape '" + r.shape + "', which does not match the shape of the input '" + a.shape + "'");
            if (null == e[a.id]) e[a.id] = r;
            else {
                var s = e[a.id];
                e[a.id] = s.add(r), s.dispose();
            }
        };
...
function assertTypesMatch(e, t) {
    assert(e.dtype === t.dtype, function() {
...
var Type, tensor_util = Object.freeze({
    ...
    function e(e, t, n) {
        this.backend = e, this.safeMode = t, this.debugMode = n, this.registeredVariables = {}, this.nextTapeNodeId = 0, this.numBytes = 0, this.numTensors = 0, this.numStringTensors = 0, this.numDataBuffers = 0, this.profiling = !1, this.gradientDepth = 0, this.kernelDepth = 0, this.scopeStack = [], this.nextScopeId = 0, this.tensorInfo = new WeakMap, this.profiler = new Profiler(e), this.activeProfile = {
            newBytes: 0,
            newTensors: 0,
            peakBytes: 0,
            kernels: [],
    ...
    return e.prototype.moveData = function(e) {
        ...
        var r, o = this, a = [], i = this.isTapeOn(), s = null != this.activeScope ? this.activeScope.name : "", u = function(e) {
            i && (a = e.map(function(e) {
                return o.keep(o.clone(e));
            }));
    ...
    }, e.prototype.registerTensor = function(e, t) {
        var n = this.tensorInfo.has(e.dataId) ? this.tensorInfo.get(e.dataId).refCount : 0;
        if (this.numTensors++, "string" === e.dtype && this.numStringTensors++, 0 === n) {
            this.numDataBuffers++;
            var r = 0;
            "complex64" !== e.dtype && "string" !== e.dtype && (r = e.size * bytesPerElement(e.dtype)), this.tensorInfo.set(e.dataId, {
                backend: null != t ? t : this.backend,
                dtype: e.dtype,
                shape: e.shape,
                bytes: r,
                refCount: 0
            }), this.numBytes += r, null != t ? t.register(e.dataId, e.shape, e.dtype) : this.backend.register(e.dataId, e.shape, e.dtype);
        }
        ...
        if (this.tensorInfo.has(e.dataId)) {
            this.numTensors--, "string" === e.dtype && this.numStringTensors--;
        ...
        e && (t.name = e), this.scopeStack.push(t), this.activeScope = t;
    }, e.prototype.endScope = function(e) {
        for(var t = this, n = getTensorsInContainer(e), r = new Set(n.map(function(e) {
            return e.id;
        })), o = 0; o < this.activeScope.track.length; o++){
            var a = this.activeScope.track[o];
            a.kept || r.has(a.id) || a.dispose();
        }
        var i = this.scopeStack.pop();
        this.activeScope = 0 === this.scopeStack.length ? null : this.scopeStack[this.scopeStack.length - 1], n.forEach(function(e) {
            e.kept || e.scopeId !== i.id || t.track(e);
        });
    }, e.prototype.gradients = function(e, t, n, r) {
        var o = this;
        if (void 0 === r && (r = !1), assert(t.length > 0, function() {
        ...
        var a = this.scopedRun(function() {
            ...
            return o.tidy("forward", e);
        });
        assert(a instanceof Tensor, function() {
            return "The result y returned by f() must be a tensor.";
        });
        var i = getFilteredNodesXToY(this.activeTape, t, a);
        ...
        return this.tidy("backward", function() {
            var e = {};
            e[a.id] = null == n ? ones(a.shape) : n, backpropagateGradients(e, i, function(e) {
                return o.tidy(e);
            });
            var r = t.map(function(t) {
                return e[t.id];
            });
            return 0 === o.gradientDepth && (o.activeTape.forEach(function(e) {
                for(var t in e.saved)e.saved[t].dispose();
            }), o.activeTape = null), {
                value: a,
                grads: r
            };
        ...
        var t = this;
        return assert(isFunction(e), function() {
            ...
            return r.forEach(function(e, t) {
                a[t] = e;
            }), t.runKernel(function(t, o) {
                return assert((n = e.apply(void 0, r.concat([
                    o
                ]))).value instanceof Tensor, function() {
                    return "The function f passed in customGrad(f) must return an object where `obj.value` is a tensor";
                }), assert(isFunction(n.gradFunc), function() {
                    return "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function.";
                }), n.value;
            }, a, function(e, t) {
                var o = n.gradFunc(e, t), a = Array.isArray(o) ? o : [
                    o
                ];
                assert(a.length === r.length, function() {
        ...
        return null != this.activeScope && (e.scopeId = this.activeScope.id, this.activeScope.track.push(e)), e;
...
var _global, EPSILON_FLOAT16 = 1e-4, TEST_EPSILON_FLOAT16 = .1, EPSILON_FLOAT32 = 1e-7, TEST_EPSILON_FLOAT32 = .001, Environment = function() {
    function e(e) {
        this.features = {}, this.registry = {}, this.registryFactory = {}, null != e && (this.features = e), this.get("DEBUG") && console.warn("Debugging mode is ON. The output of every math call will be downloaded to CPU and checked for NaNs. This significantly impacts performance.");
    }
    return e.setBackend = function(e, t) {
        ...
        return e in this.registryFactory ? this.registryFactory[e] : null;
    }, e.prototype.registerBackend = function(e, t, n) {
        var r = this;
        if (void 0 === n && (n = 1), e in this.registry) return console.warn(e + " backend was already registered. Reusing existing backend"), !1;
        try {
            var o = t();
            return o.setDataMover({
                moveData: function(e) {
                    return r.engine.moveData(e);
                }
            }), this.registry[e] = {
                backend: o,
                priority: n
            }, this.registryFactory[e] = t, !0;
        } catch (t) {
...
function getGlobalNamespace() {
    if (null == _global) {
        ...
        else if ("TURBOPACK compile-time truthy", 1) e = /*TURBOPACK member replacement*/ __turbopack_context__.g;
...
function convertToTensor(e, t, n, r) {
    ...
    if ("string" !== o && [
        ...
        "int32",
        "float32"
    ].indexOf(r) >= 0 && (o = r), assertDtype(r, o, t, n), null == e || !isTypedArray(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e && "string" != typeof e) {
        var a = null == e ? "null" : e.constructor.name;
        throw new Error("Argument '" + t + "' passed to '" + n + "' must be a Tensor or TensorLike, but got '" + a + "'");
    }
    var i = inferShape(e);
    isTypedArray(e) || Array.isArray(e) || (e = [
        e
    ]);
    var s = "string" !== o ? toTypedArray(e, o, ENV.get("DEBUG")) : flatten(e);
    return Tensor.make(i, {
        values: s
    }, o);
}
function convertToTensorArray(e, t, n, r) {
...
function grad(e) {
    return assert(isFunction(e), function() {
        ...
        var r = convertToTensor(t, "x", "tf.grad", null), o = null != n ? convertToTensor(n, "dy", "tf.grad") : null;
        return ENV.engine.tidy(function() {
            var t = ENV.engine.gradients(function() {
                return e(r);
            }, [
                r
            ], o), n = t.value, a = t.grads;
            return null != o && assertShapesMatch(n.shape, o.shape, "The shape of dy passed in grad(f)(x, dy) must match the shape returned by f(x)"), checkGrads(a), a[0];
        });
    };
}
function grads(e) {
    return assert(isFunction(e), function() {
        ...
        assert(Array.isArray(t), function() {
            return "The args passed in grads(f)(args) must be an array of `Tensor`s or `TensorLike`s";
        });
        var r = convertToTensorArray(t, "args", "tf.grads", null), o = null != n ? convertToTensor(n, "dy", "tf.grads") : null;
        return ENV.engine.tidy(function() {
            var t = ENV.engine.gradients(function() {
                return e.apply(void 0, r);
            }, r, o), n = t.value, a = t.grads;
            return null != o && assertShapesMatch(n.shape, o.shape, "The shape of dy passed in grads(f)([x1,...], dy) must match the shape returned by f([x1,...])"), checkGrads(a), a;
        });
    };
}
function valueAndGrad(e) {
    return assert(isFunction(e), function() {
        ...
        assert(t instanceof Tensor, function() {
            return "The x passed in valueAndGrad(f)(x) must be a tensor";
        }), assert(null == n || n instanceof Tensor, function() {
...
function variableGrads(e, t) {
    if (assert(isFunction(e), function() {
        return "The f passed in variableGrads(f) must be a function";
    }), assert(null == t || Array.isArray(t) && t.every(function(e) {
        return e instanceof Variable;
    }), function() {
        return "The varList passed in variableGrads(f, varList) must be an array of variables";
    }), null == t) for(var n in t = [], ENV.engine.registeredVariables)t.push(ENV.engine.registeredVariables[n]);
    var r = t.length;
    ...
    }), assert(0 === a.rank, function() {
        return "The f passed in variableGrads(f) must return a scalar, but it returned a rank-" + a.rank + " tensor";
    });
    var s = {};
...
function assertAxesAreInnerMostDims(e, t, n) {
    assert(axesAreInnerMostDims(t, n), function() {
...
function assertParamsConsistent(e, t) {
    var n = e[0].length;
    e.forEach(function(e, t) {
        assert(e.length === n, function() {
            return "Error in concat" + n + "D: rank of tensors[" + t + "] must be the same as the rank of the rest (" + n + ")";
        });
    }), assert(t >= 0 && t < n, function() {
        return "Error in concat" + n + "D: axis must be between 0 and " + (n - 1) + ".";
    });
    var r = e[0];
    e.forEach(function(e, o) {
        for(var a = 0; a < n; a++)assert(a === t || e[a] === r[a], function() {
            return "Error in concat" + n + "D: Shape of tensors[" + o + "] (" + e + ") does not match the shape of the rest (" + r + ") along the non-concatenated axis " + o + ".";
        });
    });
}
...
function prepareAndValidate(e, t) {
    ...
    var c = computeStrides(e.shape).map(function(e) {
        return e / u;
    }).concat([
        1
    ]).slice(0, r);
...
function segOpComputeOptimalWindowSize(e, t) {
    var n, r = !1;
    for(e <= PARALLELIZE_THRESHOLD ? (n = e, r = !0) : n = nearestDivisor(e, Math.floor(Math.sqrt(e))); !r;)n > t || n === e ? r = !0 : n = nearestDivisor(e, n + 1);
    return n;
}
...
function assertParamsValid(e, t, n) {
    assert(e.rank === t.length, function() {
        return "Error in slice" + e.rank + "D: Length of begin " + t + " must match the rank of the array (" + e.rank + ").";
    }), assert(e.rank === n.length, function() {
        return "Error in slice" + e.rank + "D: Length of size " + n + " must match the rank of the array (" + e.rank + ").";
    });
    for(var r = function(r) {
        assert(t[r] + n[r] <= e.shape[r], function() {
            return "Error in slice" + e.rank + "D: begin[" + r + "] + size[" + r + "] (" + (t[r] + n[r]) + ") would overflow input.shape[" + r + "] (" + e.shape[r] + ")";
        });
    }, o = 0; o < e.rank; ++o)r(o);
}
function getStridedSlicedInfo(e, t, n, r, o, a, i, s, u) {
    ...
    for(var c = [], l = [], p = [], d = 0; d < e.length; d++)c[d] = startForAxis(o, t, r, e, d), l[d] = stopForAxis(a, n, r, e, d), u & 1 << d && (l[d] = c[d] + 1, p.push(d));
    var h = new Array(e.length).fill(0);
    return h = h.map(function(e, t) {
        for(var n = 0, o = r[t] || 1, a = c[t]; !(o > 0 ? a >= l[t] : a <= l[t]); a += o)n += 1;
        return n;
    }), [
        c,
        h,
...
function startForAxis(e, t, n, r, o) {
    var a = t[o], i = n[o] || 1;
    (e & 1 << o || null == a) && (a = i > 0 ? Number.MIN_SAFE_INTEGER : Number.MAX_SAFE_INTEGER);
    var s = r[o];
    return a < 0 && (a += s), a = clamp(0, a, s - 1);
}
function stopForAxis(e, t, n, r, o) {
    var a = t[o], i = n[o] || 1;
    (e & 1 << o || null == a) && (a = i > 0 ? Number.MAX_SAFE_INTEGER : Number.MIN_SAFE_INTEGER);
    var s = r[o];
    return a < 0 && (a += s), a = i > 0 ? clamp(0, a, s) : clamp(-1, a, s - 1);
}
...
function softmax_(e, t) {
    ...
    return customGrad(function(e, n) {
        var r = e.logSumExp([
            t
        ], !0), o = e.toFloat().sub(r).exp();
        n([
            o
        ]);
        return {
...
function logSoftmax_(e, t) {
    ...
    return customGrad(function(e, n) {
        var r = e.max(t, !0), o = e.sub(r), a = o.toFloat().sub(o.exp().sum(t, !0).log());
        n([
            a
        ]);
        return {
...
function onesLike_(e) {
    ...
    if ("complex64" === t.dtype) {
        var n = onesLike(real(t)), r = zerosLike(imag(t));
        return complex(n, r);
    }
    return ENV.engine.runKernel(function(e) {
        return e.onesLike(t);
...
var onesLike = op({
    ...
    return e.prototype.time = function(e) {
        ...
        throw new Error("Not yet implemented");
    }, e.prototype.isInf = function(e) {
        throw new Error("Not yet implemented");
    }, e.prototype.isFinite = function(e) {
        throw new Error("Not yet implemented");
        ...
        throw new Error("Not yet implemented.");
    }, e.prototype.onesLike = function(e) {
        throw new Error("Not yet implemented");
    }, e.prototype.zerosLike = function(e) {
        throw new Error("Not yet implemented");
...
function nonMaxSuppressionImpl(e, t, n, r, o) {
    for(var a = Array.from(t).map(function(e, t) {
        ...
        var u = a[s], c = u.score, l = u.boxIndex;
        if (c < o) break;
...
function intersectionOverUnion(e, t, n) {
    var r = e.subarray(4 * t, 4 * t + 4), o = e.subarray(4 * n, 4 * n + 4), a = Math.min(r[0], r[2]), i = Math.min(r[1], r[3]), s = Math.max(r[0], r[2]), u = Math.max(r[1], r[3]), c = Math.min(o[0], o[2]), l = Math.min(o[1], o[3]), p = Math.max(o[0], o[2]), d = Math.max(o[1], o[3]), h = (s - a) * (u - i), f = (p - c) * (d - l);
    if (h <= 0 || f <= 0) return 0;
    var m = Math.max(a, c), g = Math.max(i, l), v = Math.min(s, p), y = Math.min(u, d), x = Math.max(v - m, 0) * Math.max(y - g, 0);
    return x / (h + f - x);
}
...
function topkImpl(e, t, n, r, o) {
    for(var a = t[t.length - 1], i = [
        e.length / a,
        a
    ], s = i[0], u = i[1], c = getTypedArrayFromDType(n, s * r), l = getTypedArrayFromDType("int32", s * r), p = 0; p < s; p++){
        ...
        var g = p * r, v = c.subarray(g, g + r), y = l.subarray(g, g + r);
...
function getLogicalCoordinatesFromFlatIndex(e, t, n) {
    void 0 === n && (n = "index");
...
function dotify(e, t) {
    ...
    for(var n = [], r = Math.floor(e.length / 4), o = e.length % 4, a = 0; a < r; a++){
        var i = e.slice(4 * a, 4 * a + 4), s = t.slice(4 * a, 4 * a + 4);
        n.push(buildVec(i) + ", " + buildVec(s));
    }
    if (0 !== o) {
        i = e.slice(4 * r), s = t.slice(4 * r);
...
function makeShader(e, t, n, r) {
    ...
    }).join("\n"), c = t.texShape, l = getGlslDifferences(), p = getFloatTextureSampleSnippet(l), d = getShaderPrefix(l);
    return t.isPacked ? (a = getPackedOutputSamplingSnippet(t.logicalShape, c), i = getFloatTextureSetRGBASnippet(l)) : (a = getOutputSamplingSnippet(t.logicalShape, c), i = getFloatTextureSetRSnippet(l)), r && (d += SHADER_PACKED_PREFIX), [
        d,
        p,
        i,
        s,
...
function getSampler2D(e) {
    ...
    var i = squeezeShape(t), s = i.newShape, u = i.keptDims, c = s;
    ...
    var l = o[0], p = o[1], d = getFlatOffsetUniformName(n);
...
function getSampler3D(e) {
    var t = e.shapeInfo.logicalShape, n = e.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = t[1] * t[2], a = t[2], i = squeezeShape(t), s = i.newShape, u = i.keptDims, c = s;
    if (c.length < t.length) {
    ...
    var l = e.shapeInfo.texShape, p = l[0], d = l[1], h = e.shapeInfo.flatOffset;
...
function getPackedSamplerND(e) {
    for(var t = e.shapeInfo.logicalShape, n = t.length, r = e.name, o = "get" + r.charAt(0).toUpperCase() + r.slice(1), a = e.shapeInfo.texShape, i = [
        Math.ceil(a[0] / 2),
        Math.ceil(a[1] / 2)
    ], s = i[0], u = i[1], c = Math.ceil(t[n - 1] / 2), l = c * Math.ceil(t[n - 2] / 2), p = "int b, int row, int col", d = "b * " + l + " + (row / 2) * " + c + " + (col / 2)", h = 2; h < n - 1; h++)p = "int b" + h + ", " + p, d = "b" + h + " * " + (l *= t[n - h - 1]) + " + " + d;
    return "\n    vec4 " + o + "(" + p + ") {\n      int index = " + d + ";\n      int texR = index / " + u + ";\n      int texC = index - texR * " + u + ";\n      vec2 uv = (vec2(texC, texR) + halfCR) / vec2(" + u + ", " + s + ");\n      return " + getGlslDifferences().texture2D + "(" + r + ", uv);\n    }\n  ";
}
function getSampler4D(e) {
    var t = e.shapeInfo.logicalShape, n = e.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = t[3], a = t[2] * o, i = t[1] * a, s = squeezeShape(t), u = s.newShape, c = s.keptDims;
    ...
    var l = e.shapeInfo.flatOffset, p = e.shapeInfo.texShape, d = p[0], h = p[1];
    return h === i && null == l ? "\n      float " + r + "(int row, int col, int depth, int depth2) {\n        float texR = float(row);\n        float texC =\n            dot(vec3(col, depth, depth2),\n                vec3(" + a + ", " + o + ", 1));\n        vec2 uv = (vec2(texC, texR) + halfCR) /\n                   vec2(" + h + ".0, " + d + ".0);\n        return sampleTexture(" + n + ", uv);\n      }\n    " : h === o && null == l ? "\n      float " + r + "(int row, int col, int depth, int depth2) {\n        float texR = dot(vec3(row, col, depth),\n                         vec3(" + t[1] * t[2] + ", " + t[2] + ", 1));\n        float texC = float(depth2);\n        vec2 uv = (vec2(texC, texR) + halfCR) /\n                  vec2(" + h + ".0, " + d + ".0);\n        return sampleTexture(" + n + ", uv);\n      }\n    " : "\n    float " + r + "(int row, int col, int depth, int depth2) {\n      // Explicitly use integer operations as dot() only works on floats.\n      int index = row * " + i + " + col * " + a + " +\n          depth * " + o + " + depth2;\n      vec2 uv = uvFromFlat(" + d + ", " + h + ", index + " + getFlatOffsetUniformName(n) + ");\n      return sampleTexture(" + n + ", uv);\n    }\n  ";
}
function getSampler5D(e) {
    var t = e.shapeInfo.logicalShape, n = e.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = t[4], a = t[3] * o, i = t[2] * a, s = t[1] * i, u = squeezeShape(t), c = u.newShape, l = u.keptDims;
    if (c.length < t.length) {
...
function getSampler6D(e) {
    ...
    var s = t[5], u = t[4] * s, c = t[3] * u, l = t[2] * c, p = t[1] * l;
    if (e.shapeInfo.isUniform) return "\n      float " + r + "(int row, int col, int depth,\n                  int depth2, int depth3, int depth4) {\n        int index = round(dot(\n          vec4(row, col, depth, depth2),\n          vec4(" + p + ", " + l + ", " + c + ", " + u + ")) +\n          dot(\n            vec2(depth3, depth4),\n            vec2(" + s + ", 1)));\n        " + getUniformSampler(e) + "\n      }\n    ";
...
function getPackedSamplerAtOutputCoords(e, t) {
    var n, r = e.name, o = r.charAt(0).toUpperCase() + r.slice(1), a = "get" + o + "AtOutCoords", i = e.shapeInfo.logicalShape.length, s = t.logicalShape.length, u = getBroadcastDims(e.shapeInfo.logicalShape, t.logicalShape), c = getCoordsDataType(s), l = s - i, p = [
        "x",
        "y",
        "z",
        "w",
...
function getSamplerAtOutputCoords(e, t) {
    ...
    var c = getCoordsDataType(u), l = getBroadcastDims(e.shapeInfo.logicalShape, t.logicalShape), p = u - s, d = [
        "x",
        "y",
        "z",
        "w",
    ...
    return "\n    float " + o + "() {\n      " + c + " coords = getOutputCoords();\n      " + (0 === s ? "" : u < 2 && l.length >= 1 ? "coords = 0;" : l.map(function(e) {
...
var ArgMinMaxPackedProgram = function() {
    return function(e, t, n, r) {
        this.variableNames = [
            "A"
        ], this.usesPackedTextures = !0, assert(e.length > 2, function() {
        ...
        var i, s, u = this.outputShape, c = u.length, l = getCoordsDataType(c), p = getChannels("coords", c);
        if (1 === a) {
            var d = getCoordsDataType(s = c + 1);
        ...
        var h = [
            ...
            "u",
            "v"
        ].slice(0, s), f = "." + h[s - 1], m = h.map(function(e) {
            return "int " + e;
        }), g = getChannels("sourceLocR", s - 1).concat("inIdx.r"), v = getChannels("sourceLocG", s - 1).concat("inIdx.g"), y = getChannels("sourceLocB", s - 1).concat("inIdx.b"), x = getChannels("sourceLocA", s - 1).concat("inIdx.a"), E = "max" === n ? "greaterThan" : "lessThan", T = r ? "" : "\n          inIdx = round(vec4(getBestIndicesAChannel(" + g.join() + "),\n                             getBestIndicesAChannel(" + v.join() + "),\n                             getBestIndicesAChannel(" + y.join() + "),\n                             getBestIndicesAChannel(" + x.join() + ")));", b = "vec4(\n            getAChannel(" + g.join() + "),\n            hasNextCol ? getAChannel(" + v.join() + ") : 0.,\n            hasNextRow ? getAChannel(" + y.join() + ") : 0.,\n            hasNextRow && hasNextCol ? getAChannel(" + x.join() + ") : 0.)", w = r ? "" : "\n      float getBestIndicesAChannel(" + m.join() + ") {\n        return getChannel(getBestIndicesA(" + h.join() + "),\n                                          vec2(" + h.slice(-2).join() + "));\n      }";
    ...
    return function(e) {
        ...
        var t = e.filterHeight, n = e.filterWidth, r = e.strideHeight, o = e.strideWidth, a = e.dilationHeight, i = e.dilationWidth, s = e.effectiveFilterHeight, u = e.effectiveFilterWidth, c = s - 1 - e.padInfo.top, l = u - 1 - e.padInfo.left, p = 1 / (t * n);
    ...
    return function(e) {
        ...
        for(n = 1; n < t.length; n++){
            var o = t[n - 1];
            r.push("else if (yC < " + t[n] + ") setOutput(getT" + n + "(yR, yC-" + o + "));");
        }
        var a = t.length, i = t[t.length - 1];
        r.push("else setOutput(getT" + a + "(yR, yC-" + i + "));"), this.userCode = "\n      void main() {\n        ivec2 coords = getOutputCoords();\n        int yR = coords.x;\n        int yC = coords.y;\n\n        " + r.join("\n        ") + "\n      }\n    ";
    };
}(), ConcatPackedProgram = function() {
    return function(e, t) {
        this.usesPackedTextures = !0, this.outputShape = [], this.outputShape = computeOutShape(e, t);
        var n = this.outputShape, r = n.length, o = getCoordsDataType(r), a = getChannels("coords", r), i = [
            "x",
            "y",
            "z",
            "w",
        ...
        var c = i[t], l = "vec2(" + i.slice(-2).join() + ")", p = i.join(), d = "if (" + c + " < " + s[0] + ")\n          return getChannel(getT0(" + p + "), " + l + ");";
        for(u = 1; u < s.length; u++){
            var h = s[u - 1];
            d += "\n        else if (" + c + " < " + s[u] + ") {\n          " + c + " -= " + h + ";\n          return getChannel(getT" + u + "(" + p + "), " + l + ");\n        }";
        }
        var f = s.length;
        d += "\n        else {\n          " + c + " -= " + s[s.length - 1] + ";\n          return getChannel(getT" + f + "(" + p + "), " + l + ");\n        }", this.userCode = "\n      float getValue(" + i.map(function(e) {
            return "int " + e;
    ...
    return function(e) {
        ...
        var t = e.filterDepth, n = e.filterHeight, r = e.filterWidth, o = e.strideDepth, a = e.strideHeight, i = e.strideWidth, s = t - 1 - e.padInfo.front, u = n - 1 - e.padInfo.top, c = r - 1 - e.padInfo.left;
    ...
    return function(e) {
        ...
        var t = e.padInfo.top, n = e.padInfo.left, r = e.strideHeight, o = e.strideWidth, a = e.dilationHeight, i = e.dilationWidth, s = e.filterHeight, u = e.filterWidth, c = 4 * Math.floor(e.inChannels / 4), l = e.inChannels % 4;
    ...
    return function(e) {
        ...
        var t = e.padInfo.front, n = e.padInfo.top, r = e.padInfo.left, o = e.strideDepth, a = e.strideHeight, i = e.strideWidth, s = e.dilationDepth, u = e.dilationHeight, c = e.dilationWidth, l = e.filterDepth, p = e.filterHeight, d = e.filterWidth, h = 4 * Math.floor(e.inChannels / 4), f = e.inChannels % 4;
    ...
    return function(e) {
        ...
        var t = e.inHeight, n = e.inWidth, r = e.padInfo.top, o = e.padInfo.left, a = e.strideHeight, i = e.strideWidth, s = e.dilationHeight, u = e.dilationWidth, c = e.filterHeight, l = e.filterWidth, p = e.outChannels / e.inChannels;
    ...
    return function(e) {
        ...
        for(var t = e.inHeight, n = e.inWidth, r = e.padInfo.top, o = e.padInfo.left, a = e.strideHeight, i = e.strideWidth, s = e.dilationHeight, u = e.dilationWidth, c = e.filterHeight, l = e.filterWidth, p = l, d = "int xR; int xC; int xCOffset;", h = 0; h < c; h++)for(var f = 0; f < l; f++)d += "\n          vec4 xTexelR" + h + "C" + 2 * f + " = vec4(0.);\n          vec4 wR" + h + "C" + f + " = vec4(0.);\n          vec4 xR" + h + "C" + f + " = vec4(0.);";
        for(h = 0; h < c; h++)for(var m = 0; m < p; m++){
            if (d += "\n          xR = xRCorner + " + h * s + ";\n          xC = xCCorner + " + (f = 2 * m) * u + ";\n        ", 1 === i) {
        ...
        for(h = 0; h < c; h++)for(f = 0; f < l; f++)d += "result += xR" + h + "C" + f + " * wR" + h + "C" + f + ";";
        this.userCode = "\n      const ivec2 strides = ivec2(" + a + ", " + i + ");\n      const ivec2 pads = ivec2(" + r + ", " + o + ");\n\n      void main() {\n\n        ivec4 coords = getOutputCoords();\n        int batch = coords.x;\n        ivec2 xRCCorner = coords.yz * strides - pads;\n        int d2 = coords.w;\n        int d1 = d2;\n        int q = 0;\n        int xRCorner = xRCCorner.x;\n        int xCCorner = xRCCorner.y;\n\n        vec4 result = vec4(0.);\n\n        " + d + "\n\n        setOutput(result);\n      }\n    ";
    };
    ...
    return function(e, t, n, r, o) {
        ...
        var a = e[0], i = e[1], s = e[2], u = e[3], c = t[0], l = n[0], p = n[1];
        this.outputShape = [
            c,
            l,
            p,
...
var DepthToSpaceProgram = function() {
    ...
    return function(e, t, n) {
        ...
        var o = getCoordsDataType(this.rank), a = getSourceCoords$1(e, n);
...
function encodeMatrixToPackedRGBA(e, t, n, r, o) {
    for(var a = r % 2 == 1, i = n % 2 == 1, s = Math.floor(r / 2), u = Math.floor(n / 2), c = Math.ceil(r / 2), l = c * Math.ceil(n / 2), p = nearestLargerEven(n) * nearestLargerEven(r), d = 0; d < t; d++){
        for(var h = d * n * r, f = d * p, m = a ? 4 : 0, g = r, v = f, y = 0; y < u; ++y){
            for(var x = 2 * y * r, E = 0; E < s; ++E){
                var T = h + x + 2 * E;
                o[v] = e[T], o[v + 1] = e[T + 1], o[v + 2] = e[T + g], o[v + 3] = e[T + g + 1], v += 4;
            }
            v += m;
        }
        if (a) {
            T = h + r - 1, v = f + 4 * (c - 1);
            var b = 2 * r;
            for(m = 4 * c, y = 0; y < u; ++y)o[v] = e[T], o[v + 2] = e[T + r], T += b, v += m;
        }
        if (i) {
            for(T = h + (n - 1) * r, v = f + 4 * (l - c), E = 0; E < s; ++E)o[v++] = e[T++], o[v++] = e[T++], v += 2;
            a && i && (o[f + p - 4] = e[T]);
        }
    }
    return o;
...
function decodeMatrixFromPackedRGBA(e, t, n, r, o) {
    ...
    for(var i = r % 2 == 1, s = n % 2 == 1, u = Math.floor(r / 2), c = Math.floor(n / 2), l = Math.ceil(r / 2), p = l * Math.ceil(n / 2), d = nearestLargerEven(n) * nearestLargerEven(r), h = 0; h < t; h++){
        for(var f = h * n * r, m = h * d, g = i ? 4 : 0, v = r + (i ? 1 : 0), y = m, x = f, E = f + r, T = 0; T < c; ++T){
            for(var b = 0; b < u; ++b)o[x++] = e[y++], o[x++] = e[y++], o[E++] = e[y++], o[E++] = e[y++];
            y += g, x += v, E += v;
        }
        if (i) {
            y = m + 4 * (l - 1);
            var w = f + r - 1;
            for(g = 4 * l, v = 2 * r, T = 0; T < c; ++T)o[w] = e[y], o[w + r] = e[y + 2], y += g, w += v;
        }
        if (s) {
            for(y = m + 4 * (p - l), w = f + (n - 1) * r, b = 0; b < u; ++b)o[w++] = e[y++], o[w++] = e[y++], y += 2;
            i && (o[f + n * r - 1] = e[y]);
        }
    }
    return o;
}
function callAndCheck(e, t, n) {
    var r = n();
    return t && checkWebGLError(e), r;
}
...
function getExtensionOrThrow(e, t, n) {
    return throwIfNull(e, t, function() {
        return e.getExtension(n);
    }, 'Extension "' + n + '" not supported on this browser.');
}
function createVertexShader(e, t, n) {
    var r = throwIfNull(e, t, function() {
        return e.createShader(e.VERTEX_SHADER);
    }, "Unable to create vertex WebGLShader.");
    if (callAndCheck(e, t, function() {
        return e.shaderSource(r, n);
    }), callAndCheck(e, t, function() {
...
function createFragmentShader(e, t, n) {
    var r = throwIfNull(e, t, function() {
    ...
    if (callAndCheck(e, t, function() {
        ...
        return e.compileShader(r);
    }), !1 === e.getShaderParameter(r, e.COMPILE_STATUS)) throw logShaderSourceAndInfoLog(n, e.getShaderInfoLog(r)), new Error("Failed to compile fragment shader.");
    return r;
}
...
function logShaderSourceAndInfoLog(e, t) {
    ...
    var c = i.slice(0, r - 1), l = i.slice(r - 1, r), p = i.slice(r);
...
function linkProgram(e, t, n) {
    if (callAndCheck(e, t, function() {
        return e.linkProgram(n);
    }), !1 === e.getProgramParameter(n, e.LINK_STATUS)) throw console.log(e.getProgramInfoLog(n)), new Error("Failed to link vertex and fragment shaders.");
}
function validateProgram(e, t, n) {
    if (callAndCheck(e, t, function() {
...
function bindVertexBufferToProgramAttribute(e, t, n, r, o, a, i, s) {
    var u = e.getAttribLocation(n, r);
    return -1 !== u && (callAndCheck(e, t, function() {
        return e.bindBuffer(e.ARRAY_BUFFER, o);
    }), callAndCheck(e, t, function() {
        return e.vertexAttribPointer(u, a, e.FLOAT, !1, i, s);
    }), callAndCheck(e, t, function() {
        return e.enableVertexAttribArray(u);
    }), !0);
}
function bindTextureUnit(e, t, n, r) {
    validateTextureUnit(e, r), callAndCheck(e, t, function() {
        return e.activeTexture(e.TEXTURE0 + r);
    }), callAndCheck(e, t, function() {
        return e.bindTexture(e.TEXTURE_2D, n);
    });
}
function unbindTextureUnit(e, t, n) {
    validateTextureUnit(e, n), callAndCheck(e, t, function() {
        return e.activeTexture(e.TEXTURE0 + n);
    }), callAndCheck(e, t, function() {
        return e.bindTexture(e.TEXTURE_2D, null);
    });
}
function getProgramUniformLocationOrThrow(e, t, n, r) {
    return throwIfNull(e, t, function() {
...
function bindTextureToProgramUniformSampler(e, t, n, r, o, a) {
    callAndCheck(e, t, function() {
        return bindTextureUnit(e, t, r, a);
    }), callAndCheck(e, t, function() {
        return e.uniform1i(o, a);
    });
}
function bindCanvasToFramebuffer(e, t) {
    callAndCheck(e, t, function() {
...
function bindColorTextureToFramebuffer(e, t, n, r) {
    callAndCheck(e, t, function() {
...
function unbindColorTextureFromFramebuffer(e, t, n) {
    callAndCheck(e, t, function() {
...
function throwIfNull(e, t, n, r) {
    var o = callAndCheck(e, t, function() {
        return n();
    });
...
function getTextureShapeFromLogicalShape(e, t) {
    ...
    if (t && (r *= 2, 1 === (e = e.map(function(t, n) {
        return n >= e.length - 2 ? nearestLargerEven(e[n]) : e[n];
    })).length && (e = [
        2,
        e[0]
    ])), 2 !== e.length) {
        var o = squeezeShape(e);
        e = o.newShape;
    }
    var a = sizeFromShape(e);
    if (e.length <= 1 && a <= r) return [
        1,
        a
    ];
    if (2 === e.length && e[0] <= r && e[1] <= r) return e;
    if (3 === e.length && e[0] * e[1] <= r && e[2] <= r) return [
        e[0] * e[1],
        e[2]
    ];
    if (3 === e.length && e[0] <= r && e[1] * e[2] <= r) return [
        e[0],
        e[1] * e[2]
    ];
    if (4 === e.length && e[0] * e[1] * e[2] <= r && e[3] <= r) return [
        e[0] * e[1] * e[2],
        e[3]
    ];
    if (4 === e.length && e[0] <= r && e[1] * e[2] * e[3] <= r) return [
        e[0],
        e[1] * e[2] * e[3]
    ];
    if (t) {
        var i = getBatchDim(e), s = 2, u = 2;
        return e.length && (s = (n = getRowsCols(e))[0], u = n[1]), sizeToSquarishShape(a = i * (s / 2) * (u / 2)).map(function(e) {
            return 2 * e;
        });
    }
...
function createVertexShader$1(e, t) {
    var n = getGlslDifferences();
    return createVertexShader(e, t, n.version + "\n    precision highp float;\n    " + n.attribute + " vec3 clipSpacePos;\n    " + n.attribute + " vec2 uv;\n    " + n.varyingVs + " vec2 resultUV;\n\n    void main() {\n      gl_Position = vec4(clipSpacePos, 1);\n      resultUV = uv;\n    }");
}
function createVertexBuffer(e, t) {
    return createStaticVertexBuffer(e, t, new Float32Array([
        -1,
        1,
        0,
        0,
...
function createIndexBuffer(e, t) {
    return createStaticIndexBuffer(e, t, new Uint16Array([
        0,
        1,
        2,
        2,
...
function getTextureConfig(e, t) {
    var n, r, o, a, i, s, u, c, l = e;
    return 2 === ENV.get("WEBGL_VERSION") ? (n = l.R32F, r = l.R16F, o = l.RGBA16F, a = l.RGBA32F, i = l.RED, s = 4, u = 1, c = l.HALF_FLOAT) : (n = e.RGBA, r = e.RGBA, o = e.RGBA, a = l.RGBA, i = e.RGBA, s = 4, u = 4, c = null != t ? t.HALF_FLOAT_OES : null), {
...
function createAndConfigureTexture(e, t, n, r, o, a, i) {
    validateTextureSize(n, r);
    var s = createTexture(e, t), u = e.TEXTURE_2D;
    return callAndCheck(e, t, function() {
        ...
        return e.texImage2D(u, 0, o, n, r, 0, a, i, null);
    }), callAndCheck(e, t, function() {
        return e.bindTexture(e.TEXTURE_2D, null);
    }), s;
}
function createFloat32MatrixTexture(e, t, n, r, o) {
    var a = getUnpackedMatrixTextureShapeWidthHeight(n, r);
    return createAndConfigureTexture(e, t, a[0], a[1], o.internalFormatFloat, o.textureFormatFloat, e.FLOAT);
}
function createFloat16MatrixTexture(e, t, n, r, o) {
    var a = getUnpackedMatrixTextureShapeWidthHeight(n, r);
    return createAndConfigureTexture(e, t, a[0], a[1], o.internalFormatHalfFloat, o.textureFormatFloat, o.textureTypeHalfFloat);
}
function createUnsignedBytesMatrixTexture(e, t, n, r, o) {
    var a = getUnpackedMatrixTextureShapeWidthHeight(n, r);
    return createAndConfigureTexture(e, t, a[0], a[1], e.RGBA, e.RGBA, e.UNSIGNED_BYTE);
}
function createPackedMatrixTexture(e, t, n, r, o) {
    var a = getPackedMatrixTextureShapeWidthHeight(n, r);
    return createAndConfigureTexture(e, t, a[0], a[1], o.internalFormatPackedFloat, e.RGBA, e.FLOAT);
}
function createFloat16PackedMatrixTexture(e, t, n, r, o) {
    var a = getPackedMatrixTextureShapeWidthHeight(n, r);
    return createAndConfigureTexture(e, t, a[0], a[1], o.internalFormatPackedHalfFloat, e.RGBA, o.textureTypeHalfFloat);
}
function bindVertexProgramAttributeStreams(e, t, n, r) {
    return callAndCheck(e, t, function() {
        return e.bindBuffer(e.ARRAY_BUFFER, r);
    }), bindVertexBufferToProgramAttribute(e, t, n, "clipSpacePos", r, 3, 20, 0) && bindVertexBufferToProgramAttribute(e, t, n, "uv", r, 2, 20, 12);
}
function uploadPixelDataToTexture(e, t, n, r) {
    callAndCheck(e, t, function() {
        return e.bindTexture(e.TEXTURE_2D, n);
    }), callAndCheck(e, t, function() {
...
function uploadDataToTexture(e, t, n, r, o, a, i) {
    validateTextureSize(r, o), callAndCheck(e, t, function() {
        return e.bindTexture(e.TEXTURE_2D, n);
    }), callAndCheck(e, t, function() {
        return e.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, r, o, i, e.FLOAT, a);
    }), callAndCheck(e, t, function() {
        return e.bindTexture(e.TEXTURE_2D, null);
    });
}
function uploadMatrixToTexture(e, t, n, r, o, a, i, s) {
    var u, c = getUnpackedMatrixTextureShapeWidthHeight(r, o), l = c[0], p = c[1], d = r * o;
    1 === s.defaultNumChannels && d === a.length ? u = a : encodeMatrixToUnpackedArray(a, u = new Float32Array(d * i), i), uploadDataToTexture(e, t, n, l, p, u, s.textureFormatFloat);
}
function uploadMatrixToPackedTexture(e, t, n, r, o, a, i, s, u, c) {
    var l = getPackedMatrixTextureShapeWidthHeight(i, s), p = l[0], d = l[1], h = new Float32Array(getPackedRGBAArraySizeFromMatrixShape(i, s));
    encodeMatrixToPackedRGBA(u, r, o, a, h), uploadDataToTexture(e, t, n, p, d, h, e.RGBA);
}
function maybeCreateBufferFromOutputTexture(e, t, n, r, o, a) {
    var i = n;
    if (2 === ENV.get("WEBGL_VERSION")) {
        var s = e, u = s.createBuffer();
        callAndCheck(e, t, function() {
            return e.bindBuffer(s.PIXEL_PACK_BUFFER, u);
        });
        var c = 4 * getUnpackedArraySizeFromMatrixSize(r * o, a.downloadUnpackNumChannels);
        callAndCheck(e, t, function() {
            return e.bufferData(s.PIXEL_PACK_BUFFER, c, s.STREAM_READ);
        }), callAndCheck(e, t, function() {
            return s.readPixels(0, 0, o, r, e.RGBA, e.FLOAT, 0);
        }), callAndCheck(e, t, function() {
            return e.bindBuffer(s.PIXEL_PACK_BUFFER, null);
        }), i = u;
    }
    return i;
}
...
function downloadFloat32MatrixFromOutputTexture(e, t, n, r, o) {
    var a = getUnpackedMatrixTextureShapeWidthHeight(n, r), i = a[0], s = a[1], u = new Float32Array(getUnpackedArraySizeFromMatrixSize(n * r, o.downloadUnpackNumChannels));
    callAndCheck(e, t, function() {
        return e.readPixels(0, 0, i, s, o.downloadTextureFormat, e.FLOAT, u);
    });
    var c = new Float32Array(n * r);
    return decodeMatrixFromUnpackedArray(u, c, o.downloadUnpackNumChannels), c;
}
function downloadByteEncodedFloatMatrixFromOutputTexture(e, t, n, r, o) {
    var a = getUnpackedMatrixTextureShapeWidthHeight(n, r), i = a[0], s = a[1], u = new Uint8Array(getUnpackedArraySizeFromMatrixSize(n * r, 4));
    return callAndCheck(e, t, function() {
        return e.readPixels(0, 0, i, s, o.downloadTextureFormat, e.UNSIGNED_BYTE, u);
    }), new Float32Array(u.buffer);
}
function downloadPackedMatrixFromBuffer(e, t, n, r, o, a, i, s) {
    var u = e, c = new Float32Array(getPackedRGBAArraySizeFromMatrixShape(a, i));
    u.bindBuffer(u.PIXEL_PACK_BUFFER, t), u.getBufferSubData(u.PIXEL_PACK_BUFFER, 0, c), u.bindBuffer(u.PIXEL_PACK_BUFFER, null);
    var l = new Float32Array(sizeFromShape([
        n,
        r,
        o
    ]));
    return decodeMatrixFromPackedRGBA(c, n, r, o, l), l;
}
function downloadMatrixFromPackedOutputTexture(e, t, n, r, o, a, i, s) {
    var u = getPackedMatrixTextureShapeWidthHeight(a, i), c = u[0], l = u[1], p = new Float32Array(getPackedRGBAArraySizeFromMatrixShape(a, i));
    callAndCheck(e, t, function() {
        return e.readPixels(0, 0, c, l, e.RGBA, e.FLOAT, p);
    });
    var d = new Float32Array(sizeFromShape([
        n,
        r,
        o
    ]));
    return decodeMatrixFromPackedRGBA(p, n, r, o, d);
}
var gpgpu_util = Object.freeze({
    ...
    return Object.defineProperty(e.prototype, "debug", {
        ...
        if (!this.disposed) {
            ...
            var t = this.gl;
            callAndCheck(t, this.debug, function() {
                return t.finish();
            }), callAndCheck(t, this.debug, function() {
        ...
        return this.throwIfDisposed(), createFloat32MatrixTexture(this.gl, this.debug, e, t, this.textureConfig);
    }, e.prototype.createFloat16MatrixTexture = function(e, t) {
        return this.throwIfDisposed(), createFloat16MatrixTexture(this.gl, this.debug, e, t, this.textureConfig);
    }, e.prototype.createUnsignedBytesMatrixTexture = function(e, t) {
        return this.throwIfDisposed(), createUnsignedBytesMatrixTexture(this.gl, this.debug, e, t, this.textureConfig);
    }, e.prototype.uploadPixelDataToTexture = function(e, t) {
        this.throwIfDisposed(), uploadPixelDataToTexture(this.gl, this.debug, e, t);
    }, e.prototype.createFloat16PackedMatrixTexture = function(e, t) {
        return this.throwIfDisposed(), createFloat16PackedMatrixTexture(this.gl, this.debug, e, t, this.textureConfig);
    }, e.prototype.createPackedMatrixTexture = function(e, t) {
        return this.throwIfDisposed(), createPackedMatrixTexture(this.gl, this.debug, e, t, this.textureConfig);
    }, e.prototype.deleteMatrixTexture = function(e) {
        var t = this;
        this.throwIfDisposed(), this.outputTexture === e && (unbindColorTextureFromFramebuffer(this.gl, this.debug, this.framebuffer), this.outputTexture = null), callAndCheck(this.gl, this.debug, function() {
            return t.gl.deleteTexture(e);
        });
    }, e.prototype.uploadMatrixToTexture = function(e, t, n, r) {
        this.throwIfDisposed();
        var o = getNumChannels();
        return uploadMatrixToTexture(this.gl, this.debug, e, t, n, r, o, this.textureConfig);
    }, e.prototype.uploadMatrixToPackedTexture = function(e, t, n, r, o, a, i) {
        return this.throwIfDisposed(), uploadMatrixToPackedTexture(this.gl, this.debug, e, t, n, r, o, a, i, this.textureConfig);
    }, e.prototype.downloadFloat32MatrixFromOutputTexture = function(e, t, n) {
        var r = this;
        return this.downloadMatrixDriver(e, function() {
            return downloadFloat32MatrixFromOutputTexture(r.gl, r.debug, t, n, r.textureConfig);
        });
    }, e.prototype.downloadByteEncodedFloatMatrixFromOutputTexture = function(e, t, n) {
        var r = this;
        return this.downloadMatrixDriver(e, function() {
            return downloadByteEncodedFloatMatrixFromOutputTexture(r.gl, r.debug, t, n, r.textureConfig);
        });
    }, e.prototype.downloadPackedMatrixFromBuffer = function(e, t, n, r, o, a) {
        ...
        var r = maybeCreateBufferFromOutputTexture(this.gl, this.debug, e, t, n, this.textureConfig);
        ...
        var i = this;
        return this.downloadMatrixDriver(e, function() {
            return downloadMatrixFromPackedOutputTexture(i.gl, i.debug, t, n, r, o, a, i.textureConfig);
        });
    }, e.prototype.createProgram = function(e) {
        this.throwIfDisposed();
        var t = this.gl, n = createFragmentShader(t, this.debug, e), r = createVertexShader$1(t, this.debug), o = createProgram(t, this.debug);
        return callAndCheck(t, this.debug, function() {
            return t.attachShader(o, r);
        }), callAndCheck(t, this.debug, function() {
            return t.attachShader(o, n);
        }), linkProgram(t, this.debug, o), this.debug && validateProgram(t, this.debug, o), this.vertexAttrsAreBound || (this.setProgram(o), this.vertexAttrsAreBound = bindVertexProgramAttributeStreams(t, this.debug, this.program, this.vertexBuffer)), o;
    }, e.prototype.deleteProgram = function(e) {
        var t = this;
        this.throwIfDisposed(), e === this.program && (this.program = null), null != e && callAndCheck(this.gl, this.debug, function() {
            return t.gl.deleteProgram(e);
        });
    }, e.prototype.setProgram = function(e) {
        var t = this;
        this.throwIfDisposed(), this.program = e, null != this.program && this.debug && validateProgram(this.gl, this.debug, this.program), callAndCheck(this.gl, this.debug, function() {
            return t.gl.useProgram(e);
        });
    }, e.prototype.getUniformLocation = function(e, t, n) {
        return void 0 === n && (n = !0), this.throwIfDisposed(), n ? getProgramUniformLocationOrThrow(this.gl, this.debug, e, t) : getProgramUniformLocation(this.gl, e, t);
        ...
        this.throwIfDisposed(), this.throwIfNoProgram(), bindTextureToProgramUniformSampler(this.gl, this.debug, this.program, e, t, n);
        ...
        var e = this.gl;
        this.debug && this.debugValidate(), callAndCheck(e, this.debug, function() {
        ...
        this.throwIfDisposed(), bindColorTextureToFramebuffer(this.gl, this.debug, e, this.framebuffer), this.debug && validateFramebuffer(this.gl);
        ...
        this.throwIfDisposed();
        var r = this.gl;
        bindColorTextureToFramebuffer(r, this.debug, e, this.framebuffer), this.debug && validateFramebuffer(r), this.outputTexture = e, callAndCheck(r, this.debug, function() {
            return r.viewport(0, 0, t, n);
        }), callAndCheck(r, this.debug, function() {
...
function compileProgram(e, t, n, r) {
    var o = t.userCode, a = n.map(function(e, n) {
        var r = {
        ...
        flatOffset: null
    }, u = makeShader(a, s, o, t.usesPackedTextures), c = e.createProgram(u), l = null, p = null;
    1 === ENV.get("WEBGL_VERSION") && (l = e.getUniformLocation(c, "INFINITY", !1), p = e.getUniformLocation(c, "NAN", !1));
    for(var d = {}, h = 0; h < t.variableNames.length; h++){
        var f = t.variableNames[h];
        d[f] = e.getUniformLocation(c, f, !1), d["offset" + f] = e.getUniformLocation(c, "offset" + f, !1);
    }
    return {
        program: t,
        source: u,
...
function runProgram(e, t, n, r, o) {
    validateBinaryAndProgram(t.inShapeInfos, n), validateBinaryAndProgram([
        t.outShapeInfo
    ], [
        r
    ]);
    var a = r.texData.texture, i = r.texData.texShape;
    r.texData.isPacked ? e.setOutputPackedMatrixTexture(a, i[0], i[1]) : e.setOutputMatrixTexture(a, i[0], i[1]), e.setProgram(t.webGLProgram), 1 === ENV.get("WEBGL_VERSION") && (null !== t.infLoc && e.gl.uniform1f(t.infLoc, 1 / 0), null !== t.nanLoc && e.gl.uniform1f(t.nanLoc, NaN)), n.forEach(function(n, r) {
        var o = t.program.variableNames[r], a = t.uniformLocations[o], i = t.uniformLocations["offset" + o];
        if (null != a) if (n.isUniform) if (sizeFromShape(n.shape) < 2) e.gl.uniform1f(a, n.uniformValues[0]);
        else {
            var s = n.uniformValues;
            s instanceof Float32Array || (s = new Float32Array(s)), e.gl.uniform1fv(a, s);
        }
        else null != n.texData.slice && null != i && e.gl.uniform1i(i, n.texData.slice.flatOffset), e.setInputMatrixTexture(n.texData.texture, a, r);
    }), null != o && o(e, t.webGLProgram), e.executeProgram();
}
function makeShaderKey(e, t, n) {
    ...
    var o = e.userCode, a = e.constructor.name;
    return a += "_" + r + "_" + o;
}
var Im2ColPackedProgram = function() {
    return function(e, t, n) {
        ...
        var r = n.filterWidth, o = n.inChannels, a = n.strideWidth, i = n.strideHeight, s = n.padInfo, u = n.outWidth, c = n.dilationWidth, l = n.dilationHeight, p = s.left, d = s.top, h = o * r, f = getGlslDifferences();
    ...
    return function(e, t, n, r, o, a) {
        ...
        var i = n ? e[1] : e[2], s = Math.ceil(i / 2), u = n ? "i * 2, rc.y" : "rc.y, i * 2", c = r ? "rc.z, i * 2" : "i * 2, rc.z", l = n ? [
            "a.xxyy",
            "a.zzww"
        ] : [
            "a.xxzz",
        ...
        a && (d = "vec4 activation(vec4 x) {\n        " + a + "\n      }", h = "result = activation(result);");
        var f = o ? "result += getBiasAtOutCoords();" : "";
...
var PadProgram = function() {
    ...
    return function(e, t, n) {
        this.variableNames = [
            "x"
        ], this.usesPackedTextures = !0, this.outputShape = t.map(function(t, n) {
            return t[0] + e[n] + t[1];
        });
        for(var r = e.length, o = getCoordsDataType(r), a = t.map(function(e) {
            return e[0];
        }).join(","), i = t.map(function(t, n) {
            return t[0] + e[n];
        }).join(","), s = getChannels("rc", r), u = getChannels("source", r), c = s[r - 1] + " < " + this.outputShape[r - 1], l = 1 === r ? "source" : "vec2(" + u.slice(-2).join() + ")", p = [
            o + " rc = outputLoc;",
            s[r - 1] + " += 1;\n       if(" + c + ") {\n      ",
    ...
    return function(e, t, n) {
        ...
        var r = e.filterWidth, o = e.strideHeight, a = e.strideWidth, i = e.dilationHeight, s = e.dilationWidth, u = e.effectiveFilterHeight, c = e.effectiveFilterWidth, l = e.padInfo.top, p = e.padInfo.left;
        this.outputShape = e.outShape;
        var d = "avg" === t, h = "0.0";
    ...
    return function(e, t) {
        ...
        var c = 4 * Math.floor(n / 4), l = n % 4, p = "\n      if (" + ("sum" === t) + ") {\n        sumValue += dot(values, ones);\n      } else if (" + ("prod" === t) + ") {\n        vec2 tmp = vec2(values[0], values[1]) * vec2(values[2], values[3]);\n        prodValue *= tmp[0] * tmp[1];\n      } else {\n        minMaxValue = " + s + "(values, minMaxValue);\n      }\n    ", d = "vec4";
...
function getFlatIndex(e) {
    return "\n    int getFlatIndex(ivec3 coords) {\n      return round(" + dotify([
        ...
        "coords.y",
        "coords.z"
    ], computeStrides(e).map(function(e) {
        return e.toString();
    }).concat([
        "1."
    ])) + ");\n    }\n  ";
...
var ResizeBilinearBackpropProgram = function() {
    return function(e, t, n) {
        ...
        var r = t.shape, o = r[1], a = r[2], i = e.shape, s = i[1], u = i[2], c = [
            n && s > 1 ? o - 1 : o,
            n && u > 1 ? a - 1 : a
        ], l = [
            n && s > 1 ? s - 1 : s,
            n && u > 1 ? u - 1 : u
        ], p = c[0] / l[0], d = c[1] / l[1], h = 1 / p, f = 1 / d, m = 2 * Math.ceil(h) + 2, g = 2 * Math.ceil(f) + 2;
...
}(), ResizeBilinearPackedProgram = function() {
    return function(e, t, n, r) {
        this.variableNames = [
            "A"
    ...
    return function(e, t) {
        ...
        if (n > 4) throw new Error("WebGL backend: Reverse of rank-" + n + " tensor is not yet supported");
        this.outputShape = e;
        var r = getChannels("rc", n), o = r[n - 1] + " + 1 < " + this.outputShape[n - 1], a = r[n - 2] + " + 1 < " + this.outputShape[n - 2], i = getCoordsDataType(n);
        function s(n) {
    ...
    return function(e, t, n, r, o, a, i) {
        ...
        var s = getCoordsDataType(o.length), u = getCoordsDataType(a.length), c = "";
        1 === n ? c = "i" : 2 === n && (c = "i, j");
        var l = "getIndices(" + c + ")", p = "";
    ...
    function e(e) {
        ...
        var t, n = getCoordsDataType(this.rank), r = "uniform int start[" + this.rank + "];", o = getCoords$1(this.rank);
...
var SlicePackedProgram = function() {
    function e(e) {
        this.variableNames = [
            "source"
        ], this.usesPackedTextures = !0, this.outputShape = e, this.rank = e.length;
        var t = getCoordsDataType(this.rank), n = getChannels("coords", this.rank), r = getChannels("sourceLoc", this.rank), o = 1 === this.rank ? "sourceLoc" : "vec2(" + r.slice(-2).join() + ")", a = "getChannel(getSource(" + r.join() + "), " + o + ")", i = "\n      result.x = " + a + ";\n      if (++" + n[this.rank - 1] + " < " + e[this.rank - 1] + ") {\n        ++" + r[this.rank - 1] + ";\n        result.y = " + a + ";\n        --" + r[this.rank - 1] + ";\n      }\n    ", s = 1 === this.rank ? "" : "\n      --" + n[this.rank - 1] + ";\n      if (++" + n[this.rank - 2] + " < " + e[this.rank - 2] + ") {\n        ++" + r[this.rank - 2] + ";\n        result.z = " + a + ";\n        if (++" + n[this.rank - 1] + " < " + e[this.rank - 1] + ") {\n          ++" + r[this.rank - 1] + ";\n          result.w = " + a + ";\n        }\n      }\n    ", u = this.rank <= 4 ? "sourceLoc = coords +\n            " + t + "(" + e.map(function(e, t) {
            return "start[" + t + "]";
...
var TransposePackedProgram = function() {
    return function(e, t) {
        ...
        var o = getCoordsDataType(this.rank), a = getVecChannels("rc", this.rank), i = new Array(this.rank);
...
}(), ERF_P = .3275911, ERF_A1 = .254829592, ERF_A2 = -.284496736, ERF_A3 = 1.421413741, ERF_A4 = -1.453152027, ERF_A5 = 1.061405429, SELU_SCALEALPHA = 1.7580993408473768, SELU_SCALE = 1.0507009873554805, UnaryOpProgram = function() {
    return function(e, t) {
        this.variableNames = [
            "A"
...
function STEP(e) {
    return void 0 === e && (e = 0), CHECK_NAN_SNIPPET$2 + "\n    return x > 0.0 ? 1.0 : float(" + e + ");\n  ";
}
var NEG = "return -x;", CEIL = "return ceil(x);", FLOOR = "return floor(x);", SIGN = "\n  if (isnan(x)) { return 0.0; }\n  return sign(x);\n", IS_NAN = "return float(isnan(x));", IS_INF = "return float(isinf(x));", IS_FINITE = "return float(!isnan(x) && !isinf(x));", ROUND = "\n  // OpenGL ES does not support round function.\n  // The algorithm is based on banker's rounding.\n  float base = floor(x);\n  if ((x - base) < 0.5) {\n    return floor(x);\n  } else if ((x - base) > 0.5) {\n    return ceil(x);\n  } else {\n    if (mod(base, 2.0) == 0.0) {\n      return base;\n    } else {\n      return base + 1.0;\n    }\n  }\n", EXP = "return exp(x);", EXPM1 = "return exp(x) - 1.0;", LOG = "if (x < 0.0) return NAN;\n  return log(x);", LOG1P = "return log(1.0 + x);", SQRT = "return sqrt(x);", RSQRT = "return inversesqrt(x);", SIGMOID = "return 1.0 / (1.0 + exp(-1.0 * x));", SOFTPLUS = "\n  float epsilon = 1.1920928955078125e-7;\n  float threshold = log(epsilon) + 2.0;\n\n  bool too_large = x > -threshold;\n  bool too_small = x < threshold;\n\n  float result;\n  float exp_x = exp(x);\n\n  if (too_large){\n    result = x;\n  }\n  else if (too_small){\n    result = exp_x;\n  }\n  else{\n    result = log(exp_x + 1.0);\n  }\n  return result;\n", SIN = CHECK_NAN_SNIPPET$2 + "\n  return sin(x);\n", COS = CHECK_NAN_SNIPPET$2 + "\n  return cos(x);\n", TAN = "return tan(x);", ASIN = "return asin(x);", ACOS = "return acos(x);", ATAN = CHECK_NAN_SNIPPET$2 + "\n  return atan(x);\n", SINH = "\n  float e2x = exp(x);\n  return (e2x - 1.0 / e2x) / 2.0;\n", COSH = "\n  float e2x = exp(-x);\n  return (e2x + 1.0 / e2x) / 2.0;\n", TANH = "\n  float e2x = exp(-2.0 * abs(x));\n  return sign(x) * (1.0 - e2x) / (1.0 + e2x);\n", ASINH = "return log(x + sqrt(x * x + 1.0));", ACOSH = CHECK_NAN_SNIPPET$2 + "\n  if (x < 1.0) return NAN;\n  return log(x + sqrt(x * x - 1.0));", ATANH = CHECK_NAN_SNIPPET$2 + "\n  if ((x < -1.0) || (x > 1.0)) return NAN;\n  return (log(1.0 + x) - log(1.0 - x)) / 2.0;", ERF = '\n  // Error function is calculated approximately with elementary function.\n  // See "Handbook of Mathematical Functions with Formulas,\n  // Graphs, and Mathematical Tables", Abramowitz and Stegun.\n  float p = ' + ERF_P + ";\n  float a1 = " + ERF_A1 + ";\n  float a2 = " + ERF_A2 + ";\n  float a3 = " + ERF_A3 + ";\n  float a4 = " + ERF_A4 + ";\n  float a5 = " + ERF_A5 + ";\n\n  float t = 1.0 / (1.0 + p * x);\n  return 1.0 - (((((a5*t + a4)*t) + a3)*t + a2)*t + a1)*t*exp(-x*x);\n", SQUARE = "return x * x;", RECIPROCAL = "return 1.0 / x;", LOGICAL_NOT = "return float(!(x >= 1.0));", TO_INT = "return float(int(x));", CLONE = "return x;", LINEAR$1 = "return x;", LOG$1 = "\n  vec4 result = log(x);\n  vec4 isNaN = vec4(lessThan(x, vec4(0.0)));\n  result.r = isNaN.r == 1.0 ? NAN : result.r;\n  result.g = isNaN.g == 1.0 ? NAN : result.g;\n  result.b = isNaN.b == 1.0 ? NAN : result.b;\n  result.a = isNaN.a == 1.0 ? NAN : result.a;\n\n  return result;\n", RELU$1 = "\n  vec4 result = x * vec4(greaterThanEqual(x, vec4(0.0)));\n  bvec4 isNaN = isnan(x);\n\n  result.r = isNaN.r ? x.r : result.r;\n  result.g = isNaN.g ? x.g : result.g;\n  result.b = isNaN.b ? x.b : result.b;\n  result.a = isNaN.a ? x.a : result.a;\n\n  return result;\n", UnaryOpPackedProgram = function() {
    ...
    return function(e) {
        ...
        var t = e.length, n = getChannels("rc", t), r = getCoordsDataType(t), o = getSourceCoords(t, n), a = n.slice(-2), i = t <= 1 ? "rc" : "vec2(" + a.join(",") + ")";
...
function concat_(e, t) {
    void 0 === t && (t = 0), assert(e.length >= 1, function() {
...
function split_(e, t, n) {
    ...
    n = parseAxisParam(n, o.shape)[0], "number" == typeof t ? (assert(o.shape[n] % t == 0, function() {
        return "Number of splits must evenly divide the axis.";
    }), r = new Array(t).fill(o.shape[n] / t)) : (assert(o.shape[n] === t.reduce(function(e, t) {
        return e + t;
    }), function() {
...
var concat = op({
    ...
    split_: split_
}), commonjsGlobal = "undefined" != typeof window ? window : ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
...
var alea = createCommonjsModule(function(e) {
    !function(e, t, n) {
        ...
        t && t.exports ? t.exports = o : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : this.alea = o;
    }(0, e, !1);
    ...
    !function(e, t, n) {
        ...
        t && t.exports ? t.exports = o : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : this.xor128 = o;
    }(0, e, !1);
    ...
    !function(e, t, n) {
        ...
        t && t.exports ? t.exports = o : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : this.xorwow = o;
    }(0, e, !1);
    ...
    !function(e, t, n) {
        ...
        t && t.exports ? t.exports = o : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : this.xorshift7 = o;
    }(0, e, !1);
    ...
    !function(e, t, n) {
        ...
        t && t.exports ? t.exports = o : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : this.xor4096 = o;
    }(0, e, !1);
    ...
    !function(e, t, n) {
        ...
        t && t.exports ? t.exports = o : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : this.tychei = o;
    }(0, e, !1);
}), seedrandom = createCommonjsModule(function(e) {
    !function(t, n) {
        var r, o = this, a = 256, i = 6, s = "random", u = n.pow(a, i), c = n.pow(2, 52), l = 2 * c, p = a - 1;
        function d(e, d, g) {
            var v = [], y = f(function e(t, n) {
                ...
                for(var e = x.g(i), t = u, n = 0; e < c;)e = (e + n) * a, t *= a, n = x.g(1);
                for(; e >= l;)e /= 2, t /= 2, n >>>= 1;
                return (e + n) / t;
            };
            ...
            }, E.double = E, f(m(x.S), t), (d.pass || g || function(e, t, r, o) {
                return o && (o.S && h(o, x), e.state = function() {
                    return h(x, {});
                }), r ? (n[s] = e, t) : e;
            })(E, y, "global" in d ? d.global : this == n, d.state);
        }
        function h(e, t) {
...
function oneHot_(e, t, n, r) {
    ...
    var o = convertToTensor(e, "indices", "oneHot", "int32"), a = o.shape.concat([
        t
    ]);
    o = o.flatten();
    return ENV.engine.runKernel(function(e) {
...
function reshape_(e, t) {
    var n = convertToTensor(e, "x", "reshape", null);
    t = inferFromImplicitShape(t, n.size), assert(n.size === sizeFromShape(t), function() {
...
function tile_(e, t) {
    ...
    assert(n.rank === t.length, function() {
    ...
    return ENV.engine.runKernel(function(e, r) {
        ...
        return {
            $x: function() {
                var n = zerosLike(r);
                if (1 === r.rank) for(var o = 0; o < t[0]; ++o)n = n.add(e.slice([
                    o * r.shape[0]
                ], [
                    r.shape[0]
                ]));
                else if (2 === r.rank) for(o = 0; o < t[0]; ++o)for(var a = 0; a < t[1]; ++a)n = n.add(e.slice([
                    o * r.shape[0],
                    a * r.shape[1]
                ], [
                    r.shape[0],
                ...
                else if (3 === r.rank) for(o = 0; o < t[0]; ++o)for(a = 0; a < t[1]; ++a)for(var i = 0; i < t[2]; ++i)n = n.add(e.slice([
                    o * r.shape[0],
                    a * r.shape[1],
                    i * r.shape[2]
                ], [
                    ...
                    for(o = 0; o < t[0]; ++o)for(a = 0; a < t[1]; ++a)for(i = 0; i < t[2]; ++i)for(var s = 0; s < t[3]; ++s)n = n.add(e.slice([
                        o * r.shape[0],
                        a * r.shape[1],
                        i * r.shape[2],
                        s * r.shape[3]
...
function pad1d_(e, t, n) {
    return void 0 === n && (n = 0), assert(2 === t.length, function() {
...
function pad2d_(e, t, n) {
    return void 0 === n && (n = 0), assert(2 === t.length && 2 === t[0].length && 2 === t[1].length, function() {
        return "Invalid number of paddings. Must be length of 2 each.";
    }), pad(e, t, n);
}
function pad3d_(e, t, n) {
    return void 0 === n && (n = 0), assert(3 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length, function() {
        return "Invalid number of paddings. Must be length of 2 each.";
    }), pad(e, t, n);
}
function pad4d_(e, t, n) {
    return void 0 === n && (n = 0), assert(4 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length && 2 === t[3].length, function() {
        return "Invalid number of paddings. Must be length of 2 each.";
    }), pad(e, t, n);
}
function pad_(e, t, n) {
...
function stack_(e, t) {
    ...
    if (assert(n.length >= 1, function() {
        return "Pass at least one tensor to tf.stack";
    }), 1 === n.length) return n[0].expandDims(t);
...
function batchToSpaceND_(e, t, n) {
    ...
    assert(r.rank >= 1 + t.length, function() {
        return "input rank is " + r.rank + " but should be > than blockShape.length " + t.length;
    }), assert(n.length === t.length, function() {
        return "crops.length is " + n.length + " but should be equal to blockShape.length  " + t.length;
    }), assert(r.shape[0] % o == 0, function() {
        return "input tensor batch is " + r.shape[0] + " but is not divisible by the product of the elements of blockShape " + t.join(" * ") + " === " + o;
    });
    return ENV.engine.runKernel(function(e) {
...
function spaceToBatchND_(e, t, n) {
    ...
    }), assert(r.shape.reduce(function(e, r, o) {
...
function unstack_(e, t) {
    void 0 === t && (t = 0), t = t || 0;
    var n = convertToTensor(e, "x", "unstack");
    assert(t >= -n.shape.length && t < n.shape.length, function() {
...
function cumsum_(e, t, n, r) {
    ...
    var o = convertToTensor(e, "x", "cumsum"), a = getAxesPermutation([
        t |= 0
    ], o.rank), i = o;
...
function expandDims_(e, t) {
    ...
    assert(t <= n.rank, function() {
        return "Axis must be <= rank of the tensor";
    });
    var r = n.shape.slice();
    return t < 0 && (assert(-(n.rank + 1) <= t, function() {
        return "Axis must be in the interval [" + -(n.rank + 1) + ", " + n.rank + "]";
    }), t = n.rank + t + 1), r.splice(t, 0, 1), reshape(n, r);
}
function depthToSpace_(e, t, n) {
    void 0 === n && (n = "NHWC");
    var r = convertToTensor(e, "x", "depthToSpace"), o = "NHWC" === n ? r.shape[1] : r.shape[2], a = "NHWC" === n ? r.shape[2] : r.shape[3], i = "NHWC" === n ? r.shape[3] : r.shape[1];
    return assert(o * t >= 0, function() {
        return "Negative dimension size caused by overflow when multiplying\n      " + o + " and " + t + "  for depthToSpace with input shape\n      " + r.shape;
    }), assert(a * t >= 0, function() {
        return "Negative dimension size caused by overflow when multiplying\n      " + a + " and " + t + " for depthToSpace with input shape\n          " + r.shape;
    }), assert(i % (t * t) == 0, function() {
        return "Dimension size must be evenly divisible by " + t * t + " but is " + i + " for depthToSpace with input shape " + r.shape;
...
function setdiff1dAsync_(e, t) {
    return __awaiter(this, void 0, void 0, function() {
        var n, r, o, a, i, s, u, c, l, p;
        return __generator(this, function(d) {
            switch(d.label){
                case 0:
                    return n = convertToTensor(e, "x", "setdiff1d"), r = convertToTensor(t, "y", "setdiff1d"), assert(n.dtype === r.dtype, function() {
                        return "x and y should have the same dtype, but got x (" + n.dtype + ") and y (" + r.dtype + ").";
                    }), assert(1 === n.rank, function() {
                        return "x should be 1D tensor, but got x (" + n.shape + ").";
                    }), assert(1 === r.rank, function() {
                ...
                case 2:
                    for(a = d.sent(), i = new Set(a), s = 0, l = 0; l < o.length; l++)i.has(o[l]) || s++;
                    for(u = new TensorBuffer([
                        s
                    ], n.dtype), c = new TensorBuffer([
                        s
                    ], "int32"), l = 0, p = 0; l < o.length; l++)i.has(o[l]) || (u.values[p] = o[l], c.values[p] = l, p++);
                    return [
                        2,
                        [
                            u.toTensor(),
...
function buffer(e, t, n) {
    return void 0 === t && (t = "float32"), t = t || "float32", assertNonNegativeIntegerDimensions(e), new TensorBuffer(e, t, n);
}
function print(e, t) {
...
function getBinaryCache(e) {
    return e in binaryCaches ? binaryCaches[e] : (binaryCaches[e] = {}, binaryCaches[e]);
}
...
var CPU_HANDOFF_SIZE_THRESHOLD = 128, MATMUL_SHARED_DIM_THRESHOLD = 1e3, MathBackendWebGL = function() {
    function e(e) {
        if (this.gpgpu = e, this.pendingRead = new WeakMap, this.pendingDisposal = new WeakSet, this.dataRefCount = new WeakMap, this.lruDataGPU = [], this.numBytesInGPU = 0, this.uploadWaitMs = 0, this.downloadWaitMs = 0, this.disposed = !1, ENV.get("WEBGL_VERSION") < 1) throw new Error("WebGL is not supported on this device");
        if (null == e) {
            var t = getWebGLContext(ENV.get("WEBGL_VERSION"));
            this.binaryCache = getBinaryCache(ENV.get("WEBGL_VERSION")), this.gpgpu = new GPGPUContext(t), this.canvas = t.canvas, this.gpgpuCreatedLocally = !0;
        } else this.binaryCache = {}, this.gpgpuCreatedLocally = !1, this.canvas = e.gl.canvas;
    ...
    return e.prototype.register = function(e, t, n) {
        ...
        var o = this.texData.get(e), a = o.texture, i = o.texShape, s = o.usage, u = o.dtype, c = o.isPacked;
        if ("complex64" === u) throw new Error("Cannot write to a complex64 dtype. Please use tf.complex(real, imag).");
        null != a && (this.releaseTexture(e, a, i, s, u, c), o.texture = null, o.texShape = null), o.usage = TextureUsage.UPLOAD, o.values = t;
    }, e.prototype.readSync = function(e) {
        ...
        var l, p, d = null != this.activeTimers;
        (d && (l = performance.now()), "complex64" === r) ? p = mergeRealAndImagArrays(o.real.dataSync(), o.imag.dataSync()) : p = this.getValuesFromTexture(e);
        return d && (this.downloadWaitMs += performance.now() - l), this.convertAndCacheOnCPU(e, p);
    }, e.prototype.read = function(e) {
        return __awaiter(this, void 0, void 0, function() {
            var t, n, r, o, a, i, s, u, c, l, p, d, h, f, m, g, v, y, x, E, T, b, w, S;
            return __generator(this, function(C) {
                switch(C.label){
                    case 0:
                        if (this.pendingRead.has(e)) return r = this.pendingRead.get(e), [
                            2,
                            new Promise(function(e) {
                                return r.push(e);
                            })
                        ];
                        if (o = this.texData.get(e), a = o.texture, i = o.values, s = o.texShape, u = o.isPacked, c = o.shape, l = o.slice, p = o.dtype, null != l) return d = new UnaryOpProgram(c, CLONE), h = this.compileAndRun(d, [
                            {
                                dataId: e,
                                shape: c,
                                dtype: p
                    ...
                    case 1:
                        return C.sent(), v instanceof WebGLTexture ? y = this.getValuesFromTexture(e) : (x = sizeFromShape(c), u ? (E = getBatchDim(c), T = 1, b = 1, c.length && (n = getRowsCols(c), T = n[0], b = n[1]), y = this.gpgpu.downloadPackedMatrixFromBuffer(v, E, T, b, s[0], s[1]).subarray(0, x)) : y = this.gpgpu.downloadFloat32MatrixFromBuffer(v, s[0], s[1]).subarray(0, x)), w = this.convertAndCacheOnCPU(e, y), S = this.pendingRead.get(e), this.pendingRead.delete(e), S.forEach(function(e) {
                            return e(w);
                        }), this.pendingDisposal.has(e) && (this.pendingDisposal.delete(e), this.disposeData(e)), [
                            2,
                            w
                        ];
                }
        ...
        var t, n = this, r = this.texData.get(e), o = r.shape, a = r.dtype, i = r.texture, s = r.texShape, u = sizeFromShape(o);
        if (ENV.get("WEBGL_DOWNLOAD_FLOAT_ENABLED")) {
            if (this.texData.get(e).isPacked) {
                var c = getBatchDim(o), l = 1, p = 1;
                return o.length && (l = (t = getRowsCols(o))[0], p = t[1]), this.gpgpu.downloadMatrixFromPackedTexture(i, c, l, p, s[0], s[1]).subarray(0, u);
            }
            return this.gpgpu.downloadFloat32MatrixFromOutputTexture(i, s[0], s[1]).subarray(0, u);
        }
        var d = this.makeTensorHandle(o, "float32");
        d.size = sizeFromShape(o), this.texData.get(d.dataId).usage = TextureUsage.DOWNLOAD;
        var h = tidy(function() {
            var t = new EncodeFloatProgram(o);
        ...
        }), f = this.texData.get(h.dataId), m = this.gpgpu.downloadByteEncodedFloatMatrixFromOutputTexture(f.texture, f.texShape[0], f.texShape[1]).subarray(0, u);
        ...
        if (!this.pendingDisposal.has(e)) {
            if (this.pendingRead.has(e)) this.pendingDisposal.add(e);
                ...
                var t = this.texData.get(e), n = t.texture, r = t.dtype, o = t.texShape, a = t.usage, i = t.complexTensors, s = t.isPacked, u = t.slice;
                if (null != n) {
                    var c = u && u.origDataId || e, l = this.dataRefCount.get(c);
                    l > 1 ? this.dataRefCount.set(c, l - 1) : (this.dataRefCount.delete(c), this.releaseTexture(e, n, o, a, r, s), this.texData.delete(e));
                }
        ...
        if (r || !o) {
            var a = ENV.get("WEBGL_PACK_ARRAY_OPERATIONS") ? new SlicePackedProgram(n) : new SliceProgram(n), i = a.getCustomSetupFunc(t);
        ...
        var r = this.texData.get(e.dataId), o = Tensor.make(n, {}, e.dtype, this), a = this.texData.get(o.dataId);
        ...
        if (this.shouldExecuteOnCPU([
            e
        ])) return this.cpuBackend.stridedSlice(e, t, n, r, o, a, i, s, u);
        var c = getStridedSlicedInfo(e.shape, t, n, r, o, a, i, s, u), l = c[0], p = c[1], d = c[2], h = p.filter(function(e, t) {
            return -1 === d.indexOf(t);
        });
        if (h.some(function(e) {
            return 0 === e;
        })) return tensor([], h);
        var f = new StridedSliceProgram(l, r, p, d);
        return this.compileAndRun(f, [
            e
        ]);
    }, e.prototype.reverse = function(e, t) {
        var n = ENV.get("WEBGL_PACK_ARRAY_OPERATIONS") ? new ReversePackedProgram(e.shape, t) : new ReverseProgram(e.shape, t);
        ...
        if (e.length > ENV.get("WEBGL_MAX_TEXTURES_IN_SHADER")) {
            var n = Math.floor(e.length / 2), r = this.concat(e.slice(0, n), t), o = this.concat(e.slice(n), t);
            return this.concat([
                r,
                o
            ], t);
        }
        if (ENV.get("WEBGL_PACK_ARRAY_OPERATIONS") && e[0].rank > 1) {
            var a = new ConcatPackedProgram(e.map(function(e) {
                return e.shape;
            }), t);
            return this.compileAndRun(a, e);
        }
        var i = computeOutShape(e.map(function(e) {
            return e.shape;
        }), t), s = e.map(function(e) {
            return e.as2D(-1, sizeFromShape(e.shape.slice(t)));
        }), u = new ConcatProgram(s.map(function(e) {
            return e.shape;
        }));
        return this.compileAndRun(u, s).reshape(i);
    }, e.prototype.neg = function(e) {
        ...
        if ((1 === o || 1 === a) && i > MATMUL_SHARED_DIM_THRESHOLD) {
            ...
            var u = 1 === a ? e : e.as3D(s, i, 1), c = 1 === a ? 2 : 1, l = 1 === a ? t.as3D(s, 1, i) : t;
            return this.multiply(u, l).sum(c, !0);
        }
        var p = upcastType(e.dtype, t.dtype), d = new MatMulPackedProgram(e.shape, [
            s,
            o,
            a
        ], n, r), h = this.makePackedTensor(d.outputShape, p);
        return this.compileAndRun(d, [
            e,
            t
        ], h);
    }, e.prototype.fusedBatchMatMul = function(e, t, n, r, o, a) {
        var i = n ? e.shape[2] : e.shape[1], s = r ? t.shape[1] : t.shape[2], u = e.shape[0], c = upcastType(e.dtype, t.dtype), l = new MatMulPackedProgram(e.shape, [
            u,
            i,
            s
        ], n, r, !!o, a ? mapActivationToShaderProgram(a, !0) : null), p = this.makePackedTensor(l.outputShape, c), d = [
            e,
            t
        ];
        return o && d.push(o), this.compileAndRun(l, d, p);
    }, e.prototype.multiply = function(e, t) {
        if ("complex64" === e.dtype) {
            ...
            ], s = this.compileAndRun(o, i), u = this.compileAndRun(a, i), c = this.complex(s, u);
        ...
        var l = new BinaryOpProgram(MUL, e.shape, t.shape), p = this.makeOutputArray(l.outputShape, e.dtype);
        ...
        if (null != o && (u = o.shape, i.push(o)), ENV.get("WEBGL_PACK_BATCHNORMALIZATION")) {
            var c = new BatchNormPackedProgram(e.shape, t.shape, n.shape, s, u, r);
        ...
        if (this.shouldExecuteOnCPU([
            e
        ])) return this.cpuBackend.transpose(e, t);
        var n = ENV.get("WEBGL_PACK_ARRAY_OPERATIONS") ? new TransposePackedProgram(e.shape, t) : new TransposeProgram(e.shape, t);
        return this.compileAndRun(n, [
            e
        ]);
    }, e.prototype.gather = function(e, t, n) {
        if (this.shouldExecuteOnCPU([
            e,
            t
        ])) return this.cpuBackend.gather(e, t, n);
        ...
        assert(e.rank <= 4, function() {
            return "batchToSpaceND for rank > 4 with a WebGL backend not implemented yet";
        });
        var r = t.reduce(function(e, t) {
            return e * t;
        }), o = getReshaped(e.shape, t, r), a = getPermuted(o.length, t.length), i = getReshapedPermuted(e.shape, t, r), s = getSliceBeginCoords(n, t.length), u = getSliceSize(i, n, t.length);
        ...
        o.push.apply(o, n);
        for(var a = 1 + t.length; a < e.shape.length; ++a)o.push([
            0,
            0
        ]);
        var i = e.pad(o), s = getReshaped(i.shape, t, r, !1), u = getPermuted(s.length, t.length, !1), c = getReshapedPermuted(i.shape, t, r, !1);
        ...
        var r = e.shape[0], o = e.shape[1], a = computeOptimalWindowSize(o), i = new ReduceProgram({
            ...
            inSize: o,
            batchSize: r
        }, t), s = i.outputShape, u = s[0], c = s[1], l = this.makeOutputArray([
            u,
            c
        ], n);
        return this.compileAndRun(i, [
            e
        ], l), 1 === l.shape[1] ? l : this.reduce(l, t, n);
        ...
        var a = computeOptimalWindowSize(o), i = new ArgMinMaxProgram({
            ...
            inSize: o,
            batchSize: r
        }, t, null == n), s = i.outputShape, u = s[0], c = s[1], l = this.makeOutputArray([
            u,
            c
        ], "int32"), p = [
            e
        ];
        return null != n && p.push(n), this.compileAndRun(i, p, l), 1 === l.shape[1] ? l : this.argReduce(e, t, l);
    }, e.prototype.argReducePacked = function(e, t, n) {
        void 0 === n && (n = null);
        var r = null != n ? n.shape : e.shape, o = computeOptimalWindowSize(r[r.length - 1]), a = new ArgMinMaxPackedProgram(r, o, t, null == n), i = this.makePackedTensor(a.outputShape, "int32"), s = null == n ? [
            e
        ] : [
            e,
            n
        ];
        return this.compileAndRun(a, s, i), i.rank === e.rank ? this.argReducePacked(e, t, i) : i;
    }, e.prototype.sum = function(e, t) {
        ...
        if (this.shouldExecuteOnCPU([
            e
        ])) return this.cpuBackend.prod(e, t);
        var n = computeOutAndReduceShapes(e.shape, t), r = n[0], o = sizeFromShape(n[1]), a = e.as2D(-1, o), i = sumOutType(e.dtype);
        ...
        var i = computeOutShape$1(a.shape, r, n), s = sizeFromShape([
            a.shape[r]
        ]), u = a.as2D(-1, s), c = sumOutType(e.dtype), l = this.segOpCompute(u, "unsortedSegmentSum", t, c, n).reshape(i);
        return null != o && (l = l.transpose(getUndoAxesPermutation(o))), l;
        ...
        var a = e.shape[0], i = e.shape[1], s = segOpComputeOptimalWindowSize(i, o), u = new SegmentOpProgram({
            ...
            batchSize: a,
            numSegments: o
        }, t), c = u.outputShape, l = c[0], p = c[1], d = this.makeOutputArray([
            l,
            p
        ], r);
    ...
    }, e.prototype.argMinMaxReduce = function(e, t, n) {
        var r = [
            t
        ];
        if (assertAxesAreInnerMostDims("arg" + n.charAt(0).toUpperCase() + n.slice(1), r, e.rank), !ENV.get("WEBGL_PACK_REDUCE") || e.rank <= 2) {
            var o = computeOutAndReduceShapes(e.shape, r), a = o[0], i = sizeFromShape(o[1]), s = e.as2D(-1, i);
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, EQUAL$1, "bool");
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, NOT_EQUAL$1, "bool");
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, LESS$1, "bool");
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, LESS_EQUAL$1, "bool");
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, GREATER$1, "bool");
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, GREATER_EQUAL$1, "bool");
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, LOGICAL_AND$1, "bool");
        ...
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, LOGICAL_OR$1, "bool");
        ...
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS") ? new BinaryOpPackedProgram(MIN$1, e.shape, t.shape) : new BinaryOpProgram(MIN, e.shape, t.shape);
        return this.compileAndRun(n, [
            e,
            t
        ]);
    }, e.prototype.mod = function(e, t) {
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS") ? new BinaryOpPackedProgram(MOD$1, e.shape, t.shape) : new BinaryOpProgram(MOD, e.shape, t.shape);
        return this.compileAndRun(n, [
            e,
            t
        ]);
        ...
        if (this.shouldExecuteOnCPU([
            e
        ])) return this.cpuBackend.max(e, t);
        ...
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS") ? new BinaryOpPackedProgram(MAX$1, e.shape, t.shape) : new BinaryOpProgram(MAX, e.shape, t.shape);
        return this.compileAndRun(n, [
            e,
            t
        ]);
        ...
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS") ? new BinaryOpPackedProgram(SQUARED_DIFFERENCE, e.shape, t.shape) : new BinaryOpProgram(SQUARED_DIFFERENCE, e.shape, t.shape);
        return this.compileAndRun(n, [
            e,
            t
        ]);
        ...
        var n = INT_DIV;
        if (ENV.get("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(e, t, INT_DIV$1, "int32");
        ...
        if (this.shouldExecuteOnCPU([
            e,
            t
        ])) return this.cpuBackend.add(e, t);
        var n = upcastType(e.dtype, t.dtype);
    ...
    }, e.prototype.packedBinaryOp = function(e, t, n, r) {
        ...
        var r = this, o = this.texData.get(e.dataId), a = this.texData.get(t.dataId), i = [
            [
            ...
            var a = o[0], i = o[1], s = r.makeComplexComponentTensorHandle(e, a), u = r.makeComplexComponentTensorHandle(t, i), c = new BinaryOpProgram(n, e.shape, t.shape), l = r.makeOutputArray(c.outputShape, upcastType(a.dtype, i.dtype));
        ...
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS"), r = n ? new BinaryOpPackedProgram(POW$1, e.shape, t.shape) : new BinaryOpProgram(POW, e.shape, t.shape), o = upcastType(e.dtype, t.dtype), a = n ? this.makePackedTensor(r.outputShape, o) : this.makeOutputArray(r.outputShape, o);
        return this.compileAndRun(r, [
            e,
            t
        ], a);
        ...
        var t = new UnaryOpProgram(e.shape, IS_NAN), n = this.makeOutputArray(t.outputShape, "bool");
        return this.compileAndRun(t, [
            e
        ], n);
    }, e.prototype.isInf = function(e) {
        var t = new UnaryOpProgram(e.shape, IS_INF), n = this.makeOutputArray(t.outputShape, "bool");
        return this.compileAndRun(t, [
            e
        ], n);
    }, e.prototype.isFinite = function(e) {
        var t = new UnaryOpProgram(e.shape, IS_FINITE), n = this.makeOutputArray(t.outputShape, "bool");
        return this.compileAndRun(t, [
            e
        ], n);
    }, e.prototype.round = function(e) {
        ...
        var t;
        return t = ENV.get("WEBGL_PACK") ? new UnaryOpPackedProgram(e.shape, LOG$1) : new UnaryOpProgram(e.shape, LOG), this.compileAndRun(t, [
            e
        ]);
    }, e.prototype.log1p = function(e) {
        ...
        if (this.shouldExecuteOnCPU([
            e
        ])) return this.cpuBackend.rsqrt(e);
        ...
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS") ? new BinaryOpPackedProgram(PRELU$1, e.shape, t.shape) : new BinaryOpProgram(PRELU, e.shape, t.shape);
        return this.compileAndRun(n, [
            e,
            t
        ]);
        ...
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS") ? new BinaryOpPackedProgram(ELU_DER$1, e.shape, t.shape) : new BinaryOpProgram(ELU_DER, e.shape, t.shape);
        return this.compileAndRun(n, [
            e,
            t
        ]);
        ...
        var n = ENV.get("WEBGL_PACK_BINARY_OPERATIONS") ? new BinaryOpPackedProgram(ATAN2$1, e.shape, t.shape) : new BinaryOpProgram(ATAN2, e.shape, t.shape);
        return this.compileAndRun(n, [
            e,
            t
        ]);
    ...
    }, e.prototype.conv2dByMatMul = function(e, t, n) {
        var r = e.shape, o = this.texData.get(e.dataId), a = n.inChannels, i = r[0] * r[1] * r[2], s = n.outChannels, u = (1 === i || 1 === s) && a > MATMUL_SHARED_DIM_THRESHOLD, c = r[2] % 2 != 0 && !!o.isPacked;
        if (u || !ENV.get("WEBGL_LAZILY_UNPACK") || !ENV.get("WEBGL_PACK_BINARY_OPERATIONS") || !c) {
            var l = this.reshape(e, [
                1,
                r[0] * r[1] * r[2],
                n.inChannels
            ]), p = this.reshape(t, [
            ...
            return this.reshape(this.batchMatMul(l, p, !1, !1), n.outShape);
        }
        var d = Tensor.make([
            1,
            r[0] * r[1] * (r[2] + 1),
            ...
            dataId: e.dataId
        }, e.dtype, this), h = o.shape;
        o.shape = o.shape.slice(), o.shape[o.shape.length - 2]++, assert(isReshapeFree(o.shape, d.shape), function() {
            return "packed reshape " + o.shape + " to " + d.shape + " isn't free";
        });
        var f = this.reshape(t, [
            1,
            n.inChannels,
            n.outChannels
        ]), m = this.batchMatMul(d, f, !1, !1), g = this.texData.get(m.dataId);
        return assert(g.isPacked, function() {
            return "batchMatMul result is expected to be packed";
        }), o.shape = h, g.shape = n.outShape, Tensor.make(n.outShape, {
            dataId: m.dataId
        }, m.dtype, this);
    }, e.prototype.conv2dWithIm2Row = function(e, t, n) {
        var r = n.filterWidth, o = n.filterHeight, a = n.inChannels, i = n.outWidth, s = n.outHeight, u = r * o * a, c = s * i, l = [
            u,
            c
        ], p = e.squeeze([
            0
            ...
            u,
            -1
        ]), h = new Im2ColPackedProgram(l, p.shape, n), f = this.compileAndRun(h, [
            p
        ]).reshape([
            1,
            l[0],
            l[1]
        ]), m = new MatMulPackedProgram(f.shape, [
            1,
            c,
            n.outChannels
        ], !0, !1);
        ...
        if (1 === n.filterHeight && 1 === n.filterWidth && 1 === n.dilationHeight && 1 === n.dilationWidth && 1 === n.strideHeight && 1 === n.strideWidth && ("SAME" === n.padInfo.type || "VALID" === n.padInfo.type)) return this.conv2dByMatMul(e, t, n);
        ...
        return !n.isPacked || isReshapeFree(e.shape, t) || null !== n.texture && isReshapeFree(n.shape, t) ? reshapeTensor(e, t) : this.packedReshape(e, t);
    }, e.prototype.resizeBilinear = function(e, t, n, r) {
        var o = ENV.get("WEBGL_PACK_IMAGE_OPERATIONS") ? new ResizeBilinearPackedProgram(e.shape, t, n, r) : new ResizeBilinearProgram(e.shape, t, n, r);
        return this.compileAndRun(o, [
            e
        ]);
    }, e.prototype.resizeBilinearBackprop = function(e, t, n) {
        ...
        var o = t ? e : softmax(e), a = o.shape[0], i = o.shape[1], s = new MultinomialProgram(a, i, n), u = this.makeOutputArray(s.outputShape, "int32"), c = s.getCustomSetupFunc(r);
        return this.compileAndRun(s, [
            o
        ], u, c);
    }, e.prototype.oneHot = function(e, t, n, r) {
        ...
        var r = e.shape[0], o = "NHWC" === n ? e.shape[1] : e.shape[2], a = "NHWC" === n ? e.shape[2] : e.shape[3], i = "NHWC" === n ? e.shape[3] : e.shape[1], s = o * t, u = a * t, c = i / (t * t), l = new DepthToSpaceProgram("NHWC" === n ? [
            r,
            s,
            u,
            c
        ...
        var r = calculateShapes(t, e, n), o = r.sliceRank, a = r.numUpdates, i = r.sliceSize, s = r.strides, u = r.outputSize, c = [
            u / i,
            i
        ], l = e.reshape([
            a,
        ...
        var d = scalar(0), h = new ScatterProgram(a, o, l.rank, p.rank, s, c);
        ...
        var o = calculateShapes(t, e, n), a = o.sliceRank, i = o.numUpdates, s = o.strides, u = o.outputSize, c = new ScatterProgram(i, a, e.rank, t.rank, s, [
            u,
            1
        ], !1);
        ...
        var n = t.shape, r = n[n.length - 1], o = prepareAndValidate(e, t), a = o[0], i = o[1], s = o[2], u = o[3], c = t.reshape([
            i,
            r
        ]), l = e.reshape([
            e.size / s,
        ...
        if ("string" === (n = n || inferDtype(t))) {
            var r = getArrayFromDType(n, sizeFromShape(e));
            return r.fill(t), Tensor.make(e, {
                values: r
            }, n);
        }
        var o = new FillProgram(e, t), a = o.getCustomSetupFunc(t), i = this.makeOutputArray(e, n);
        ...
        var a = this;
        if (void 0 === o && (o = !0), null == n && (n = e.usesPackedTextures ? this.makePackedTensor(e.outputShape, t[0].dtype) : this.makeOutputArray(e.outputShape, t[0].dtype)), 0 === n.size) return this.texData.get(n.dataId).values = getTypedArrayFromDType(n.dtype, 0), n;
        var i = t.map(function(t) {
            ...
            } else if (!!n.isPacked != !!e.usesPackedTextures) t = n.isPacked ? a.unpackTensor(t) : a.packTensor(t), n = a.texData.get(t.dataId);
            else if (n.isPacked && !isReshapeFree(n.shape, t.shape)) {
                var r = t, o = t.shape;
                t.shape = n.shape, t = a.packedReshape(t, o), n = a.texData.get(t.dataId), r.shape = o;
            }
        ...
        var s, u = {
            ...
            isUniform: !1
        }, c = makeShaderKey(e, i, u), l = this.getAndSaveBinary(c, function() {
            return compileProgram(a.gpgpu, e, i, u);
        }), p = null != this.activeTimers;
        p && (s = this.startTimer()), runProgram(this.gpgpu, l, i, u, r);
        var d = 1024 * ENV.get("WEBGL_NUM_MB_BEFORE_PAGING");
        if (o && this.numBytesInGPU > d) for(var h = this.numBytesInGPU - d; h > 0 && this.lruDataGPU.length > 0;){
            var f = this.lruDataGPU.shift(), m = this.texData.get(f), g = m.texShape, v = m.dtype;
            h -= this.computeBytes(g, v), this.read(f);
        }
        return p && (s = this.endTimer(s), this.activeTimers.push({
            name: e.constructor.name,
            query: this.getQueryTime(s)
        })), ENV.get("WEBGL_LAZILY_UNPACK") || !this.texData.get(n.dataId).isPacked || e.isPackShader ? n : this.unpackTensor(n);
        ...
        var t, n = this.texData.get(e), r = n.shape, o = n.dtype, a = n.values, i = n.texture, s = n.usage, u = n.isPacked;
        if (null == i) {
            var c, l = null != this.activeTimers;
            l && (c = performance.now());
            var p = getTextureShapeFromLogicalShape(r, u);
            n.texShape = p;
            var d = this.acquireTexture(e, p, s, o, u);
            if (n.texture = d, null != a) {
                if (u) {
                    var h = getBatchDim(r), f = 1, m = 1;
                    r.length && (f = (t = getRowsCols(r))[0], m = t[1]), this.gpgpu.uploadMatrixToPackedTexture(d, h, f, m, p[0], p[1], typedArrayToFloat32(a));
                } else this.gpgpu.uploadMatrixToTexture(d, p[0], p[1], typedArrayToFloat32(a));
                n.values = null, l && (this.uploadWaitMs += performance.now() - c);
            }
        } else {
            ENV.get("WEBGL_NUM_MB_BEFORE_PAGING") < Number.POSITIVE_INFINITY && this.lruDataGPU.indexOf(e) >= 0 && (this.lruDataGPU.splice(this.lruDataGPU.indexOf(e), 1), this.lruDataGPU.push(e));
        }
    }, e.prototype.convertAndCacheOnCPU = function(e, t) {
        var n = this.texData.get(e), r = n.texture, o = n.texShape, a = n.dtype, i = n.usage, s = n.isPacked;
        return null != r && (this.releaseTexture(e, r, o, i, a, s), n.texture = null, n.texShape = null, n.isPacked = !1), n.usage = TextureUsage.UPLOAD, null != t && (n.values = float32ToTypedArray(t, a)), n.values;
    }, e.prototype.releaseTexture = function(e, t, n, r, o, a) {
        if (ENV.get("WEBGL_NUM_MB_BEFORE_PAGING") < Number.POSITIVE_INFINITY) {
            var i = this.lruDataGPU.indexOf(e);
            i >= 0 && this.lruDataGPU.splice(i, 1);
        }
        this.numBytesInGPU -= this.computeBytes(n, o), this.textureManager.releaseTexture(t, n, r, a);
    }, e.prototype.acquireTexture = function(e, t, n, r, o) {
        return ENV.get("WEBGL_NUM_MB_BEFORE_PAGING") < Number.POSITIVE_INFINITY && this.lruDataGPU.push(e), this.numBytesInGPU += this.computeBytes(t, r), this.textureManager.acquireTexture(t, n, o);
...
function sqrt_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.div(n.toFloat().sqrt().mul(2));
            }
        };
    });
}
function rsqrt_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.div(n.pow(1.5).mul(2)).neg();
            }
        };
    });
}
...
function clipByValue_(e, t, n) {
    ...
    return ENV.engine.runKernel(function(e, o) {
        var a = e.clip(r, t, n);
        return o([
            r
        ]), a;
        ...
        return {
            $x: function() {
                return e.where(o.greaterEqual(t).logicalAnd(o.lessEqual(n)), zerosLike(e));
            }
        };
    });
}
...
function cos_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return n.toFloat().sin().neg().mul(e);
            }
        };
    });
}
...
function asin_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.divStrict(scalar(1).sub(n.toFloat().square()).sqrt());
            }
        };
    });
}
function acos_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.divStrict(scalar(1).sub(n.toFloat().square()).sqrt()).neg();
            }
        };
    });
}
function atan_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.div(n.toFloat().square().add(1));
            }
        };
    });
}
function sinh_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return n.toFloat().cosh().mulStrict(e);
            }
        };
    });
}
function cosh_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return n.toFloat().sinh().mulStrict(e);
            }
        };
    });
}
...
function asinh_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.divStrict(scalar(1).add(n.toFloat().square()).sqrt());
            }
        };
    });
}
function acosh_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.divStrict(n.toFloat().square().sub(1).sqrt());
            }
        };
    });
}
function atanh_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.div(scalar(1).sub(n.toFloat().square()));
            }
        };
    });
}
function erf_(e) {
    ...
    assert("int32" === t.dtype || "float32" === t.dtype, function() {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.mul(n.square().neg().exp().mul(2 / Math.sqrt(Math.PI)));
            }
        };
    });
}
...
function batchNorm2d_(e, t, n, r, o, a) {
    var i, s, u = convertToTensor(e, "x", "batchNorm"), c = convertToTensor(t, "mean", "batchNorm"), l = convertToTensor(n, "variance", "batchNorm");
    return null != o && (i = convertToTensor(o, "scale", "batchNorm")), null != r && (s = convertToTensor(r, "offset", "batchNorm")), assert(2 === u.rank, function() {
        return "Error in batchNorm3D: x must be rank 3 but got rank " + u.rank + ".";
    }), assert(2 === c.rank || 1 === c.rank, function() {
        return "Error in batchNorm2D: mean must be rank 2 or rank 1 but got rank " + c.rank + ".";
    }), assert(2 === l.rank || 1 === l.rank, function() {
        return "Error in batchNorm2D: variance must be rank 2 or rank 1 but got rank " + l.rank + ".";
    }), null != i && assert(2 === i.rank || 1 === i.rank, function() {
        return "Error in batchNorm2D: scale must be rank 2 or rank 1 but got rank " + i.rank + ".";
    }), null != s && assert(2 === s.rank || 1 === s.rank, function() {
        return "Error in batchNorm2D: offset must be rank 2 or rank 1 but got rank " + s.rank + ".";
    }), batchNorm_(u, c, l, s, i, a);
}
function batchNorm3d_(e, t, n, r, o, a) {
    var i, s, u = convertToTensor(e, "x", "batchNorm"), c = convertToTensor(t, "mean", "batchNorm"), l = convertToTensor(n, "variance", "batchNorm");
    return null != o && (i = convertToTensor(o, "scale", "batchNorm")), null != r && (s = convertToTensor(r, "offset", "batchNorm")), assert(3 === u.rank, function() {
        return "Error in batchNorm3D: x must be rank 3 but got rank " + u.rank + ".";
    }), assert(3 === c.rank || 1 === c.rank, function() {
        return "Error in batchNorm3D: mean must be rank 3 or rank 1 but got rank " + c.rank + ".";
    }), assert(3 === l.rank || 1 === l.rank, function() {
        return "Error in batchNorm3D: variance must be rank 3 or rank 1 but got rank " + l.rank + ".";
    }), null != i && assert(3 === i.rank || 1 === i.rank, function() {
        return "Error in batchNorm3D: scale must be rank 3 or rank 1 but got rank " + i.rank + ".";
    }), null != s && assert(3 === s.rank || 1 === s.rank, function() {
        return "Error in batchNorm3D: offset must be rank 3 or rank 1 but got rank " + s.rank + ".";
    }), batchNorm_(u, c, l, s, i, a);
}
function batchNorm4d_(e, t, n, r, o, a) {
    var i, s, u = convertToTensor(e, "x", "batchNorm"), c = convertToTensor(t, "mean", "batchNorm"), l = convertToTensor(n, "variance", "batchNorm");
    return null != o && (i = convertToTensor(o, "scale", "batchNorm")), null != r && (s = convertToTensor(r, "offset", "batchNorm")), assert(4 === u.rank, function() {
        return "Error in batchNorm4D: x must be rank 4 but got rank " + u.rank + ".";
    }), assert(4 === c.rank || 1 === c.rank, function() {
        return "Error in batchNorm4D: mean must be rank 4 or rank 1 but got rank " + c.rank + ".";
    }), assert(4 === l.rank || 1 === l.rank, function() {
        return "Error in batchNorm4D: variance must be rank 4 or rank 1 but got rank " + l.rank + ".";
    }), null != i && assert(4 === i.rank || 1 === i.rank, function() {
        return "Error in batchNorm4D: scale must be rank 4 or rank 1 but got rank " + i.rank + ".";
    }), null != s && assert(4 === s.rank || 1 === s.rank, function() {
        return "Error in batchNorm4D: offset must be rank 4 or rank 1 but got rank " + s.rank + ".";
    }), batchNorm_(u, c, l, s, i, a);
}
function batchNormalization_(e, t, n, r, o, a) {
    return void 0 === r && (r = .001), warnDeprecation(), batchNorm_(e, t, n, a, o, r);
}
function batchNorm_(e, t, n, r, o, a) {
    null == a && (a = .001);
    var i, s, u, c = convertToTensor(e, "x", "batchNorm"), l = convertToTensor(t, "mean", "batchNorm"), p = convertToTensor(n, "variance", "batchNorm");
    null != o && (i = convertToTensor(o, "scale", "batchNorm")), null != r && (s = convertToTensor(r, "offset", "batchNorm")), assert(l.rank === p.rank, function() {
        return "Batch normalization gradient requires mean and variance to have equal ranks.";
    }), assert(null == s || l.rank === s.rank, function() {
        return "Batch normalization gradient requires mean and offset to have equal ranks.";
    }), assert(null == i || l.rank === i.rank, function() {
    ...
    return ENV.engine.runKernel(function(e, t) {
        var n = e.batchNormalization(u, batchnormReshape4D(l), batchnormReshape4D(p), a, batchnormReshape4D(i), batchnormReshape4D(s));
        return t([
            c,
            l,
            p,
        ...
        var n = t[0], r = t[1], o = t[2], i = t[3], s = null == i ? scalar(1) : i, c = getReductionAxes(r.shape, u.shape), l = [];
        if (1 === r.rank) {
            for(var p = 0; p < u.shape.length - 1; ++p)l.push(u.shape[p]);
            l.push(1);
        }
        var d = n.sub(r), h = e.mul(s), f = rsqrt(o.add(scalar(a))), m = f.mul(f).mul(f).mul(scalar(-.5));
        return {
            $x: function() {
                return 1 === r.rank ? e.mul(tile(f.as4D(1, 1, 1, r.shape[0]), l)).mul(s).reshape(n.shape) : e.mul(f).mul(s).reshape(n.shape);
            },
            $mean: function() {
                var e = f.mul(scalar(-1)).mul(h);
...
function batchNormalization2d_(e, t, n, r, o, a) {
    return void 0 === r && (r = .001), warnDeprecation(), batchNorm2d_(e, t, n, a, o, r);
}
function batchNormalization3d_(e, t, n, r, o, a) {
    return void 0 === r && (r = .001), warnDeprecation(), batchNorm3d_(e, t, n, a, o, r);
}
function batchNormalization4d_(e, t, n, r, o, a) {
    return void 0 === r && (r = .001), warnDeprecation(), batchNorm4d_(e, t, n, a, o, r);
}
...
function computePool2DInfo(e, t, n, r, o, a, i) {
    ...
    var s, u = parseTupleParam(t), c = u[0], l = u[1];
    if ("channelsLast" === i) s = [
        c,
        l,
        e[3],
...
function computeConv2DInfo(e, t, n, r, o, a, i, s) {
    ...
    var u = [
        ...
        -1,
        -1
    ], c = u[0], l = u[1], p = u[2], d = u[3];
    if ("channelsLast" === s) c = e[0], l = e[1], p = e[2], d = e[3];
    else {
        if ("channelsFirst" !== s) throw new Error("Unknown dataFormat " + s);
        c = e[0], d = e[1], l = e[2], p = e[3];
    }
    var h, f = t[0], m = t[1], g = t[3], v = parseTupleParam(n), y = v[0], x = v[1], E = parseTupleParam(r), T = E[0], b = E[1], w = getEffectiveFilterSize(f, T), S = getEffectiveFilterSize(m, b), C = getPadAndOutInfo(o, l, p, y, x, w, S, a), A = C.padInfo, N = C.outHeight, _ = C.outWidth, R = i ? g * d : g;
...
function computeConv3DInfo(e, t, n, r, o, a, i) {
    ...
    var s = [
        ...
        -1,
        -1
    ], u = s[0], c = s[1], l = s[2], p = s[3], d = s[4];
    if ("channelsLast" === i) u = e[0], c = e[1], l = e[2], p = e[3], d = e[4];
    else {
        if ("channelsFirst" !== i) throw new Error("Unknown dataFormat " + i);
        u = e[0], d = e[1], c = e[2], l = e[3], p = e[4];
    }
    var h, f = t[0], m = t[1], g = t[2], v = t[4], y = parse3TupleParam(n), x = y[0], E = y[1], T = y[2], b = parse3TupleParam(r), w = b[0], S = b[1], C = b[2], A = get3DPadAndOutInfo(o, c, l, p, x, E, T, getEffectiveFilterSize(f, w), getEffectiveFilterSize(m, S), getEffectiveFilterSize(g, C)), N = A.padInfo, _ = A.outDepth, R = A.outHeight, I = A.outWidth, k = a ? v * d : v;
...
function getPadAndOutInfo(e, t, n, r, o, a, i, s) {
    ...
    if ("number" == typeof e) {
        ...
        c = Math.ceil(t / r), l = Math.ceil(n / o);
        var d = Math.max(0, (c - 1) * r + a - t), h = Math.max(0, (l - 1) * o + i - n), f = Math.floor(d / 2), m = d - f, g = Math.floor(h / 2);
        u = {
            top: f,
            bottom: m,
            left: g,
        ...
        u = {
            ...
            right: 0,
            type: "VALID"
        }, c = Math.ceil((t - a + 1) / r), l = Math.ceil((n - i + 1) / o);
    }
    return {
        padInfo: u,
        outHeight: c,
...
function get3DPadAndOutInfo(e, t, n, r, o, a, i, s, u, c) {
    var l, p, d, h;
    if ("same" === e) {
        var f = ((p = Math.ceil(t / o)) - 1) * o + s - t, m = ((d = Math.ceil(n / a)) - 1) * a + u - n, g = ((h = Math.ceil(r / i)) - 1) * i + c - r, v = Math.floor(f / 2), y = f - v, x = Math.floor(m / 2), E = m - x, T = Math.floor(g / 2);
        l = {
            top: x,
            bottom: E,
            left: T,
        ...
        l = {
            ...
            back: 0,
            type: "VALID"
        }, p = Math.ceil((t - s + 1) / o), d = Math.ceil((n - u + 1) / a), h = Math.ceil((r - c + 1) / i);
    }
    return {
        padInfo: l,
        outDepth: p,
...
function conv1d_(e, t, n, r, o, a, i) {
    ...
    return l ? h.as2D(h.shape[2], h.shape[3]) : h.as3D(h.shape[0], h.shape[2], h.shape[3]);
}
function conv2d_(e, t, n, r, o, a, i) {
    ...
    var s = convertToTensor(e, "x", "conv2d"), u = convertToTensor(t, "filter", "conv2d"), c = s, l = !1;
    3 === s.rank && (l = !0, c = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])), assert(4 === c.rank, function() {
        return "Error in conv2d: input must be rank 4, but got rank " + c.rank + ".";
    }), assert(4 === u.rank, function() {
    ...
    }), assert(c.shape[3] === u.shape[2], function() {
    ...
    }), assert("NHWC" === o, function() {
        return "Error in conv2d: got dataFormat of " + o + " but only NHWC is currently supported.";
    });
    var p = computeConv2DInfo(c.shape, u.shape, n, a, r, i), d = ENV.engine.runKernel(function(e, t) {
        var n = e.conv2d(c, u, p);
        return t([
            u,
            c
        ]), n;
        ...
        var o = t, i = o[0], s = o[1];
        return assert(tupleValuesAreOne(a), function() {
            return "Error in gradient of conv2D: dilation rates greater than 1 are not yet supported in gradients. Got dilations '" + a + "'";
        }), {
            x: function() {
                return conv2dDerInput_(s.shape, e, i, n, r);
            },
            $filter: function() {
                return conv2dDerFilter_(s, e, i.shape, n, r);
            }
        };
    });
...
function conv2dDerInput_(e, t, n, r, o, a) {
    assert(e.length === t.rank, function() {
    ...
    var p = computeConv2DInfo(i, n.shape, r, 1, o, a), d = ENV.engine.runKernel(function(e, t) {
        ...
        return {
            ...
            filter: function() {
                return conv2dDerFilter(e, i, n.shape, r, o, a);
            }
        };
    });
...
function conv2dDerFilter_(e, t, n, r, o, a) {
    ...
    var s = t;
    3 === s.rank && (s = t.as4D(1, t.shape[0], t.shape[1], t.shape[2])), assert(4 === i.rank, function() {
...
function depthwiseConv2d_(e, t, n, r, o, a, i) {
    ...
    var s = convertToTensor(e, "x", "depthwiseConv2d"), u = convertToTensor(t, "filter", "depthwiseConv2d"), c = s, l = !1;
    3 === s.rank && (l = !0, c = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])), assert(4 === c.rank, function() {
    ...
    var p = computeConv2DInfo(c.shape, u.shape, n, a, r, i, !0), d = ENV.engine.runKernel(function(e, t) {
        var n = e.depthwiseConv2D(c, u, p);
        return t([
            c,
            u
        ]), n;
        ...
        assert(tupleValuesAreOne(a), function() {
            return "Error in gradient of depthwiseConv2d: dilation rates greater than 1 are not yet supported. Got dilations '" + a + "'";
        });
        var n = t[0], r = t[1];
        return {
            x: function() {
                return depthwiseConv2dDerInput(n.shape, e, r, p);
            },
            $filter: function() {
                return depthwiseConv2dDerFilter(n, e, r.shape, p);
            }
        };
    });
    return l ? d.as3D(d.shape[1], d.shape[2], d.shape[3]) : d;
...
function separableConv2d_(e, t, n, r, o, a, i) {
    ...
    var s = convertToTensor(e, "x", "separableConv2d"), u = convertToTensor(t, "depthwiseFilter", "separableConv2d"), c = convertToTensor(n, "pointwiseFilter", "separableConv2d"), l = s, p = !1;
    if (3 === s.rank && (p = !0, l = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])), "NCHW" === i) throw new Error("separableConv2d currently does not support dataFormat NCHW; only NHWC is supported");
    assert(4 === l.rank, function() {
    ...
    assert(c.shape[2] === d * h, function() {
        return "Error in separableConv2d: the third dimension of pointwise filter must be " + d * h + ", but got " + c.shape[2] + ".";
    });
    var f = depthwiseConv2d(l, u, r, o, i, a), m = conv2d(f, c, 1, "valid", i);
...
function conv3d_(e, t, n, r, o, a) {
    void 0 === o && (o = "NHWC"), void 0 === a && (a = [
        1,
        1,
        1
    ]);
    var i = convertToTensor(e, "x", "conv3d"), s = convertToTensor(t, "filter", "conv3d"), u = i, c = !1;
    4 === i.rank && (c = !0, u = i.as5D(1, i.shape[0], i.shape[1], i.shape[2], i.shape[3])), assert(5 === u.rank, function() {
        return "Error in conv3d: input must be rank 5, but got rank " + u.rank + ".";
    }), assert(5 === s.rank, function() {
        return "Error in conv3d: filter must be rank 5, but got rank " + s.rank + ".";
    }), assert(u.shape[4] === s.shape[3], function() {
        return "Error in conv3d: depth of input (" + u.shape[4] + ") must match input depth for filter " + s.shape[3] + ".";
    }), assert(eitherStridesOrDilationsAreOne$1(n, a), function() {
        return "Error in conv3D: Either strides or dilations must be 1. Got strides " + n + " and dilations '" + a + "'";
    }), assert("NHWC" === o, function() {
        return "Error in conv3d: got dataFormat of " + o + " but only NHWC is currently supported.";
    });
    var l = computeConv3DInfo(u.shape, s.shape, n, a, r), p = ENV.engine.runKernel(function(e, t) {
        var n = e.conv3d(u, s, l);
        return t([
            u,
            s
        ]), n;
...
function matMul_(e, t, n, r) {
    ...
    var a = convertToTensor(e, "a", "matMul"), i = convertToTensor(t, "b", "matMul");
    o = makeTypesMatch(a, i), a = o[0], i = o[1];
    var s = n ? a.shape[a.rank - 2] : a.shape[a.rank - 1], u = r ? i.shape[i.rank - 1] : i.shape[i.rank - 2], c = n ? a.shape[a.rank - 1] : a.shape[a.rank - 2], l = r ? i.shape[i.rank - 2] : i.shape[i.rank - 1], p = a.shape.slice(0, -2), d = i.shape.slice(0, -2), h = sizeFromShape(p), f = sizeFromShape(d);
    assert(a.rank >= 2 && i.rank >= 2 && a.rank === i.rank, function() {
        return "Error in matMul: inputs must have the same rank of at least 2, got ranks " + a.rank + " and " + i.rank + ".";
    }), assert(arraysEqual(p, d), function() {
        return "Error in matMul: outer dimensions (" + p + ") and (" + d + ") of Tensors with shapes " + a.shape + " and " + i.shape + " must match.";
    }), assert(s === u, function() {
    ...
    var m = a.shape.slice(0, -2).concat([
        c,
        l
    ]), g = n ? a.as3D(h, s, c) : a.as3D(h, c, s), v = r ? i.as3D(f, l, u) : i.as3D(f, u, l);
    return ENV.engine.runKernel(function(e, t) {
        var o = e.batchMatMul(g, v, n, r);
        return t([
            g,
            v
        ]), o;
        ...
        return n || r ? !n && r ? {
            $a: function() {
                return e.matMul(i, !1, !1);
            },
            $b: function() {
                return e.matMul(a, !0, !1);
            }
        } : n && !r ? {
            $a: function() {
                return i.matMul(e, !1, !0);
            },
            $b: function() {
                return a.matMul(e, !1, !1);
            }
        } : {
            $a: function() {
                return i.matMul(e, !0, !0);
            },
            $b: function() {
                return e.matMul(a, !0, !0);
            }
        } : {
            $a: function() {
                return e.matMul(i, !1, !0);
            },
            $b: function() {
                return a.matMul(e, !0, !1);
            }
        };
    }).reshape(m);
}
function outerProduct_(e, t) {
    ...
    return assert(1 === n.rank && 1 === r.rank, function() {
...
function dot_(e, t) {
    ...
    assert(!(1 !== n.rank && 2 !== n.rank || 1 !== r.rank && 2 !== r.rank), function() {
...
function maxPoolImpl_(e, t, n, r, o, a) {
    ...
    }), assert(eitherStridesOrDilationsAreOne(n, r), function() {
    ...
    var c = computePool2DInfo(s.shape, t, n, r, o, a), l = ENV.engine.runKernel(function(e, t) {
        var n = e.maxPool(s, c);
        return t([
            s,
            n
        ...
        return {
            x: function() {
                return maxPoolBackprop(e, i, s, t, n, r, o);
            }
        };
    });
...
function avgPoolImpl_(e, t, n, r, o, a) {
    ...
    var s = i, u = !1;
    3 === i.rank && (u = !0, s = i.as4D(1, i.shape[0], i.shape[1], i.shape[2])), assert(4 === s.rank, function() {
    ...
    var c = computePool2DInfo(s.shape, t, n, r, o, a), l = ENV.engine.runKernel(function(e) {
        return e.avgPool(s, c);
    }, {
        x: s
    }, function(e) {
        return {
...
function pool_(e, t, n, r, o, a) {
    ...
    var i = convertToTensor(e, "x", "maxPool"), s = i, u = !1;
    3 === i.rank && (u = !0, s = i.as4D(1, i.shape[0], i.shape[1], i.shape[2])), assert(eitherStridesOrDilationsAreOne(a, o), function() {
        return "Error in pool: Either strides or dilations must be 1. Got strides " + a + " and dilations '" + o + "'";
    });
    var c, l = computePool2DInfo(s.shape, t, a, o, r), p = [
        l.dilationHeight,
        l.dilationWidth
    ];
    c = "same" === r ? withSpaceToBatchBasePaddings([
        l.filterHeight,
        l.filterWidth
    ], p) : [
        [
    ...
    var d = 1 === p[0] && 1 === p[1], h = requiredSpaceToBatchPaddings([
        l.inHeight,
        l.inWidth
    ], p, c), f = h[0], m = h[1], g = d ? r : "valid", v = d ? s : spaceToBatchND(s, p, f), y = ("avg" === n ? function() {
...
function maxPoolBackprop(e, t, n, r, o, a, i, s) {
    var u = convertToTensor(e, "dy", "maxPoolBackprop"), c = convertToTensor(t, "input", "maxPoolBackprop"), l = convertToTensor(n, "output", "maxPoolBackprop");
    assert(c.rank === u.rank, function() {
        return "Rank of input (" + c.rank + ") does not match rank of dy (" + u.rank + ")";
    }), null == a && (a = [
        1,
        1
    ]), assert(eitherStridesOrDilationsAreOne(o, a), function() {
    ...
    }), null != s && assert(isInt(i), function() {
        return "Error in maxPoolBackprop: pad must be an integer when using, dimRoundingMode " + s + " but got pad " + i + ".";
    });
    var p = computePool2DInfo(c.shape, r, o, a, i, s);
    return ENV.engine.runKernel(function(e) {
        return e.maxPoolBackprop(u, c, l, p);
    }, {
        $dy: u,
        $input: c
    });
...
function avgPoolBackprop(e, t, n, r, o, a) {
    ...
    assert(s.rank === i.rank, function() {
        return "Rank of input (" + s.rank + ") does not match rank of dy (" + i.rank + ")";
    }), null == o && (o = [
        1,
        1
    ]), assert(eitherStridesOrDilationsAreOne(r, o), function() {
        return "Error in avgPoolBackprop: Either strides or dilations must be 1. Got strides " + r + " and dilations '" + o + "'";
    });
    var u = s, c = i, l = !1;
    3 === s.rank && (l = !0, u = s.as4D(1, s.shape[0], s.shape[1], s.shape[2]), c = i.as4D(1, i.shape[0], i.shape[1], i.shape[2])), assert(4 === c.rank, function() {
    ...
    var p = computePool2DInfo(u.shape, n, r, o, a), d = ENV.engine.runKernel(function(e) {
        return e.avgPoolBackprop(c, u, p);
    }, {
        dy4D: c,
        input4D: u
    });
...
function requiredSpaceToBatchPaddings(e, t, n) {
    var r = n.map(function(e) {
        ...
        return e[1];
    }), a = e.concat(r, o), i = t.map(function(e, t) {
        return (e - a[t] % e) % e;
...
function slice1d_(e, t, n) {
    ...
    return assert(1 === r.rank, function() {
...
function slice2d_(e, t, n) {
    ...
    return assert(2 === r.rank, function() {
...
function slice3d_(e, t, n) {
    ...
    return assert(3 === r.rank, function() {
...
function slice4d_(e, t, n) {
    ...
    return assert(4 === r.rank, function() {
...
function slice_(e, t, n) {
    ...
    r = "number" == typeof t ? [
        t
    ].concat(new Array(a.rank - 1).fill(0)) : t.length < a.rank ? t.concat(new Array(a.rank - t.length).fill(0)) : t.slice(), o = (o = null == n ? new Array(a.rank).fill(-1) : "number" == typeof n ? [
        n
    ].concat(new Array(a.rank - 1).fill(-1)) : n.length < a.rank ? n.concat(new Array(a.rank - n.length).fill(-1)) : n).map(function(e, t) {
        return e >= 0 ? e : (assert(-1 === e, function() {
...
function prod_(e, t, n) {
    ...
    if (n) {
        var c = expandShapeToKeepDim(u.shape, o);
        u = u.reshape(c);
    }
    return u;
}
function mean_(e, t, n) {
    void 0 === t && (t = null), void 0 === n && (n = !1);
    var r = convertToTensor(e, "x", "mean"), o = parseAxisParam(t, r.shape), a = sizeFromShape(computeOutAndReduceShapes(r.shape, o)[1]);
    return customGrad(function(e) {
        var r = scalar(a);
        return {
            ...
            gradFunc: function(t) {
                ...
                return o.forEach(function(e) {
                    n[e] = 1;
                }), t.reshape(n).mul(ones$1(e.shape, "float32")).div(a);
            }
        };
    })(r);
}
function gradForMinAndMax(e, t, n, r, o) {
    return t.rank < n.rank && (t = t.reshape(expandShapeToKeepDim(t.shape, r))), e.rank < n.rank && (e = e.reshape(expandShapeToKeepDim(e.shape, r))), {
        $x: function() {
            var r = e.mul(n.equal(t).cast(e.dtype));
...
function min_(e, t, n) {
    void 0 === t && (t = null), void 0 === n && (n = !1);
    var r = convertToTensor(e, "x", "min"), o = r, a = parseAxisParam(t, r.shape), i = a, s = getAxesPermutation(i, r.rank);
    ...
    var u = ENV.engine.runKernel(function(e, t) {
        ...
        return gradForMinAndMax(e, t[1], t[0], a, s);
    });
    if (n) {
        var c = expandShapeToKeepDim(u.shape, a);
        u = u.reshape(c);
    }
    return u;
}
function max_(e, t, n) {
    void 0 === t && (t = null), void 0 === n && (n = !1);
    var r = convertToTensor(e, "x", "max"), o = r, a = parseAxisParam(t, r.shape), i = a, s = getAxesPermutation(i, r.rank);
    null != s && (r = r.transpose(s), i = getInnerMostAxes(i.length, r.rank));
    var u = ENV.engine.runKernel(function(e, t) {
        var n = e.max(r, i);
        return t([
...
function all_(e, t, n) {
    void 0 === t && (t = null), void 0 === n && (n = !1);
    var r = convertToTensor(e, "x", "all", "bool"), o = parseAxisParam(t, r.shape), a = o, i = getAxesPermutation(a, r.rank);
...
function any_(e, t, n) {
    void 0 === t && (t = null), void 0 === n && (n = !1);
    var r = convertToTensor(e, "x", "any", "bool"), o = parseAxisParam(t, r.shape), a = o, i = getAxesPermutation(a, r.rank);
    null != i && (r = r.transpose(i), a = getInnerMostAxes(a.length, r.rank));
    var s = ENV.engine.runKernel(function(e) {
        return e.any(r, a);
    }, {
...
function notEqual_(e, t) {
    var n, r = convertToTensor(e, "a", "notEqual"), o = convertToTensor(t, "b", "notEqual");
...
function less_(e, t) {
    var n, r = convertToTensor(e, "a", "less"), o = convertToTensor(t, "b", "less");
    return n = makeTypesMatch(r, o), r = n[0], o = n[1], assertAndGetBroadcastShape(r.shape, o.shape), ENV.engine.runKernel(function(e) {
        return e.less(r, o);
    }, {
        $a: r,
...
function equal_(e, t) {
    var n, r = convertToTensor(e, "a", "equal"), o = convertToTensor(t, "b", "equal");
    return n = makeTypesMatch(r, o), r = n[0], o = n[1], assertAndGetBroadcastShape(r.shape, o.shape), ENV.engine.runKernel(function(e) {
        return e.equal(r, o);
    }, {
        $a: r,
...
function lessEqual_(e, t) {
    var n, r = convertToTensor(e, "a", "lessEqual"), o = convertToTensor(t, "b", "lessEqual");
    return n = makeTypesMatch(r, o), r = n[0], o = n[1], assertAndGetBroadcastShape(r.shape, o.shape), ENV.engine.runKernel(function(e) {
...
function greater_(e, t) {
    var n, r = convertToTensor(e, "a", "greater"), o = convertToTensor(t, "b", "greater");
    return n = makeTypesMatch(r, o), r = n[0], o = n[1], assertAndGetBroadcastShape(r.shape, o.shape), ENV.engine.runKernel(function(e) {
...
function greaterEqual_(e, t) {
    var n, r = convertToTensor(e, "a", "greaterEqual"), o = convertToTensor(t, "b", "greaterEqual");
    n = makeTypesMatch(r, o), r = n[0], o = n[1], assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.greaterEqual(r, o);
        return t([
            r,
            o
        ]), n;
...
function add_(e, t) {
    var n, r = convertToTensor(e, "a", "add"), o = convertToTensor(t, "b", "add");
    n = makeTypesMatch(r, o), r = n[0], o = n[1];
...
function sub_(e, t) {
    var n, r = convertToTensor(e, "a", "sub"), o = convertToTensor(t, "b", "sub");
    n = makeTypesMatch(r, o), r = n[0], o = n[1];
    var a = assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e) {
...
function pow_(e, t) {
    var n = convertToTensor(e, "base", "pow"), r = convertToTensor(t, "exp", "pow"), o = assertAndGetBroadcastShape(n.shape, r.shape);
    ...
    return ENV.engine.runKernel(function(e, t) {
        ...
        return {
            ...
            $exp: function() {
                var t = n.greater(0), i = n.log().where(t, zerosLike(n)), s = e.mul(a.mul(i)), u = getReductionAxes(r.shape, o);
...
function mul_(e, t) {
    var n, r = convertToTensor(e, "a", "mul"), o = convertToTensor(t, "b", "mul");
    n = makeTypesMatch(r, o), r = n[0], o = n[1];
    var a = assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.multiply(r, o);
        return t([
            r,
            o
        ]), n;
        ...
        return {
            $a: function() {
                var t = e.mul(r.toFloat()), o = getReductionAxes(n.shape, a);
                return o.length > 0 ? t.sum(o).reshape(n.shape) : t;
            },
            $b: function() {
                var t = e.mul(n.toFloat()), o = getReductionAxes(r.shape, a);
...
function div_(e, t) {
    ...
    if (n = makeTypesMatch(r, o), r = n[0], o = n[1], "int32" === r.dtype && "int32" === o.dtype) return floorDiv(r, o);
    var a = assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.realDivide(r, o);
        return t([
            r,
            o
        ]), n;
        ...
        return {
            $a: function() {
                var t = e.div(r.toFloat()), o = getReductionAxes(n.shape, a);
                return o.length > 0 ? t.sum(o).reshape(n.shape) : t;
            },
            $b: function() {
                var t = e.mul(n.toFloat()), o = getReductionAxes(r.shape, a);
                o.length > 0 && (t = t.sum(o).reshape(r.shape));
                var i = r.square();
...
function floorDiv_(e, t) {
    var n, r = convertToTensor(e, "a", "floorDiv"), o = convertToTensor(t, "b", "floorDiv");
    n = makeTypesMatch(r, o), r = n[0], o = n[1];
    var a = assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.floorDiv(r, o);
        return t([
            r,
            o
        ]), n;
...
function mod_(e, t) {
    var n, r = convertToTensor(e, "a", "mod"), o = convertToTensor(t, "b", "mod");
    n = makeTypesMatch(r, o), r = n[0], o = n[1];
    var a = assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.mod(r, o);
        ...
        return {
            $a: function() {
                var t = getReductionAxes(n.shape, a);
                return t.length > 0 ? e.sum(t).reshape(n.shape) : e;
            },
            $b: function() {
                var t = e.mul(n.div(r).floor().neg()), o = getReductionAxes(r.shape, a);
                return o.length > 0 ? t.sum(o).reshape(r.shape) : t;
            }
        };
    });
...
function minimum_(e, t) {
    var n, r = convertToTensor(e, "a", "minimum"), o = convertToTensor(t, "b", "minimum");
...
function maximum_(e, t) {
    var n, r = convertToTensor(e, "a", "maximum"), o = convertToTensor(t, "b", "maximum");
    n = makeTypesMatch(r, o), r = n[0], o = n[1], "bool" === r.dtype && (r = r.toInt(), o = o.toInt()), assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.maximum(r, o);
        return t([
...
function squaredDifference_(e, t) {
    var n, r = convertToTensor(e, "a", "squaredDifference"), o = convertToTensor(t, "b", "squaredDifference");
    n = makeTypesMatch(r, o), r = n[0], o = n[1], assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.squaredDifference(r, o);
        return t([
            r,
            o
        ]), n;
        ...
        var n = t[0], r = t[1], o = scalar(2);
        return {
            $a: function() {
                return e.mul(n.sub(r).mul(o));
            },
            $b: function() {
                return e.mul(r.sub(n).mul(o));
            }
        };
    });
}
...
function atan2_(e, t) {
    var n, r = convertToTensor(e, "a", "atan2"), o = convertToTensor(t, "b", "atan2");
    n = makeTypesMatch(r, o), r = n[0], o = n[1];
    var a = assertAndGetBroadcastShape(r.shape, o.shape);
    return ENV.engine.runKernel(function(e, t) {
        var n = e.atan2(r, o);
        ...
        return {
            $a: function() {
                var t = add(n.square(), r.square()), o = e.mul(r.div(t)), i = getReductionAxes(n.shape, a);
                return i.length > 0 && (o = o.sum(i)), o.reshape(n.shape);
            },
            $b: function() {
                var t = add(n.square(), r.square()), o = neg(e.mul(n.div(t))), i = getReductionAxes(r.shape, a);
...
function where_(e, t, n) {
    var r = convertToTensor(t, "a", "where"), o = convertToTensor(n, "b", "where"), a = convertToTensor(e, "condition", "where", "bool");
    assertShapesMatch(r.shape, o.shape, "Error in where: "), 1 === a.rank ? assert(a.shape[0] === r.shape[0], function() {
        return "The first dimension of `a` must match the size of `condition`.";
    }) : assertShapesMatch(a.shape, o.shape, "Error in where: ");
    return ENV.engine.runKernel(function(e, t) {
        var n = e.select(a, r, o);
        return t([
            a
        ]), n;
    }, {
        ...
        return {
            $condition: function() {
                return zerosLike(n).toFloat();
            },
            $a: function() {
                return e.mul(n.cast(e.dtype));
            },
            $b: function() {
                return e.mul(n.logicalNot().cast(e.dtype));
            }
        };
    });
}
...
function relu_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                return e.mulStrict(n.step().toFloat());
            }
        };
    });
}
...
function selu_(e) {
    ...
    return ENV.engine.runKernel(function(e, n) {
        ...
        return {
            $x: function() {
                var t = n.greater(scalar(0)), r = scalar(SELU_SCALEALPHA), o = scalar(SELU_SCALE), a = e.mul(o), i = e.mul(r).mul(n.toFloat().exp());
                return where(t, a, i);
            }
        };
    });
...
function prelu_(e, t) {
    var n = convertToTensor(e, "x", "prelu"), r = convertToTensor(t, "alpha", "prelu");
    return ENV.engine.runKernel(function(e, t) {
        var o = e.prelu(n, r);
        return t([
            n,
        ...
        var n = t[0], r = t[1], o = n.greater(0);
        return {
            $x: function() {
                return where(o, e, e.mul(r));
            },
            $alpha: function() {
                var t = where(o, zerosLike(e), e.mul(n)), a = getReductionAxes(r.shape, e.shape);
                return a.length > 0 && (t = t.sum(a)), t.reshape(r.shape);
            }
        };
    });
}
...
function localResponseNormalization_(e, t, n, r, o) {
    ...
    assert(4 === a.rank || 3 === a.rank, function() {
        return "Error in localResponseNormalization: x must be rank 3 or 4 but got\n               rank " + a.rank + ".";
    }), assert(isInt(t), function() {
    ...
    var u = ENV.engine.runKernel(function(e, a) {
        var s = e.localResponseNormalization4D(i, t, n, r, o);
        return a([
            i,
            s
        ]), s;
...
function unsortedSegmentSum_(e, t, n) {
    var r = convertToTensor(e, "x", "unsortedSegmentSum"), o = convertToTensor(t, "segmentIds", "unsortedSegmentSum", "int32");
    assert(isInt(n), function() {
        return "numSegments must be of dtype int";
    });
    return ENV.engine.runKernel(function(e, t) {
        var a = e.unsortedSegmentSum(r, o, n);
        return t([
            o
        ]), a;
    }, {
        ...
        return {
            $x: function() {
                return gatherDropNegatives(e, n);
            }
        };
    });
}
function gather_(e, t, n) {
    ...
    var a = collectGatherOpShapeInfo(r, o, n);
    return ENV.engine.runKernel(function(e, t) {
        var a = e.gather(r, o.flatten(), n);
        return t([
            o
        ]), a;
    }, {
        ...
        return {
            $x: function() {
                var t = r.shape, a = o.size, i = t.slice(0, n), s = i.length, u = t.slice(n, t.length).slice(1), c = u.length, l = arrayRange(0, s), p = arrayRange(s + 1, s + 1 + c), d = arrayConcat([
                    i,
                    [
                        a
                    ],
...
function multiRNNCell_(e, t, n, r) {
    ...
    var p = [], d = [];
    for(c = 0; c < u.length; c += 2)p.push(u[c]), d.push(u[c + 1]);
    return [
        p,
        d
    ];
...
function basicLSTMCell_(e, t, n, r, o, a) {
    var i = convertToTensor(e, "forgetBias", "basicLSTMCell"), s = convertToTensor(t, "lstmKernel", "basicLSTMCell"), u = convertToTensor(n, "lstmBias", "basicLSTMCell"), c = convertToTensor(r, "data", "basicLSTMCell"), l = convertToTensor(o, "c", "basicLSTMCell"), p = convertToTensor(a, "h", "basicLSTMCell"), d = c.concat(p, 1).matMul(s).add(u), h = d.shape[0], f = d.shape[1] / 4, m = [
        h,
        f
    ], g = d.slice([
        0,
        ...
        0,
        3 * f
    ], m), E = g.sigmoid().mulStrict(v.tanh()).addStrict(l.mulStrict(i.add(y).sigmoid()));
    return [
        E,
        E.tanh().mulStrict(x.sigmoid())
    ];
}
...
function movingAverage_(e, t, n, r, o) {
    ...
    assertTypesMatch(a, i), assert(arraysEqual(a.shape, i.shape), function() {
        return "Shape mismatch in v and x";
    });
    var u = scalar(1), c = u.sub(s), l = i.sub(a).mul(c);
    if (o) {
        assert(null != r, function() {
            return "When using zeroDebias: true, step is required.";
        });
        var p = convertToTensor(r, "step", "movingAverage");
        l = l.div(u.sub(pow(s, p)));
    }
    return a.add(l);
}
...
function stridedSlice_(e, t, n, r, o, a, i, s, u) {
    if (void 0 === o && (o = 0), void 0 === a && (a = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === u && (u = 0), 0 !== i) throw new Error("ellipsis mask is not yet supported");
    if (0 !== s) throw new Error("new axis mask is not yet supported");
    var c = convertToTensor(e, "x", "stridedSlice");
    if (r.every(function(e) {
        return 1 === e;
    })) {
        var l = getStridedSlicedInfo(c.shape, t, n, r, o, a, i, s, u), p = l[0], d = l[1], h = l[2], f = d.filter(function(e, t) {
            return -1 === h.indexOf(t);
        });
        return slice(c, p, d).reshape(f);
    }
    return ENV.engine.runKernel(function(e) {
...
function fft_(e) {
    assert("complex64" === e.dtype, function() {
...
function rfft_(e) {
    assert("float32" === e.dtype, function() {
        return "The dtype for rfft() must be real value but got " + e.dtype;
    });
    var t = e.shape[e.shape.length - 1], n = e.size / t, r = e.zerosLike(), o = complex(e, r).as2D(n, t), a = fft(o), i = Math.floor(t / 2) + 1, s = real(a), u = imag(a), c = s.split([
        i,
        t - i
    ], s.shape.length - 1), l = u.split([
        i,
        t - i
    ], u.shape.length - 1), p = e.shape.slice();
    return p[e.shape.length - 1] = i, complex(c[0], l[0]).reshape(p);
}
function irfft_(e) {
    ...
    var a = [
        ...
        n,
        t - 2
    ]).reverse(1).mul(scalar(-1)), l = i.concat(u, 1), p = s.concat(c, 1);
    r = complex(l, p).as2D(a[0], a[1]), o = ifft(r);
    return real(o);
}
var fft = op({
    fft_: fft_
...
function sparseToDense_(e, t, n, r) {
    void 0 === r && (r = 0);
    var o = convertToTensor(e, "sparseIndices", "sparseToDense", "int32"), a = convertToTensor(t, "sparseValues", "sparseToDense"), i = convertToTensor(r, "defaultValue", "sparseToDense", a.dtype);
...
function logLoss_(e, t, n, r, o) {
    ...
    var u = scalar(1), c = scalar(r), l = a.mul(i.add(c).log()).neg().sub(u.sub(a).mul(u.sub(i).add(c).log()));
    return computeWeightedLoss(l, s, o);
}
...
function sigmoidCrossEntropy_(e, t, n, r, o) {
    ...
    if (null != n && (s = convertToTensor(n, "weights", "sigmoidCrossEntropy")), assertShapesMatch(a.shape, i.shape, "Error in sigmoidCrossEntropy: "), r > 0) {
        var u = scalar(r), c = scalar(1), l = scalar(.5);
...
function huberLoss_(e, t, n, r, o) {
    ...
    var u = scalar(r), c = i.sub(a).abs(), l = minimum(c, u), p = c.sub(l), d = scalar(.5).mul(l.square()).add(u.mul(p));
...
function softmaxCrossEntropyWithLogits_(e, t, n) {
    ...
    return customGrad(function(e, t, r) {
        var o = t.logSumExp([
            n
        ], !0), a = t.toFloat().sub(o);
        r([
        ...
        return {
            value: a.mul(e).neg().sum([
                n
            ]),
            gradFunc: function(e, t) {
                var r = t[0], o = t[1], a = expandShapeToKeepDim(e.shape, [
                    n
                ]);
                return [
                    e.reshape(a).mul(r.toFloat().sub(o.exp())),
                    e.reshape(a).mul(o.exp().sub(r.toFloat()))
                ];
            }
        };
    })(e, t);
...
function softmaxCrossEntropy_(e, t, n, r, o) {
    ...
    if (null != n && (s = convertToTensor(n, "weights", "softmaxCrossEntropy")), assertShapesMatch(a.shape, i.shape, "Error in softmaxCrossEntropy: "), r > 0) {
        var u = scalar(r), c = scalar(1), l = scalar(a.shape[1]);
...
function gramSchmidt_(e) {
    var t;
    if (Array.isArray(e)) {
        t = !1, assert(null != e && e.length > 0, function() {
            return "Gram-Schmidt process: input must not be null, undefined, or empty";
        });
        for(var n = e[0].shape[0], r = function(t) {
            assert(e[t].shape[0] === n, function() {
...
function qr_(e, t) {
    ...
    return unstack(e.reshape([
        ...
        stack(r, 0).reshape(e.shape),
        stack(o, 0).reshape(e.shape)
    ];
}
function qr2d(e, t) {
    return void 0 === t && (t = !1), ENV.engine.tidy(function() {
        ...
        for(var n = e.shape[0], r = e.shape[1], o = eye(n), a = e.clone(), i = tensor2d([
            ...
            1,
            1
        ]), s = i.clone(), u = n >= r ? r : n, c = function(e) {
            var t, u = a, c = s, l = o;
            t = ENV.engine.tidy(function() {
                var t = a.slice([
                    ...
                    1,
                    1
                ]), l = c.sign().neg(), p = c.sub(l.mul(u)), d = t.div(p);
                ...
                var h = l.matMul(p).div(u).neg(), f = a.slice([
                    e,
                    0
                ], [
                    n - e,
            ...
            }), s = t[0], a = t[1], o = t[2], dispose([
                u,
                c,
                l
            ]);
        }, l = 0; l < u; ++l)c(l);
        return !t && n > r && (o = o.slice([
            0,
            0
        ], [
            n,
    ...
    var i = t[0], s = t[1], u = ENV.engine.runKernel(function(e, t) {
        ...
        return {
            batchImages: function() {
                return ENV.engine.runKernel(function(r) {
                    return r.resizeBilinearBackprop(e, t[0], n);
                }, {});
            }
        };
    });
...
function resizeNearestNeighbor_(e, t, n) {
    ...
    }), assert("float32" === r.dtype || "int32" === r.dtype, function() {
    ...
    var i = t[0], s = t[1], u = ENV.engine.runKernel(function(e, t) {
        return t([
            o
        ]), e.resizeNearestNeighbor(o, i, s, n);
    }, {
        batchImages: o
    }, function(e, t) {
        return {
            batchImages: function() {
                return ENV.engine.runKernel(function(r) {
                    return r.resizeNearestNeighborBackprop(e, t[0], n);
                }, {});
            }
        };
    });
...
function nonMaxSuppression_(e, t, n, r, o) {
    ...
    var a = convertToTensor(e, "boxes", "nonMaxSuppression"), i = convertToTensor(t, "scores", "nonMaxSuppression"), s = nonMaxSuppSanityCheck(a, i, n, r, o);
    ...
    return void 0 === r && (r = .5), void 0 === o && (o = Number.NEGATIVE_INFINITY), __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(p) {
            switch(p.label){
                ...
                case 2:
                    return c = p.sent(), l = nonMaxSuppressionImpl(u, c, n, r, o), a !== e && a.dispose(), i !== t && i.dispose(), [
                        2,
                        l
                    ];
            }
...
function nonMaxSuppSanityCheck(e, t, n, r, o) {
    ...
    var a = e.shape[0];
    return n = Math.min(n, a), assert(0 <= r && r <= 1, function() {
        return "iouThreshold must be in [0, 1], but was '" + r + "'";
    }), assert(2 === e.rank, function() {
        return "boxes must be a 2D tensor, but was of rank '" + e.rank + "'";
    }), assert(4 === e.shape[1], function() {
        return "boxes must have 4 columns, but 2nd dimension was " + e.shape[1];
    }), assert(1 === t.rank, function() {
        return "scores must be a 1D tensor";
    }), assert(t.shape[0] === a, function() {
        return "scores has incompatible shape with boxes. Expected " + a + ", but was " + t.shape[0];
    }), {
        maxOutputSize: n,
        iouThreshold: r,
        scoreThreshold: o
...
function cropAndResize_(e, t, n, r, o, a) {
    var i = convertToTensor(e, "image", "cropAndResize", "float32"), s = convertToTensor(t, "boxes", "cropAndResize", "float32"), u = convertToTensor(n, "boxInd", "cropAndResize", "int32");
    o = o || "bilinear", a = a || 0;
    var c = s.shape[0];
    assert(4 === i.rank, function() {
        return "Error in cropAndResize: image must be rank 4,but got rank " + i.rank + ".";
    }), assert(2 === s.rank && 4 === s.shape[1], function() {
        return "Error in cropAndResize: boxes must be have size [" + c + ",4] but had shape " + s.shape + ".";
    }), assert(1 === u.rank && u.shape[0] === c, function() {
        return "Error in cropAndResize: boxInd must be have size [" + c + "] but had shape " + s.shape + ".";
    }), assert(2 === r.length, function() {
        return "Error in cropAndResize: cropSize must be of length 2, but got length " + r.length + ".";
    }), assert(r[0] >= 1 && r[1] >= 1, function() {
        return "cropSize must be atleast [1,1], but was " + r;
    }), assert("bilinear" === o || "nearest" === o, function() {
...
function matMul_$1(e, t, n, r, o, a) {
    var i;
    void 0 === n && (n = !1), void 0 === r && (r = !1), void 0 === a && (a = "linear");
    var s = convertToTensor(e, "a", "fused matMul"), u = convertToTensor(t, "b", "fused matMul");
    i = makeTypesMatch(s, u), s = i[0], u = i[1];
    var c = n ? s.shape[s.rank - 2] : s.shape[s.rank - 1], l = r ? u.shape[u.rank - 1] : u.shape[u.rank - 2], p = n ? s.shape[s.rank - 1] : s.shape[s.rank - 2], d = r ? u.shape[u.rank - 2] : u.shape[u.rank - 1], h = s.shape.slice(0, -2), f = u.shape.slice(0, -2), m = sizeFromShape(h), g = sizeFromShape(f);
    assert(s.rank >= 2 && u.rank >= 2 && s.rank === u.rank, function() {
        return "Error in fused matMul: inputs must have the same rank of at least 2, got ranks " + s.rank + " and " + u.rank + ".";
    }), assert(arraysEqual(h, f), function() {
        return "Error in fused matMul: outer dimensions (" + h + ") and (" + f + ") of Tensors with shapes " + s.shape + " and " + u.shape + " must match.";
    }), assert(c === l, function() {
        return "Error in fused matMul: inner shapes (" + c + ") and (" + l + ") of Tensors with shapes " + s.shape + " and " + u.shape + " and transposeA=" + n + " and transposeB=" + r + " must match.";
    });
    var v, y = s.shape.slice(0, -2).concat([
        p,
        d
    ]), x = n ? s.as3D(m, c, p) : s.as3D(m, p, c), E = r ? u.as3D(g, d, l) : u.as3D(g, l, d);
    null != o && assertAndGetBroadcastShape(y, (v = makeTypesMatch(v = convertToTensor(o, "bias", "fused matMul"), s)[0]).shape);
    var T = {
        $a: x,
        $b: E
    };
    return null != o && (T.$bias = v), ENV.engine.runKernel(function(e, t) {
        var o = e.fusedBatchMatMul(x, E, n, r, v, a);
        return t([
            x,
            E,
            o
        ...
        var i, s = t[0], u = t[1], c = t[2];
        if (null == a || "linear" === a) i = e;
        else {
        ...
        return null != o && (l = {
            $bias: function() {
                var e = i, t = getReductionAxes(v.shape, i.shape);
...
var MathBackendCPU = function() {
    ...
    return e.prototype.setDataMover = function(e) {
        ...
        Array.isArray(e) || (e = [
            ...
            null != e && assert("complex64" !== e.dtype, function() {
                return t + " does not support complex64 tensors.";
            });
        });
    }, e.prototype.slice = function(e, t, n) {
        if (this.assertNotComplex(e, "slice"), isSliceContinous(e.shape, t, n)) {
            var r = computeFlatOffset(t, e.strides), o = sizeFromShape(n);
        ...
        for(var f = buffer(p, e.dtype), m = e.bufferSync(), g = 0; g < f.size; g++){
            for(var v = f.indexToLoc(g), y = new Array(v.length), x = 0; x < y.length; x++)y[x] = v[x] * r[x] + l[x];
            f.set.apply(f, [
                m.get.apply(m, y)
            ].concat(v));
        }
        ...
        return this.assertNotComplex([
            e,
            t
        ], "pow"), this.broadcastedBinaryOp(e, t, e.dtype, function(e, t) {
            return Math.pow(e, t);
        });
    }, e.prototype.batchMatMul = function(e, t, n, r) {
        ...
        for(var o = n ? e.shape[1] : e.shape[2], a = n ? e.shape[2] : e.shape[1], i = r ? t.shape[1] : t.shape[2], s = e.shape[0], u = e.dataSync(), c = t.dataSync(), l = n ? [
            e.strides[0],
            1,
            e.strides[1]
        ] : [
            ...
            a,
            i
        ], e.dtype), E = x.values, T = this.blockSize, b = 0; b < s; b++)for(var w = 0; w < a; w += T)for(var S = 0; S < i; S += T)for(var C = 0; C < o; C += T)for(var A = Math.min(w + T, a), N = Math.min(S + T, i), _ = Math.min(C + T, o), R = w; R < A; R++)for(var I = S; I < N; I++){
            for(var k = 0, D = C; D < _; D++)k += u[b * p + R * d + D * h] * c[D * m + I * g + b * v];
            E[b * y + (R * i + I)] += k;
        }
        return x.toTensor();
    }, e.prototype.fusedBatchMatMul = function(e, t, n, r, o, a) {
        ...
        for(var n = computeOutAndReduceShapes(e.shape, t), r = n[0], o = n[1], a = zeros(r, upcastType(e.dtype, "int32")), i = sizeFromShape(o), s = a.dataSync(), u = e.dataSync(), c = 0; c < s.length; ++c){
            for(var l = c * i, p = 0, d = 0; d < i; ++d)p += u[l + d];
            s[c] = p;
        }
        return a;
    }, e.prototype.prod = function(e, t) {
        ...
        for(var n = computeOutAndReduceShapes(e.shape, t), r = n[0], o = n[1], a = zeros(r, upcastType(e.dtype, "int32")), i = sizeFromShape(o), s = a.dataSync(), u = e.dataSync(), c = 0; c < s.length; ++c){
            for(var l = c * i, p = 1, d = 0; d < i; ++d)p *= u[l + d];
            s[c] = p;
        }
        return a;
    }, e.prototype.unsortedSegmentSum = function(e, t, n) {
        ...
        for(var r = computeOutAndReduceShapes(e.shape, n), o = r[0], a = r[1], i = zeros(o, "int32"), s = sizeFromShape(a), u = i.dataSync(), c = e.dataSync(), l = 0; l < u.length; ++l){
        ...
        for(var o = upcastType(e.dtype, "int32"), a = zeros(e.shape, o), i = a.dataSync(), s = e.dataSync(), u = e.shape[e.rank - 1], c = r ? function(e, t) {
            return e + u - t - 1;
        } : function(e, t) {
            return e + t;
        ...
        return this.assertNotComplex([
            e,
            t
        ], "equal"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e === t ? 1 : 0;
        });
    }, e.prototype.notEqual = function(e, t) {
        return this.assertNotComplex([
            e,
            t
        ], "notEqual"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e !== t ? 1 : 0;
        });
    }, e.prototype.less = function(e, t) {
        return this.assertNotComplex([
            e,
            t
        ], "less"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e < t ? 1 : 0;
        });
    }, e.prototype.lessEqual = function(e, t) {
        return this.assertNotComplex([
            e,
            t
        ], "lessEqual"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e <= t ? 1 : 0;
        });
    }, e.prototype.greater = function(e, t) {
        return this.assertNotComplex([
            e,
            t
        ], "greater"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e > t ? 1 : 0;
        });
    }, e.prototype.greaterEqual = function(e, t) {
        return this.assertNotComplex([
            e,
            t
        ], "greaterEqual"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e >= t ? 1 : 0;
        });
    }, e.prototype.logicalNot = function(e) {
        ...
        return this.assertNotComplex([
            e,
            t
        ], "logicalAnd"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e && t;
        });
    }, e.prototype.logicalOr = function(e, t) {
        return this.assertNotComplex([
            e,
            t
        ], "logicalOr"), this.broadcastedBinaryOp(e, t, "bool", function(e, t) {
            return e || t;
        });
    }, e.prototype.select = function(e, t, n) {
        this.assertNotComplex([
        ...
        for(var r = e.dataSync(), o = t.dataSync(), a = n.dataSync(), i = zeros(t.shape, upcastType(t.dtype, n.dtype)), s = i.dataSync(), u = 0, c = 0 === e.rank || e.rank > 1 || 1 === t.rank ? 1 : t.shape[1], l = 0; l < r.length; l++)for(var p = 0; p < c; p++)1 === r[l] ? s[u++] = o[l] : s[u++] = a[l];
        return i;
    }, e.prototype.where = function(e) {
        this.assertNotComplex([
            e
        ...
        for(var n = computeOutAndReduceShapes(e.shape, t), r = n[0], o = n[1], a = zeros(r, e.dtype), i = sizeFromShape(o), s = a.dataSync(), u = e.dataSync(), c = 0; c < s.length; ++c){
        ...
        return this.assertNotComplex([
            e,
            t
        ], "minimum"), this.broadcastedBinaryOp(e, t, e.dtype, function(e, t) {
            return Math.min(e, t);
        });
    }, e.prototype.mod = function(e, t) {
        return this.assertNotComplex([
            e,
            t
        ], "mod"), this.broadcastedBinaryOp(e, t, e.dtype, function(e, t) {
            var n = e % t;
        ...
        return this.assertNotComplex([
            e,
            t
        ], "maximum"), this.broadcastedBinaryOp(e, t, e.dtype, function(e, t) {
            return Math.max(e, t);
        });
    }, e.prototype.all = function(e, t) {
        ...
        return this.assertNotComplex([
            e,
            t
        ], "squaredDifference"), this.broadcastedBinaryOp(e, t, e.dtype, function(e, t) {
            var n = e - t;
            return n * n;
        });
    }, e.prototype.ceil = function(e) {
        ...
        this.assertNotComplex(e, "x");
        for(var t = e.dataSync(), n = new Uint8Array(t.length), r = 0; r < t.length; ++r)Number.isNaN(t[r]) && (n[r] = 1);
        return Tensor.make(e.shape, {
            values: n
        }, "bool");
    }, e.prototype.isInf = function(e) {
        this.assertNotComplex(e, "x");
        for(var t = e.dataSync(), n = new Uint8Array(t.length), r = 0; r < t.length; ++r)Math.abs(t[r]) === 1 / 0 && (n[r] = 1);
        return Tensor.make(e.shape, {
            values: n
        }, "bool");
    }, e.prototype.isFinite = function(e) {
        this.assertNotComplex(e, "x");
        for(var t = e.dataSync(), n = new Uint8Array(t.length), r = 0; r < t.length; ++r)Number.isFinite(t[r]) && (n[r] = 1);
        return Tensor.make(e.shape, {
            values: n
        }, "bool");
    }, e.prototype.round = function(e) {
        ...
        return this.assertNotComplex([
            e,
            t
        ], "prelu"), this.broadcastedBinaryOp(e, t, e.dtype, function(e, t) {
            return e < 0 ? t * e : e;
        });
    }, e.prototype.elu = function(e) {
        ...
        return this.assertNotComplex([
            e,
            t
        ], "atan2"), this.broadcastedBinaryOp(e, t, e.dtype, function(e, t) {
        ...
        for(var t = new Float32Array(e.size), n = e.dataSync(), r = ERF_P, o = ERF_A1, a = ERF_A2, i = ERF_A3, s = ERF_A4, u = ERF_A5, c = 0; c < n.length; ++c){
            var l = n[c], p = 1 / (1 + r * l);
            t[c] = 1 - ((((u * p + s) * p + i) * p + a) * p + o) * p * Math.exp(-l * l);
        }
        return Tensor.make(e.shape, {
            values: t
        });
        ...
        for(var r = n.filterHeight, o = n.filterWidth, a = n.dilationHeight, i = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = buffer(n.outShape, e.dtype), l = e.dataSync(), p = t.dataSync(), d = c.values, h = 0; h < n.batchSize; ++h)for(var f = h * e.strides[0], m = h * c.strides[0], g = 0; g < n.outHeight; ++g)for(var v = m + g * c.strides[1], y = g * n.strideHeight - s, x = 0; x < r; x++){
            var E = y + x * a;
            if (!(E < 0 || E >= n.inHeight)) for(var T = x * t.strides[0], b = f + E * e.strides[1], w = 0; w < n.outWidth; ++w)for(var S = v + w * n.outChannels, C = w * n.strideWidth - u, A = 0; A < o; A++){
                var N = C + A * i;
                if (!(N < 0 || N >= n.inWidth)) for(var _ = T + A * t.strides[1], R = b + N * n.inChannels, I = _, k = 0; k < n.inChannels; ++k){
                    for(var D = l[R + k], O = 0; O < n.outChannels; ++O)d[S + O] += D * p[I + O];
                    I += n.outChannels;
                }
            }
        }
        ...
        for(var r = n.filterDepth, o = n.filterHeight, a = n.filterWidth, i = n.dilationDepth, s = n.dilationHeight, u = n.dilationWidth, c = n.padInfo.front, l = n.padInfo.left, p = n.padInfo.top, d = buffer(n.outShape, e.dtype), h = e.dataSync(), f = t.dataSync(), m = d.values, g = 0; g < n.batchSize; ++g)for(var v = g * e.strides[0], y = g * d.strides[0], x = 0; x < n.outDepth; ++x)for(var E = y + x * d.strides[1], T = x * n.strideDepth - c, b = 0; b < r; b++){
            var w = T + b * i;
            if (!(w < 0 || w >= n.inDepth)) for(var S = b * t.strides[0], C = v + w * e.strides[1], A = 0; A < n.outHeight; ++A)for(var N = E + A * d.strides[2], _ = A * n.strideHeight - p, R = 0; R < o; R++){
                var I = _ + R * s;
                if (!(I < 0 || I >= n.inHeight)) for(var k = S + R * t.strides[1], D = C + I * e.strides[2], O = 0; O < n.outWidth; ++O)for(var P = N + O * n.outChannels, M = O * n.strideWidth - l, F = 0; F < a; F++){
                    var L = M + F * u;
                    if (!(L < 0 || L >= n.inWidth)) for(var B = k + F * t.strides[2], V = D + L * n.inChannels, U = B, z = 0; z < n.inChannels; ++z){
                        for(var W = h[V + z], G = 0; G < n.outChannels; ++G)m[P + G] += W * f[U + G];
                        U += n.outChannels;
                    }
                }
            }
        ...
        for(var r = buffer(n.inShape, "float32"), o = r.values, a = r.strides, i = a[0], s = a[1], u = a[2], c = a[3], l = e.dataSync(), p = e.strides, d = p[0], h = p[1], f = p[2], m = p[3], g = t.dataSync(), v = t.strides, y = v[0], x = v[1], E = v[2], T = v[3], b = n.batchSize, w = n.filterDepth, S = n.filterHeight, C = n.filterWidth, A = n.inChannels, N = n.inDepth, _ = n.inHeight, R = n.inWidth, I = n.outChannels, k = n.outDepth, D = n.outHeight, O = n.outWidth, P = n.strideDepth, M = n.strideHeight, F = n.strideWidth, L = w - 1 - n.padInfo.front, B = S - 1 - n.padInfo.top, V = C - 1 - n.padInfo.left, U = 0; U < b; ++U)for(var z = 0; z < A; ++z)for(var W = 0; W < N; ++W)for(var G = W - L, H = Math.max(0, Math.ceil(G / P)), q = Math.min(k, (w + G) / P), $ = 0; $ < _; ++$)for(var K = $ - B, X = Math.max(0, Math.ceil(K / M)), j = Math.min(D, (S + K) / M), Y = 0; Y < R; ++Y){
            for(var Q = Y - V, J = Math.max(0, Math.ceil(Q / F)), Z = Math.min(O, (C + Q) / F), ee = 0, te = H; te < q; ++te)for(var ne = te * P - G, re = X; re < j; ++re)for(var oe = re * M - K, ae = J; ae < Z; ++ae)for(var ie = d * U + h * te + f * re + m * ae, se = y * (w - 1 - ne) + x * (S - 1 - oe) + E * (C - 1 - (ae * F - Q)) + T * z, ue = 0; ue < I; ++ue){
                ee += l[ie + ue] * g[se + ue];
            }
            o[i * U + s * W + u * $ + c * Y + z] = ee;
        }
        return r.toTensor();
    }, e.prototype.conv2dDerFilter = function(e, t, n) {
        this.assertNotComplex([
        ...
        for(var r = n.filterHeight, o = n.filterWidth, a = n.dilationHeight, i = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = n.outChannels / n.inChannels, l = buffer(n.outShape, e.dtype), p = e.dataSync(), d = t.dataSync(), h = l.values, f = 0; f < n.batchSize; ++f)for(var m = f * e.strides[0], g = f * l.strides[0], v = 0; v < n.outHeight; ++v)for(var y = g + v * l.strides[1], x = v * n.strideHeight - s, E = 0; E < r; ++E){
            var T = x + E * a;
            if (!(T < 0 || T >= n.inHeight)) for(var b = E * t.strides[0], w = m + T * e.strides[1], S = 0; S < n.outWidth; ++S)for(var C = y + S * l.strides[2], A = S * n.strideWidth - u, N = 0; N < o; ++N){
                var _ = A + N * i;
                if (!(_ < 0 || _ >= n.inWidth)) for(var R = b + N * t.strides[1], I = w + _ * n.inChannels, k = C, D = R, O = 0; O < n.inChannels; ++O){
                    for(var P = p[I + O], M = 0; M < c; ++M)h[k + M] += P * d[D + M];
                    k += c, D += c;
                }
            }
        }
        ...
        for(var r = buffer(n.inShape, "float32"), o = r.values, a = r.strides, i = a[0], s = a[1], u = a[2], c = e.dataSync(), l = e.strides, p = l[0], d = l[1], h = l[2], f = t.dataSync(), m = t.strides, g = m[0], v = m[1], y = m[2], x = n.batchSize, E = n.filterHeight, T = n.filterWidth, b = n.inChannels, w = n.inHeight, S = n.inWidth, C = n.outChannels, A = n.outHeight, N = n.outWidth, _ = n.strideHeight, R = n.strideWidth, I = E - 1 - n.padInfo.top, k = T - 1 - n.padInfo.left, D = C / b, O = 0; O < x; ++O)for(var P = 0; P < b; ++P)for(var M = 0; M < w; ++M)for(var F = M - I, L = Math.max(0, Math.ceil(F / _)), B = Math.min(A, (E + F) / _), V = 0; V < S; ++V){
            for(var U = V - k, z = Math.max(0, Math.ceil(U / R)), W = Math.min(N, (T + U) / R), G = 0, H = L; H < B; ++H)for(var q = H * _ - F, $ = z; $ < W; ++$)for(var K = p * O + d * H + h * $, X = g * (E - 1 - q) + v * (T - 1 - ($ * R - U)) + y * P, j = 0; j < D; ++j){
                G += c[K + (P * D + j)] * f[X + j];
            }
            o[i * O + s * M + u * V + P] = G;
        }
        ...
        for(var r = n.strideHeight, o = n.strideWidth, a = n.filterHeight, i = n.filterWidth, s = buffer(n.filterShape, "float32"), u = n.padInfo.left, c = n.padInfo.top, l = n.outChannels / n.inChannels, p = e.bufferSync(), d = t.bufferSync(), h = 0; h < a; ++h)for(var f = Math.max(0, Math.ceil((c - h) / r)), m = Math.min(n.outHeight, (n.inHeight + c - h) / r), g = 0; g < i; ++g)for(var v = Math.max(0, Math.ceil((u - g) / o)), y = Math.min(n.outWidth, (n.inWidth + u - g) / o), x = 0; x < n.outChannels; ++x){
            for(var E = Math.trunc(x / l), T = x % l, b = 0, w = 0; w < n.batchSize; ++w)for(var S = f; S < m; ++S)for(var C = h + S * r - c, A = v; A < y; ++A){
                var N = g + A * o - u;
                b += p.get(w, C, N, E) * d.get(w, S, A, x);
            }
            s.set(b, h, g, E, T);
        }
        return s.toTensor();
        ...
        var r = t.map(function(t, n) {
            ...
            return e[0];
        }), a = e.bufferSync(), i = buffer(r, e.dtype);
        0 !== n && i.values.fill(n);
        for(var s = 0; s < e.size; s++){
            var u = a.indexToLoc(s), c = u.map(function(e, t) {
                return e + o[t];
            });
            i.set.apply(i, [
                a.get.apply(a, u)
        ...
        for(r = 0; r < e.size; ++r){
            for(var s = i.indexToLoc(r), u = new Array(s.length), c = 0; c < u.length; c++)u[c] = s[t[c]];
        ...
        for(var r = t.strideHeight, o = t.strideWidth, a = t.dilationHeight, i = t.dilationWidth, s = t.effectiveFilterHeight, u = t.effectiveFilterWidth, c = t.padInfo.top, l = t.padInfo.left, p = "max" === n ? Number.NEGATIVE_INFINITY : Number.POSITIVE_INFINITY, d = e.dataSync(), h = buffer(t.outShape, e.dtype), f = h.values, m = t.outShape[1] * t.outShape[2] * t.outShape[3], g = t.outShape[2] * t.outShape[3], v = t.outShape[3], y = 0; y < t.batchSize; ++y)for(var x = y * m, E = y * e.strides[0], T = 0; T < t.inChannels; ++T)for(var b = 0; b < t.outHeight; ++b)for(var w = b * r - c, S = Math.max(0, w), C = Math.min(t.inHeight, s + w), A = x + b * g, N = 0; N < t.outWidth; ++N){
            for(var _ = N * o - l, R = Math.max(0, _), I = Math.min(t.inWidth, u + _), k = p, D = 0, O = 0, P = S; P < C; P += a){
                for(var M = E + P * e.strides[1], F = R; F < I; F += i){
                    var L = d[M + F * e.strides[2] + T];
                    "max" === n && L > k ? k = L : "avg" === n && (D += L, O++);
                }
                if (isNaN(k)) break;
            }
            f[A + N * v + T] = "avg" === n ? D / O : k;
        }
        return h.toTensor();
    }, e.prototype.maxPool = function(e, t) {
        return this.pool(e, t, "max");
    }, e.prototype.maxPoolPositions = function(e, t) {
        for(var n = buffer(t.outShape, "int32"), r = t.strideHeight, o = t.strideWidth, a = t.dilationHeight, i = t.dilationWidth, s = t.effectiveFilterHeight, u = t.effectiveFilterWidth, c = t.padInfo.top, l = t.padInfo.left, p = e.bufferSync(), d = 0; d < t.batchSize; ++d)for(var h = 0; h < t.inChannels; ++h)for(var f = 0; f < t.outHeight; ++f){
            for(var m = f * r - c, g = m; g < 0;)g += a;
            for(var v = Math.min(t.inHeight, s + m), y = 0; y < t.outWidth; ++y){
                for(var x = y * o - l, E = x; E < 0;)E += i;
                for(var T = Math.min(t.inWidth, u + x), b = Number.NEGATIVE_INFINITY, w = -1, S = g; S < v; S += a)for(var C = S - m, A = E; A < T; A += i){
        ...
        for(var o = this.maxPoolPositions(t, r), a = r.strideHeight, i = r.strideWidth, s = r.dilationHeight, u = r.dilationWidth, c = r.effectiveFilterHeight, l = r.effectiveFilterWidth, p = l - 1 - r.padInfo.left, d = c - 1 - r.padInfo.top, h = buffer(t.shape, "float32"), f = o.bufferSync(), m = e.bufferSync(), g = 0; g < r.batchSize; ++g)for(var v = 0; v < r.inChannels; ++v)for(var y = 0; y < r.inHeight; ++y)for(var x = 0; x < r.inWidth; ++x){
            for(var E = y - d, T = x - p, b = 0, w = 0; w < c; w += s){
                var S = (E + w) / a;
                if (!(S < 0 || S >= r.outHeight || Math.floor(S) !== S)) for(var C = 0; C < l; C += u){
                    var A = (T + C) / i;
                    if (!(A < 0 || A >= r.outWidth || Math.floor(A) !== A)) {
                        var N = c * l - 1 - f.get(g, S, A, v) === w * l + C ? 1 : 0;
                        if (0 !== N) b += m.get(g, S, A, v) * N;
                    }
                }
            }
            h.set(b, g, y, x, v);
        ...
        for(var r = n.strideHeight, o = n.strideWidth, a = n.filterHeight, i = n.filterWidth, s = n.dilationHeight, u = n.dilationWidth, c = n.effectiveFilterHeight, l = n.effectiveFilterWidth, p = l - 1 - n.padInfo.left, d = c - 1 - n.padInfo.top, h = buffer(t.shape, "float32"), f = 1 / (a * i), m = e.bufferSync(), g = 0; g < n.batchSize; ++g)for(var v = 0; v < n.inChannels; ++v)for(var y = 0; y < n.inHeight; ++y)for(var x = 0; x < n.inWidth; ++x){
            for(var E = y - d, T = x - p, b = 0, w = 0; w < c; w += s){
                var S = (E + w) / r;
                if (!(S < 0 || S >= n.outHeight || Math.floor(S) !== S)) for(var C = 0; C < l; C += u){
                    var A = (T + C) / o;
                    if (!(A < 0 || A >= n.outWidth || Math.floor(A) !== A)) b += m.get(g, S, A, v);
                }
            }
            h.set(b * f, g, y, x, v);
        }
        ...
        for(var o = e.shape, a = o[0], i = o[1], s = o[2], u = o[3], c = e.dataSync(), l = new Float32Array(sizeFromShape([
            a,
            t,
            n,
            u
            ...
            r && t > 1 ? t - 1 : t,
            r && n > 1 ? n - 1 : n
        ], h = 0, f = p[0] / d[0], m = p[1] / d[1], g = 0; g < a; g++)for(var v = 0; v < t; v++)for(var y = f * v, x = Math.floor(y), E = y - x, T = Math.min(i - 1, Math.ceil(y)), b = g * e.strides[0] + x * e.strides[1], w = g * e.strides[0] + T * e.strides[1], S = 0; S < n; S++)for(var C = m * S, A = Math.floor(C), N = C - A, _ = Math.min(s - 1, Math.ceil(C)), R = b + A * e.strides[2], I = w + A * e.strides[2], k = b + +_ * e.strides[2], D = w + _ * e.strides[2], O = 0; O < u; O++){
            var P = c[R + O], M = c[I + O], F = P + (c[k + O] - P) * N, L = F + (M + (c[D + O] - M) * N - F) * E;
            l[h++] = L;
        }
        return tensor(l, [
            a,
        ...
        for(var o = e.shape, a = o[0], i = o[1], s = o[2], u = o[3], c = e.dataSync(), l = new Float32Array(a * t * n * u), p = [
            r && t > 1 ? i - 1 : i,
            r && n > 1 ? s - 1 : s
        ], d = [
            r && t > 1 ? t - 1 : t,
            r && n > 1 ? n - 1 : n
        ], h = p[0] / d[0], f = p[1] / d[1], m = 0, g = 0; g < a; g++)for(var v = g * e.strides[0], y = 0; y < t; y++)for(var x = h * y, E = v + Math.min(i - 1, r ? Math.round(x) : Math.floor(x)) * e.strides[1], T = 0; T < n; T++)for(var b = f * T, w = E + Math.min(s - 1, r ? Math.round(b) : Math.floor(b)) * e.strides[2], S = 0; S < u; S++){
            var C = c[w + S];
            l[m++] = C;
        }
        return tensor(l, [
        ...
        for(var r = t.shape, o = r[0], a = r[1], i = r[2], s = r[3], u = e.shape, c = u[1], l = u[2], p = new Float32Array(o * a * i * s), d = e.dataSync(), h = [
            n && c > 1 ? a - 1 : a,
            n && l > 1 ? i - 1 : i
        ], f = [
            n && c > 1 ? c - 1 : c,
            n && l > 1 ? l - 1 : l
        ], m = h[0] / f[0], g = h[1] / f[1], v = 1 / m, y = 1 / g, x = 2 * Math.ceil(v) + 2, E = 2 * Math.ceil(y) + 2, T = 0; T < o; T++)for(var b = T * t.strides[0], w = 0; w < a; w++)for(var S = b + w * t.strides[1], C = Math.floor(w * v), A = Math.floor(C - x / 2), N = 0; N < i; N++)for(var _ = S + N * t.strides[2], R = Math.floor(N * y), I = Math.floor(R - E / 2), k = 0; k < s; k++){
            for(var D = 0, O = 0; O < x; O++){
                var P = O + A;
                if (!(P < 0 || P >= c)) {
                    var M = b + P * e.strides[1], F = P * m;
                    if (w === Math.min(a - 1, n ? Math.round(F) : Math.floor(F))) for(var L = 0; L < E; L++){
                        var B = L + I;
                        if (!(B < 0 || B >= l)) {
                            var V = M + B * e.strides[2], U = B * g;
                            N === Math.min(i - 1, n ? Math.round(U) : Math.floor(U)) && (D += d[V + k]);
                        }
                    }
                }
            }
        ...
        for(var i = e.dataSync(), s = t.dataSync(), u = n.dataSync(), c = o ? o.dataSync() : new Float32Array([
            1
        ]), l = a ? a.dataSync() : new Float32Array([
            0
        ]), p = new Float32Array(i.length), d = l.length, h = c.length, f = u.length, m = s.length, g = 0, v = 0, y = 0, x = 0, E = 0; E < i.length; ++E)p[E] = l[g++] + (i[E] - s[v++]) * c[y++] / Math.sqrt(u[x++] + r), g >= d && (g = 0), v >= m && (v = 0), y >= h && (y = 0), x >= f && (x = 0);
        return tensor4d(p, e.shape);
    }, e.prototype.localResponseNormalization4D = function(e, t, n, r, o) {
        this.assertNotComplex(e, "localResponseNormalization4D");
        var a = e.shape[3], i = a - 1, s = e.dataSync(), u = e.size, c = new Float32Array(u);
        function l(e) {
        ...
        for(var p = 0; p < u; p++){
            var d = l(p), h = s[p] * Math.pow(n + r * d, -o);
            c[p] = h;
        }
        return tensor4d(c, e.shape);
    }, e.prototype.LRNGrad = function(e, t, n, r, o, a, i) {
        this.assertNotComplex(e, "LRNGrad");
        for(var s = e.shape[3], u = e.dataSync(), c = t.dataSync(), l = n.dataSync(), p = new Float32Array(e.size), d = e.size, h = 0; h < d; h++){
            for(var f = h % s, m = h - f + Math.max(0, f - r), g = h - f + Math.min(s, f + r + 1), v = 0, y = m; y < g; y++)v += Math.pow(c[y], 2);
            v = a * v + o;
            for(y = m; y < g; y++){
                var x = -2 * a * i * c[y] * l[h] / v;
        ...
        for(var o = t ? e : softmax(e), a = o.shape[0], i = o.shape[1], s = zeros([
            a,
            n
        ], "int32"), u = s.dataSync(), c = o.dataSync(), l = 0; l < a; ++l){
            var p = l * i, d = new Float32Array(i - 1);
            d[0] = c[p];
            for(var h = 1; h < d.length; ++h)d[h] = d[h - 1] + c[p + h];
            for(var f = seedrandom_1(r.toString()), m = l * n, g = 0; g < n; ++g){
                var v = f();
                u[m + g] = d.length;
        ...
        for(var n = e.shape[0], r = e.shape[1], o = buffer(e.shape, "float32"), a = buffer(e.shape, "float32"), i = real(e).as2D(n, r), s = imag(e).as2D(n, r), u = 0; u < n; u++)for(var c = i.slice([
            u,
            0
        ], [
            1,
            ...
            1,
            r
        ]), p = complex(c, l), d = this.fftImpl(p, t).dataSync(), h = 0; h < r; h++){
        ...
        return 0 == (e & e - 1);
    }, e.prototype.fftRadix2 = function(e, t, n) {
        if (1 === t) return e;
        ...
        var c = exponents(t, n), l = complex(c.real, c.imag).mul(u), p = i.add(l), d = i.sub(l), h = real(p).concat(real(d)), f = imag(p).concat(imag(d));
        return complex(h, f).as1D();
    }, e.prototype.fourierTransformByMatmul = function(e, t, n) {
        for(var r = new Float32Array(2 * t), o = 0; o < t; o++){
            for(var a = 0, i = 0, s = 0; s < t; s++){
                var u = exponent(o * s, t, n), c = getComplexWithIndex(e, s);
        ...
        assert("NHWC" === n, function() {
            return "Only NHWC dataFormat supported on CPU for depthToSpace. Got " + n;
        }), assert(t > 1, function() {
            return "blockSize should be > 1 for depthToSpace, but was: " + t;
        });
        for(var r = e.shape[0], o = e.shape[1], a = e.shape[2], i = e.shape[3], s = o * t, u = a * t, c = i / (t * t), l = e.dataSync(), p = new Float32Array(r * s * u * c), d = 0, h = 0; h < r; ++h)for(var f = 0; f < s; ++f)for(var m = Math.floor(f / t), g = f % t, v = 0; v < u; ++v)for(var y = Math.floor(v / t), x = (g * t + v % t) * c, E = 0; E < c; ++E){
            var T = E + x + i * (y + a * (m + o * h));
            p[d++] = l[T];
        }
        return tensor4d(p, [
            r,
        ...
        var o = assertAndGetBroadcastShape(e.shape, t.shape), a = buffer(o, n), i = e.dataSync(), s = t.dataSync(), u = getBroadcastDims(e.shape, o), c = getBroadcastDims(t.shape, o), l = a.values;
        if (u.length + c.length === 0) for(var p = 0; p < l.length; ++p)l[p] = r(i[p % i.length], s[p % s.length]);
        else {
        ...
        var r = assertAndGetBroadcastShape(e.shape, t.shape), o = buffer(r, "float32"), a = buffer(r, "float32"), i = e.dataSync(), s = t.dataSync(), u = getBroadcastDims(e.shape, r), c = getBroadcastDims(t.shape, r), l = o.values, p = a.values;
        if (u.length + c.length === 0) for(var d = 0; d < l.length; d++){
            var h = d % i.length, f = d % s.length, m = n(i[2 * h], i[2 * h + 1], s[2 * f], s[2 * f + 1]);
            l[d] = m.real, p[d] = m.imag;
        }
        else {
            var g = this.data.get(e.dataId).complexTensors.real.bufferSync(), v = this.data.get(t.dataId).complexTensors.real.bufferSync(), y = function(r) {
        ...
        for(var i = e.shape, s = i[0], u = i[1], c = i[2], l = i[3], p = t.shape[0], d = r[0], h = r[1], f = buffer([
            p,
            d,
            h,
            l
        ], e.dtype), m = t.dataSync(), g = n.dataSync(), v = e.dataSync(), y = e.strides, x = f.strides, E = 0; E < p; E++){
            var T = 4 * E, b = m[T], w = m[T + 1], S = m[T + 2], C = m[T + 3], A = g[E];
            if (!(A >= s)) for(var N = d > 1 ? (S - b) * (u - 1) / (d - 1) : 0, _ = h > 1 ? (C - w) * (c - 1) / (h - 1) : 0, R = 0; R < d; R++){
                var I = d > 1 ? b * (u - 1) + R * N : .5 * (b + S) * (u - 1);
                if (I < 0 || I > u - 1) for(var k = 0; k < h; k++)for(var D = 0; D < l; D++){
                    var O = D + k * x[2] + R * x[1] + E * x[0];
                    f.values[O] = a;
                }
                else if ("bilinear" === o) {
                    var P = Math.floor(I), M = Math.ceil(I), F = I - P;
                    for(k = 0; k < h; k++){
                        if ((q = h > 1 ? w * (c - 1) + k * _ : .5 * (w + C) * (c - 1)) < 0 || q > c - 1) for(D = 0; D < l; D++){
                            O = D + k * x[2] + R * x[1] + E * x[0];
                            f.values[O] = a;
                        }
                        else {
                            var L = Math.floor(q), B = Math.ceil(q), V = q - L;
                            for(D = 0; D < l; D++){
                                var U = v[O = D + L * y[2] + P * y[1] + A * y[0]], z = v[O = D + B * y[2] + P * y[1] + A * y[0]], W = v[O = D + L * y[2] + M * y[1] + A * y[0]], G = U + (z - U) * V, H = W + (v[O = D + B * y[2] + M * y[1] + A * y[0]] - W) * V;
                                O = D + k * x[2] + R * x[1] + E * x[0], f.values[O] = G + (H - G) * F;
                            }
                        }
                    }
                } else for(k = 0; k < h; ++k){
                    ...
                    if ((q = h > 1 ? w * (c - 1) + k * _ : .5 * (w + C) * (c - 1)) < 0 || q > c - 1) for(D = 0; D < l; D++){
                        ...
                        var $ = Math.round(q), K = Math.round(I);
                        for(D = 0; D < l; D++){
                            var X = D + $ * y[2] + K * y[1] + A * y[0], j = D + k * x[2] + R * x[1] + E * x[0];
                            f.values[j] = v[X];
                        }
                    }
                }
        ...
        var o = calculateShapes(t, e, n), a = o.sliceRank, i = o.numUpdates, s = o.sliceSize, u = o.strides, c = o.outputSize;
        return this.scatter(e, t, n, c, s, i, a, u, r, !1);
    }, e.prototype.gatherND = function(e, t) {
        var n = t.shape, r = n[n.length - 1], o = prepareAndValidate(e, t), a = o[0], i = o[1], s = o[2], u = o[3];
        if (0 === i) return tensor([], a, e.dtype);
        for(var c = new TensorBuffer([
            i,
            s
        ], e.dtype), l = t.dataSync(), p = e.dataSync(), d = 0; d < i; d++){
            for(var h = [], f = 0, m = 0; m < r; m++){
                var g = l[d * r + m];
                f += g * u[m], h.push(g);
            }
            if (f < 0 || f >= e.size / s) throw new Error("Invalid indices: " + h + " does not index into " + e.shape);
            for(var v = 0; v < s; v++)c.values[d * s + v] = p[f * s + v];
        }
        return c.toTensor().reshape(a);
    }, e.prototype.scatterND = function(e, t, n) {
        var r = calculateShapes(t, e, n), o = r.sliceRank, a = r.numUpdates, i = r.sliceSize, s = r.strides, u = r.outputSize, c = scalar(0);
        return this.scatter(e, t, n, u, i, a, o, s, c, !0);
    }, e.prototype.fill = function(e, t, n) {
        ...
        if ("string" === e.dtype) throw new Error("onesLike is not supported for string tensors");
        return this.fill(e.shape, 1, e.dtype);
    }, e.prototype.zerosLike = function(e) {
        var t = getArrayFromDType(e.dtype, sizeFromShape(e.shape));
        return Tensor.make(e.shape, {
            values: t
        }, e.dtype);
    }, e.prototype.scatter = function(e, t, n, r, o, a, i, s, u, c) {
        var l = [
            r / o,
            o
        ], p = e.dataSync(), d = t.dataSync();
        if (0 === r) return tensor([], n, t.dtype);
        var h = new TensorBuffer(l, t.dtype);
        ...
        for(var f = 0; f < a; f++){
            ...
            for(var x = 0; x < o; x++)c ? h.values[g * o + x] += d[f * o + x] : h.values[g * o + x] = 0 === t.rank ? d[0] : d[f * o + x];
        }
...
var delayCallback = "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" != typeof setImmediate ? setImmediate : function(e) {
    return e();
};
function nextFrame() {
...
function decodeWeights(e, t) {
    for(var n = {}, r = 0, o = function(t) {
        ...
        if ("quantization" in t) {
            ...
            var l = DTYPE_VALUE_SIZE_MAP[c.dtype], p = e.slice(r, r + s * l), d = "uint8" === c.dtype ? new Uint8Array(p) : new Uint16Array(p);
...
var useNodeBuffer = "undefined" != typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"] && ("undefined" == typeof Blob || "undefined" == typeof atob || "undefined" == typeof btoa);
function stringByteLength(e) {
    return useNodeBuffer ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].byteLength(e) : new Blob([
        e
    ]).size;
}
function arrayBufferToBase64String(e) {
    return useNodeBuffer ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e).toString("base64") : btoa(String.fromCharCode.apply(null, new Uint8Array(e)));
}
function base64StringToArrayBuffer(e) {
    if (useNodeBuffer) {
        var t = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e, "base64");
...
var IORouterRegistry = function() {
    ...
    return e.getInstance = function() {
        ...
        assert(null != t, function() {
            return "scheme must not be undefined or null.";
        }), t.endsWith(URL_SCHEME_SUFFIX) && (t = t.slice(0, t.indexOf(URL_SCHEME_SUFFIX))), assert(t.length > 0, function() {
            return "scheme must not be an empty string.";
        });
        var r = e.getInstance();
        assert(null == r.managers[t], function() {
        ...
        return new Promise(function(e, r) {
            ...
            o.onupgradeneeded = function() {
                ...
                if (null == t) {
                    ...
                    var u, c = getModelArtifactsInfoForJSON(t), l = a.transaction(INFO_STORE_NAME, "readwrite"), p = l.objectStore(INFO_STORE_NAME), d = p.put({
                    ...
                    d.onsuccess = function() {
                        ...
                        o.onsuccess = function() {
                            ...
                            var t = (p = l.objectStore(INFO_STORE_NAME)).delete(n.modelPath);
                ...
                return [
                    ...
                    new Promise(function(t, n) {
                        ...
                        r.onupgradeneeded = function() {
                            ...
                            var e = r.result, o = e.transaction(INFO_STORE_NAME, "readonly"), a = o.objectStore(INFO_STORE_NAME).getAll();
                ...
                return e = maybeStripScheme(e), [
                    ...
                    new Promise(function(n, r) {
                        ...
                        o.onupgradeneeded = function() {
                            ...
                            var t, a = o.result, i = a.transaction(INFO_STORE_NAME, "readwrite"), s = i.objectStore(INFO_STORE_NAME), u = s.get(e);
...
var PATH_SEPARATOR = "/", PATH_PREFIX = "tensorflowjs_models", INFO_SUFFIX = "info", MODEL_TOPOLOGY_SUFFIX = "model_topology", WEIGHT_SPECS_SUFFIX = "weight_specs", WEIGHT_DATA_SUFFIX = "weight_data", MODEL_METADATA_SUFFIX = "model_metadata";
    ...
    return e.prototype.save = function(e) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(o) {
                ...
                try {
                    return this.LS.setItem(this.keys.info, JSON.stringify(r)), this.LS.setItem(this.keys.topology, t), this.LS.setItem(this.keys.weightSpecs, n), this.LS.setItem(this.keys.weightData, arrayBufferToBase64String(e.weightData)), this.LS.setItem(this.keys.modelMetadata, JSON.stringify({
                        format: e.format,
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(s) {
                ...
                if (t.weightSpecs = r, null != (o = this.LS.getItem(this.keys.modelMetadata)) && (a = JSON.parse(o), t.format = a.format, t.generatedBy = a.generatedBy, t.convertedBy = a.convertedBy), null == (i = this.LS.getItem(this.keys.weightData))) throw new Error("In local storage, the binary weight values of model '" + this.modelPath + "' are missing.");
                return t.weightData = base64StringToArrayBuffer(i), [
                    2,
                    t
                ];
            });
...
var DEFAULT_FILE_NAME_PREFIX = "model", DEFAULT_JSON_EXTENSION_NAME = ".json", DEFAULT_WEIGHT_DATA_EXTENSION_NAME = ".weights.bin", BrowserDownloads = function() {
    ...
    return e.prototype.save = function(e) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(s) {
                ...
                })), (a = null == this.jsonAnchor ? document.createElement("a") : this.jsonAnchor).download = this.modelTopologyFileName, a.href = o, a.click(), null != e.weightData && ((i = null == this.weightDataAnchor ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName, i.href = t, i.click()), [
                    2,
                    {
    ...
    return e.prototype.load = function() {
        return __awaiter(this, void 0, void 0, function() {
            var e, t, n = this;
            return __generator(this, function(r) {
                return e = this.files[0], t = this.files.slice(1), [
                    2,
                    new Promise(function(r, o) {
...
function monitorPromisesProgress(e, t, n, r) {
    !function(e) {
        assert(null != e && Array.isArray(e) && e.length > 0, function() {
            return "promises must be a none empty array";
        });
    }(e), function(e, t) {
        assert(e >= 0 && e <= 1, function() {
            return "Progress fraction must be in range [0, 1], but got startFraction " + e;
        }), assert(t >= 0 && t <= 1, function() {
...
function loadWeightsAsArrayBuffer(e, t) {
    return __awaiter(this, void 0, void 0, function() {
        var n, r, o, a, i, s, u, c, l;
        return __generator(this, function(p) {
            switch(p.label){
                case 0:
                    return null == t && (t = {}), n = null == t.fetchFunc ? fetch : t.fetchFunc, r = e.map(function(e) {
                        return n(e, t.requestInit);
                    }), o = 0, a = .5, null != t.onProgress ? [
                        3,
                        2
                    ] : [
                        4,
                ...
                case 2:
                    return [
                        4,
                        monitorPromisesProgress(r, t.onProgress, o, a)
                    ];
                case 3:
                    i = p.sent(), p.label = 4;
                case 4:
                ...
                case 6:
                    return [
                        4,
                        monitorPromisesProgress(s, t.onProgress, u, c)
                    ];
                case 7:
                    l = p.sent(), p.label = 8;
                case 8:
...
function loadWeights(e, t, n, r) {
    return void 0 === t && (t = ""), __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(o) {
            return [
                2,
                weightsLoaderFactory(function(e) {
                    return loadWeightsAsArrayBuffer(e, {
                        requestInit: r
                    });
                })(e, t, n)
            ];
...
function weightsLoaderFactory(e) {
    ...
    return function(n, r, o) {
        return void 0 === r && (r = ""), __awaiter(t, void 0, void 0, function() {
            var t, a, i, s, u, c, l, p, d, h;
                ...
                switch(f.label){
                    case 0:
                        if (t = n.map(function() {
                            ...
                            return !1;
                        }) : [], s = [], n.forEach(function(e, n) {
                            var r = 0;
                            e.weights.forEach(function(e) {
                                var u = "quantization" in e ? e.quantization.dtype : e.dtype, c = DTYPE_VALUE_SIZE_MAP[u] * sizeFromShape(e.shape), l = function() {
                                    t[n] = !0, null == a[n] && (a[n] = []), a[n].push({
                                        manifestEntry: e,
                                        groupOffset: r,
                                        sizeBytes: c
                                    });
                    ...
                    case 1:
                        return p = f.sent(), d = {}, h = 0, c.forEach(function(e) {
                            for(var t = n[e].paths.length, r = 0, o = 0; o < t; o++)r += p[h + o].byteLength;
                            for(var i = new ArrayBuffer(r), s = new Uint8Array(i), u = 0, c = 0; c < t; c++){
                                var l = new Uint8Array(p[h + c]);
                                s.set(l, u), u += l.byteLength;
                            }
                            a[e].forEach(function(e) {
                                var t = decodeWeights(i.slice(e.groupOffset, e.groupOffset + e.sizeBytes), [
                                    e.manifestEntry
                                ]);
...
var OCTET_STREAM_MIME_TYPE = "application/octet-stream", JSON_TYPE = "application/json", BrowserHTTPRequest = function() {
    function e(e, t) {
        if (this.DEFAULT_METHOD = "POST", null == t && (t = {}), this.weightPathPrefix = t.weightPathPrefix, this.onProgress = t.onProgress, null == t.fetchFunc) {
            var n = ENV.global.fetch;
            if (void 0 === n) throw new Error("browserHTTPRequest is not supported outside the web browser without a fetch polyfill.");
            t.fetchFunc = n.bind(ENV.global);
        } else assert("function" == typeof t.fetchFunc, function() {
            return "Must pass a function that matches the signature of `fetch` (see https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)";
        });
        if (this.fetchFunc = function(e, n) {
            return t.fetchFunc(e, n).catch(function(t) {
                throw new Error("Request for " + e + " failed due to error: " + t);
            });
        }, assert(null != e && e.length > 0, function() {
            return "URL path for browserHTTPRequest must not be null, undefined or empty.";
        }), Array.isArray(e) && assert(2 === e.length, function() {
            return "URL paths for browserHTTPRequest must have a length of 2, (actual length is " + e.length + ").";
    ...
    return e.prototype.save = function(e) {
                ...
                switch(a.label){
                    case 0:
                        ...
                        return (t = Object.assign({
                            ...
                            type: JSON_TYPE
                        }), "model.json"), null != e.weightData && t.body.append("model.weights.bin", new Blob([
                            e.weightData
                        ], {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(u) {
                switch(u.label){
                    ...
                    case 1:
                        if (!(e = u.sent()).ok) throw new Error("Request to " + this.path + " failed with status code " + e.status + ". Please verify this URL points to the model JSON of the model to load.");
                        u.label = 2;
                    case 2:
                        return u.trys.push([
                            2,
                    ...
                    case 5:
                        if (r = t.modelTopology, o = t.weightsManifest, null == r && null == o) throw new Error("The JSON from HTTP path " + this.path + " contains neither model topology or manifest for weights.");
                        return null == o ? [
                            3,
                            7
                        ] : [
                    ...
                    case 6:
                        s = u.sent(), a = s[0], i = s[1], u.label = 7;
                    case 7:
                        return [
                            2,
                            {
        ...
        return __awaiter(this, void 0, void 0, function() {
            var t, n, r, o, a, i, s, u, c, l, p;
            return __generator(this, function(d) {
                switch(d.label){
                    case 0:
                        for(t = Array.isArray(this.path) ? this.path[1] : this.path, n = parseUrl(t), r = n[0], o = n[1], a = this.weightPathPrefix || r, i = [], s = 0, u = e; s < u.length; s++)c = u[s], i.push.apply(i, c.weights);
...
var httpRequestRouter = function(e, t) {
    if ("undefined" == typeof fetch) return null;
    return (Array.isArray(e) ? e.every(function(e) {
        return isHTTPScheme(e);
    }) : isHTTPScheme(e)) ? browserHTTPRequest(e, {
        onProgress: t
    }) : null;
};
...
function confusionMatrix_(e, t, n) {
    var r = convertToTensor(e, "labels", "confusionMatrix"), o = convertToTensor(t, "predictions", "confusionMatrix");
    assert(null == n || n > 0 && Number.isInteger(n), function() {
    ...
    }), assert(n > 0 && Number.isInteger(n), function() {
...
function toPixels(e, t) {
    return __awaiter(this, void 0, void 0, function() {
        var n, r, o, a, i, s, u, c, l, p, d, h, f, m, g, v, y, x, E, T;
            ...
            switch(b.label){
                ...
                case 2:
                    if (l = b.sent()[0], s.dispose(), u.dispose(), "float32" === n.dtype) {
                        ...
                        if (c < 0 || l > 255) throw new Error("Tensor values for a int32 Tensor must be in the range [0 - 255] but got range [" + c + " - " + l + "].");
                    }
                    return [
                        4,
                        n.data()
                ...
                case 3:
                    ...
                    return null != t && (t.width = a, t.height = o, E = t.getContext("2d"), T = new ImageData(h, a, o), E.putImageData(T, 0, 0)), n !== e && n.dispose(), [
                        2,
                        h
                    ];
            }
...
function registerClass(e) {
    assert(null != e.className, function() {
        return "Class being registered does not have the static className property defined.";
    }), assert("string" == typeof e.className, function() {
        return "className is required to be a string, but got type " + typeof e.className;
    }), assert(e.className.length > 0, function() {
...
function expectArraysClose(e, t, n) {
    return null == n && (n = ENV.get("TEST_EPSILON")), expectArraysPredicate(e, "number" == typeof t || "boolean" == typeof t ? [
        t
    ] : t, function(e, t) {
...
function expectArraysEqual(e, t) {
    var n = "string" == typeof t || "number" == typeof t || "boolean" == typeof t ? [
        t
    ] : t;
...
}), version = "1.0.3", webgl = Object.freeze({
...
var AdadeltaOptimizer = function(e) {
    ...
    return __extends(t, e), t.prototype.applyGradients = function(e) {
        var t = this, n = function(n) {
            ...
            tidy(function() {
                var e = t.rhoScalar.mul(i).add(t.oneMinusRho.mul(a.square())), r = s.add(t.epsilonScalar).sqrt().div(i.add(t.epsilonScalar).sqrt()).mul(a), u = t.rhoScalar.mul(s).add(t.oneMinusRho.mul(r.square()));
                t.accumulatedGrads[n].assign(e), t.accumulatedUpdates[n].assign(u);
                var c = t.c.mul(r).add(o);
                o.assign(c);
            });
        }, r = this;
        for(var o in e)n(o);
    ...
    return __extends(t, e), t.prototype.applyGradients = function(e) {
        ...
        tidy(function() {
            ...
            for(var o in e){
                ...
                var s = e[o], u = t.accumulatedFirstMoment[o], c = t.accumulatedSecondMoment[o], l = t.beta1Scalar.mul(u).add(t.oneMinusBeta1.mul(s)), p = t.beta2Scalar.mul(c).add(t.oneMinusBeta2.mul(s.square())), d = l.div(n), h = p.div(r);
                t.accumulatedFirstMoment[o].assign(l), t.accumulatedSecondMoment[o].assign(p);
    ...
    return __extends(t, e), t.prototype.applyGradients = function(e) {
        ...
        tidy(function() {
            ...
            for(var o in e){
                ...
                var s = e[o], u = t.accumulatedFirstMoment[o], c = t.accumulatedWeightedInfNorm[o], l = t.beta1Scalar.mul(u).add(t.oneMinusBeta1.mul(s)), p = t.beta2Scalar.mul(c), d = s.abs(), h = p.maximum(d);
                t.accumulatedFirstMoment[o].assign(l), t.accumulatedWeightedInfNorm[o].assign(h);
                var f = r.div(n).mul(l.div(t.epsScalar.add(h))).add(a);
                a.assign(f);
            }
...
var RMSPropOptimizer = function(e) {
    ...
    return __extends(t, e), t.prototype.applyGradients = function(e) {
        var t = this, n = function(n) {
            ...
            var a = r.accumulatedMeanSquares[n], i = r.accumulatedMeanGrads[n], s = r.accumulatedMoments[n], u = e[n];
            tidy(function() {
                var e = t.decayScalar.mul(a).add(t.oneMinusDecay.mul(u.square()));
                if (t.centered) {
                    var r = t.decayScalar.mul(i).add(t.oneMinusDecay.mul(u)), c = t.momentumScalar.mul(s).add(t.c.mul(u).div(e.sub(r.square().add(t.epsilonScalar)).sqrt()));
                    t.accumulatedMeanSquares[n].assign(e), t.accumulatedMeanGrads[n].assign(r), t.accumulatedMoments[n].assign(c);
                    var l = o.sub(c);
                    o.assign(l);
                } else {
                    var p = t.decayScalar.mul(a).add(t.oneMinusDecay.mul(u.square()));
                    c = t.momentumScalar.mul(s).add(t.c.mul(u).div(p.add(t.epsilonScalar).sqrt()));
                    t.accumulatedMeanSquares[n].assign(p), t.accumulatedMoments[n].assign(c);
                    l = o.sub(c);
                    o.assign(l);
                }
            });
